...
export const localNeighborhoods: LocalNeighborhoodSeoPage[] = [
  {
    ...
    profile: "bairro tradicional com comércio de rua, galerias, serviços médicos, escolas, prédios residenciais antigos e imóveis adaptados para uso comercial",
    buildings: ["lojas de rua", "clínicas", "condomínios antigos", "escolas e pequenos mercados"],
    risks: ["rotas estreitas em imóveis antigos", "alteração de layout sem atualizar planta", "sinalização desgastada", "laudos vencidos"],
    ...
    nearby: ["Tatuape", "Vila Matilde", "Vila Ré", "Carrão"],
  },
  {
    slug: "casa-verde",
    name: "Casa Verde",
    ...
    profile: "região com condomínios, comércio local, oficinas, galpões pequenos, escolas e prédios que misturam uso residencial e serviços",
    ...
    urgency: "Na Casa Verde, a renovação costuma exigir conferencia de sistemas antigos e documentação de manutenção antes da vistoria.",
    nearby: ["Santana", "Limão", "Barra Funda", "Freguesia do Ó"],
  },
  {
    slug: "limao",
    name: "Limão",
    ...
    profile: "bairro com galpões, centros de distribuição menores, comércio, condomínios e imóveis próximos a eixos de transporte",
    ...
    urgency: "No Limao, empresas próximas a eixos logisticos precisam resolver AVCB antes de fiscalização, seguro ou contrato de locação.",
    nearby: ["Casa Verde", "Freguesia do Ó", "Santana", "Barra Funda"],
  },
  {
    slug: "jacana",
    name: "Jaçanã",
    ...
    profile: "região com comércio local, escolas, condomínios, pequenas indústrias e serviços que atendem a zona norte",
    buildings: ["escolas", "condomínios", "pequenas indústrias", "lojas e clínicas"],
    risks: ["sistemas sem manutenção", "mudança de uso sem FAT", "sinalização incompleta", "brigada vencida"],
  ...
  },
  {
    ...
    urgency: "Na Freguesia do O, imóveis antigos precisam de diagnóstico antes do protocolo para evitar exigências previsíveis.",
  ...
  },
  {
    ...
    urgency: "No Carrão, negócios em ruas comerciais precisam manter AVCB regular para alvará, seguro e atendimento ao público.",
  ...
  },
  {
    ...
    name: "Vila Ré",
    zone: "Zona Leste",
    localRefs: ["Avenida Itinguçu", "Metrô Patriarca-Vila Ré", "Avenida Calim Eid", "Radial Leste"],
    profile: "região residencial e comercial com escolas, mercados, pequenas empresas, galpões leves e imóveis adaptados",
    buildings: ["escolas", "mercados", "condomínios", "pequenos galpões"],
    risks: ["projeto desatualizado", "extintores mal posicionados", "rota única", "laudos ausentes"],
    urgency: "Na Vila Ré, a regularização precisa considerar imóveis adaptados e atividades que cresceram sem atualizar o AVCB.",
  ...
  },
  {
    ...
    profile: "bairro extenso com comércio popular, escolas, mercados, galpões menores, serviços e condomínios",
  ...
  },
  {
    ...
    risks: ["alta lotação", "alarme e hidrante sem teste", "estoque obstruindo rota", "projeto sem atualização"],
    urgency: "Em Aricanduva, negócios de maior fluxo precisam de AVCB coerente com lotação, estoque e sistemas em funcionamento.",
  ...
  },
  {
    ...
    profile: "polo regional com shopping, escolas, clínicas, comércio intenso, galpões e grande circulação de pessoas",
    ...
    nearby: ["Vila Ré", "Artur Alvim", "Guaianases", "São Miguel"],
  },
  {
    slug: "jabaquara",
    name: "Jabaquara",
    ...
    profile: "bairro de conexao com grande fluxo, prédios, hotéis, escolas, clínicas, comércios e serviços próximos a corredores viarios",
    ...
    urgency: "No Jabaquara, imóveis com atendimento ao público precisam regularizar antes de fiscalização e renovação de licenças.",
  ...
  },
  {
    ...
    profile: "região com condomínios novos, galpões, logística, escritórios, studios, mercados e restaurantes",
    buildings: ["galpões", "condomínios", "escritorios", "restaurantes"],
    risks: ["mudança de uso industrial para comercial", "hidrante sem teste", "SPDA sem laudo", "projeto antigo"],
    urgency: "Na Vila Leopoldina, retrofit e mudança de uso exigem compatibilização para evitar AVCB fora da realidade atual.",
  ...
  },
  {
    ...
    profile: "bairro em verticalização com condomínios, faculdades, comércio, galpões remanescentes e prédios comerciais",
    buildings: ["condomínios", "faculdades", "lojas", "galpões e escritórios"],
    risks: ["AVCB antigo sem refletir reforma", "pressurização e escada sem laudo", "alarme vencido", "rotas alteradas"],
    urgency: "Na Vila Prudente, verticalização e reforma de imóveis antigos tornam a revisão do AVCB essencial.",
  ...
  },
  {
    ...
    name: "Morumbi",
    zone: "Zona Sul",
    localRefs: ["Avenida Giovanni Gronchi", "Avenida Morumbi", "Estádio do Morumbi", "Ponte do Morumbi"],
    profile: "bairro com condomínios de alto padrão, escolas, hospitais, clínicas, escritórios e empreendimentos de grande área",
    buildings: ["condomínios verticais", "escolas", "clínicas", "prédios corporativos"],
    risks: ["SPDA e pressurização sem laudo", "brigada vencida", "garagens sem sinalização", "sistemas sem teste"],
    urgency: "No Morumbi, administradoras e síndicos precisam controlar prazos de laudos para não perder a renovação do AVCB.",
  ...
  },
  {
    ...
    profile: "região de condomínios, shopping, restaurantes, escolas, clínicas e comércio de maior padrão",
    buildings: ["condomínios", "restaurantes", "clínicas", "lojas e escolas"],
    risks: ["GLP sem atualização", "sistemas de prédio sem laudo", "rotas em garagens", "AVCB vencido"],
    urgency: "No Analia Franco, a exigência costuma envolver condomínios e comércios com alto fluxo e documentação técnica vencida.",
  ...
  },
  {
    ...
    urgency: "Na Saúde, clínicas e consultorios precisam alinhar AVCB, laudos e licenças para evitar problemas com fiscalização.",
  ...
  },
  {
    ...
    urgency: "No Ipiranga, a idade dos imóveis torna essencial conferir projeto, rotas e sistemas antes da renovação.",
  ...
  },
  {
    ...
    risks: ["pressurização sem laudo", "SPDA vencido", "rotas em garagens", "brigada sem reciclagem"],
    urgency: "Em Santana, a renovação costuma depender de laudos de sistemas prediais e organização documental do condomínio.",
  ...
  },
  {
    ...
    profile: "bairro com prédios residenciais, comércio local, shopping, escolas, serviços e condomínios antigos",
  ...
  },
  {
    ...
    profile: "bairro de bares, restaurantes, casas de evento, hostels, estudios, escritórios criativos e imóveis adaptados",
    ...
    urgency: "Na Vila Madalena, AVCB vencido pode impactar alvará, evento, seguro e operação noturna.",
  ...
  },
  {
    ...
    localRefs: ["Rua da Consolação", "Avenida Paulista", "Avenida Angélica", "Mackenzie"],
    profile: "região com prédios comerciais, faculdades, teatros, clínicas, restaurantes, galerias e imóveis antigos",
    ...
    urgency: "Na Consolação, a regularização exige atenção a lotação, rotas e sistemas de prédios antigos de uso misto.",
  ...
  },
  {
    ...
    urgency: "Na Liberdade, a concentração de restaurantes e fluxo turistico exige AVCB coerente com lotação e sistemas ativos.",
  ...
  },
  {
    ...
    profile: "região central com prédios históricos, galerias, igrejas, comércio popular, escritórios e imóveis de uso misto",
    buildings: ["prédios históricos", "galerias", "igrejas", "comércio popular"],
    risks: ["edificação antiga", "rotas complexas", "instalação elétrica antiga", "projeto inexistente"],
    urgency: "Na Sé, imóveis antigos precisam de diagnóstico técnico cuidadoso para evitar exigências em serie.",
  ...
  },
  {
    ...
    name: "Barra Funda",
    zone: "Zona Oeste",
    localRefs: ["Terminal Barra Funda", "Avenida Marques de São Vicente", "Memorial da America Latina", "Avenida Francisco Matarazzo"],
    profile: "região com galpões convertidos, escritórios, eventos, universidades, centros logisticos urbanos e prédios residenciais novos",
    buildings: ["galpões retrofitados", "casas de evento", "escritorios", "condomínios"],
    risks: ["mudança de uso sem projeto", "lotação de eventos", "hidrantes sem teste", "rotas alteradas"],
  ...
  },
  {
    ...
    profile: "bairro com prédios residenciais antigos de alto padrão, escolas, hospitais, clínicas, comércio e edifícios mistos",
    buildings: ["condomínios antigos", "escolas", "clínicas", "prédios mistos"],
    risks: ["SPDA sem medição", "pressurização sem laudo", "rotas em garagens", "projeto antigo"],
  ...
  },
  {
    ...
    profile: "região com hospitais, clínicas, escritórios, escolas, hotéis, prédios comerciais e grande circulação de pessoas",
    ...
    urgency: "No Paraíso, a proximidade com polos de saude e escritórios torna o AVCB crítico para licenças e continuidade do atendimento.",
  ...
  },
  {
      ...
      "profile": "mega-condomínios e torres residenciais fechadas",
      "buildings": [
          "condomínios verticais",
