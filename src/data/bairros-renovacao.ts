...
export const bairrosCondominio: BairroData[] = [
  ...
  },
  {
    ...
    problemas: ["Lotação acima do projeto aprovado","Saídas de emergência subdimensionadas","Manutenção de sistemas vencida"],
    problemasDesc: ["Ampliações de área comercial sem revisão do projeto técnico fazem a população real superar a capacidade calculada das rotas de fuga.","Galerias e centros comerciais antigos têm largura de corredor e número de saídas dimensionados para uma lotação menor que a atual.","Em prédios com muitas lojas, a manutenção de extintores, alarme e iluminação de emergência costuma estar sem registro ou com laudo vencido."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido em Aricanduva. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Mudança de uso sem novo enquadramento","Compartimentação de galpões antigos","Controle de público em casas de eventos"],
    problemasDesc: ["Imóveis que eram industriais e viraram escritórios ou eventos mantêm projeto antigo incompatível com a nova ocupação.","Estruturas amplas de galpão exigem revisão de compartimentação, rotas de fuga e carga de incêndio para o uso atual.","Espaços de eventos precisam comprovar controle de acesso e lotação, item reforçado pelo regulamento atual."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Barra Funda. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Mudança de uso sem revisão de projeto","Restaurantes com gás e cozinha sem laudo","Condomínios com manutenção em atraso"],
    problemasDesc: ["Imóveis comerciais que trocaram de atividade mantêm projeto incompatível com a carga de incêndio e a lotação atuais.","Restaurantes precisam de laudo de estanqueidade de gás e adequação da cozinha, itens frequentemente esquecidos na renovação.","Prédios residenciais antigos chegam ao vencimento do AVCB com sistemas e ARTs sem atualização."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido no Carrão. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Sistemas antigos sem modernização","SPDA e elétrica sem laudo atual","Documentação de manutenção incompleta"],
    problemasDesc: ["Prédios das décadas anteriores mantêm hidrantes, bombas e alarme sem revisão compatível com as exigências atuais.","O SPDA e as instalações elétricas frequentemente estão sem inspeção e sem ART, item observado de perto na vistoria.","Faltam registros de manutenção de extintores, alarme e iluminação, o que gera exigências no protocolo."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Casa Verde. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Imóveis antigos sem planta atual","Rotas de fuga estreitas","Mudança de uso não regularizada"],
    problemasDesc: ["Construções tradicionais reformadas ao longo dos anos perderam a correspondência com o projeto aprovado original.","Edificações antigas têm corredores e saídas estreitos, que precisam de avaliação frente à lotação atual.","Casas que viraram comércio ou serviço mantêm enquadramento incompatível com a atividade real."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Freguesia do Ó. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Lotação acima do previsto em projeto","Controle de acesso de público","Sistemas de combate sem manutenção"],
    problemasDesc: ["Comércios e espaços de reunião que recebem mais público do que a planta aprovada comprometem a capacidade das saídas.","Estabelecimentos de público precisam comprovar controle de acesso e lotação, item reforçado no regulamento atual.","Hidrantes, alarme e iluminação de emergência costumam estar sem registro de manutenção atualizado."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido em Itaquera. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Mudança de uso sem FAT protocolado","Sistemas sem manutenção registrada","Brigada de incêndio vencida"],
    problemasDesc: ["Imóveis que trocaram de atividade sem regularizar o Formulário de Atendimento Técnico ficam com projeto incompatível.","Extintores, alarme e iluminação de emergência costumam estar sem registro de manutenção atualizado.","Em imóveis que exigem brigada, o treinamento vencido vira exigência no momento da renovação."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido no Jaçanã. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Carga de incêndio elevada","Rotas de fuga estreitas e obstruídas","Uso misto sem enquadramento atual"],
    problemasDesc: ["A concentração de comércio, estoque e restaurantes eleva o risco e exige sistemas de combate compatíveis.","Edifícios antigos têm corredores e escadas estreitos, muitas vezes obstruídos por mercadoria.","Prédios que misturam comércio, serviço e moradia precisam de enquadramento que reflita todos os usos."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Liberdade. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Carga de incêndio acima do projeto","Rotas de fuga bloqueadas por estoque","Laudo elétrico e SPDA pendentes"],
    problemasDesc: ["A troca do tipo de material armazenado altera a carga de incêndio e pode exigir sistemas de combate mais robustos.","Empilhamento de mercadoria sobre rotas e saídas é um dos itens que mais geram exigência na vistoria.","Galpões antigos chegam à renovação com instalações elétricas e SPDA sem inspeção e sem ART."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido no Limão. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Sistemas de prédios altos defasados","Uso de saúde com exigências específicas","Documentação corporativa desencontrada"],
    problemasDesc: ["Edifícios verticais antigos têm hidrantes, alarme e escadas que precisam de adequação às Instruções Técnicas atuais.","Clínicas e hospitais têm exigências próprias de rota, sinalização e sistemas, que pesam na vistoria.","Em prédios corporativos com vários ocupantes, falta organização de laudos, ARTs e responsabilidades."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido no Paraíso. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Mudança de uso sem revisão de projeto","Imóveis antigos com rotas estreitas","Sinalização e laudos desatualizados"],
    problemasDesc: ["Lojas e casas que trocaram de atividade mantêm enquadramento incompatível com a lotação e a carga de incêndio atuais.","Construções antigas têm corredores e saídas estreitos, que precisam ser avaliados frente ao uso de hoje.","Sinalização desgastada e laudos vencidos de elétrica, SPDA e hidrantes são exigências recorrentes na região."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Penha. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Armazenamento acima do limite do projeto","Sistemas de hidrantes inoperantes","Documentação de manutenção falha nos condomínios"],
    problemasDesc: ["Galpões e atacadistas frequentemente estocam mercadorias em níveis que exigem novos cálculos de carga de incêndio.","Redes de hidrantes em imóveis mais velhos apresentam falhas de estanqueidade e motores sem manutenção.","Condomínios residenciais grandes frequentemente trocam de síndico e perdem o histórico de manutenção dos extintores."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido no Sapopemba. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Escadas sem compartimentação ou ventilação","Fiação elétrica obsoleta sem laudo","Impossibilidade arquitetônica de reformas"],
    problemasDesc: ["Edifícios antigos não possuem escadas enclausuradas e o Corpo de Bombeiros exige sistemas paliativos de segurança.","A fiação antiga (às vezes com pano) é risco iminente e requer readequação elétrica antes do laudo técnico.","Tombamento e restrições estruturais impedem que rotas de fuga sejam ampliadas fisicamente."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Sé. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
  ...
  },
  {
    ...
    problemas: ["Casas residenciais transformadas em comércio sem FAT","Lojas com mezaninos não documentados","Condomínios de pequeno porte sem laudos (SPDA)"],
    problemasDesc: ["A conversão de uso sem trâmite no Corpo de Bombeiros impede a renovação simples do documento.","A criação de mezaninos para estoque altera a área construída e invalida a planta do projeto anterior.","Prédios menores costumam negligenciar o laudo do para-raios (SPDA) até a hora de renovar o AVCB."],
    testimonial: {"text":"[Substituir por depoimento real de cliente atendido na Vila Ré. Não publicar texto fictício.]","author":"[Nome do cliente]","role":"[Tipo de imóvel / cargo]"},
