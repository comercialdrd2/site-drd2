...
export const bairrosCondominio: BairroData[] = [
  ...
  },
  {
    ...
    "guiaLegislacaoLocal": "A aprovação de projetos técnicos e a emissão do Auto de Vistoria do Corpo de Bombeiros (AVCB) no bairro de Vila Andrade obedecem rigorosamente aos trâmites do Comando do Corpo de Bombeiros da Polícia Militar do Estado de São Paulo (CBPMESP), em conjunto com as diretrizes da Subprefeitura responsável pela Zona Sul. Devido ao perfil local, marcado por mega-condomínios e torres residenciais fechadas, a fiscalização na região da Av. Giovanni Gronchi, Rua Itapaiúna, Rua José Ramon Urtiza tem se intensificado, especialmente após as recentes atualizações do Decreto Estadual 69.118/2024. O decreto exige que edificações existentes se adaptem às novas Instruções Técnicas (ITs), sob pena de interdição.\n\nMuitos gestores e síndicos em Vila Andrade desconhecem que a responsabilidade civil e criminal em caso de sinistro recai integralmente sobre eles. Se uma edificação não possui o AVCB válido ou se as medidas de segurança contra incêndio (como extintores, mangueiras e detectores) estiverem inoperantes, a apólice de seguro predial pode ser sumariamente anulada. Em uma região com mega-condomínios e torres residenciais fechadas, a ausência de compartimentação adequada ou falhas no sistema elétrico potencializam o risco estrutural. É por isso que a engenharia preventiva se torna não apenas uma exigência legal, mas um escudo jurídico para a administração.\n\nO processo de renovação em Vila Andrade começa com a fase de diagnóstico e emissão de laudos técnicos especializados. Nossos engenheiros realizam o levantamento de campo minucioso para avaliar se a infraestrutura existente atende à IT-16 (Sistemas de proteção por extintores), IT-22 (Sistemas de hidrantes), e IT-41 (Inspeção visual em instalações elétricas). Caso haja divergências entre o Projeto Técnico aprovado anteriormente e a realidade física da edificação — como o fechamento irregular de varandas ou alteração de rotas de fuga —, é obrigatório protocolar um Formulário de Atendimento Técnico (FAT) ou um Projeto Técnico de Substituição (PTS) junto ao Via Fácil Bombeiros.\n\nApós a adequação física e documental, todos os laudos (ARTs de elétrica, SPDA, gás e bombas) são consolidados e submetidos eletronicamente. A vistoria do CBPMESP na região de Vila Andrade é rigorosa e os tenentes vistoriadores testam na prática o funcionamento das bombas de recalque e o acionamento do alarme geral. Com a DRD2 Engenharia, acompanhamos o vistoriador presencialmente em seu endereço próximo à Av. Giovanni Gronchi, Rua Itapaiúna, Rua José Ramon Urtiza, garantindo que qualquer questionamento técnico seja sanado imediatamente, resultando na emissão rápida e segura do seu AVCB.",
  ...
  },
  {
    ...
    "perfil": "polo comercial de grande porte, com shopping centers, galerias, lojas de rua, galpões logisticos e condomínios residenciais de medio porte",
    "intro": "Aricanduva concentra um dos maiores eixos de comércio e reunião de público da Zona Leste, com edificações de grande área construida e fluxo intenso de pessoas. Esse perfil de alta lotação coloca a renovação do AVCB no centro das atenções, porque o Decreto Estadual 69.118/2024 reforcou as exigências de saídas de emergência, iluminação e sinalização para locais que recebem público.",
    "box": "Em Aricanduva, a causa de reprovação mais frequente e a lotação real divergente da prevista no projeto aprovado. Lojas e galerias que ampliaram a área de atendimento, criaram mezaninos ou subdividiram pavimentos sem atualizar a planta acabam com rotas de fuga subdimensionadas para o público que recebem hoje.",
    "problemas": [
    ...
    "problemasDesc": [
      ...
      "Galerias e centros comerciais antigos tem largura de corredor e número de saídas dimensionados para uma lotação menor que a atual.",
    ...
    "faq1a": "Depende da área, da lotação e das pendencias de laudo. Em imóveis comerciais de Aricanduva, o caminho mais rápido e comecar com um diagnóstico documental e uma pre-vistoria, evitando exigências previsíveis do CBPMESP que costumam atrasar a liberação.",
    "faq2q": "Minha galeria recebe mais público do que diz a planta. Isso reprova a vistoria?",
    "faq2a": "Pode reprovar, sim. Quando a lotação real supera a prevista no projeto, as saídas de emergência ficam subdimensionadas. O ideal e revisar o projeto e adequar as rotas antes de protocolar a renovação.",
    ...
    "guiaLegislacaoLocal": "A renovação do Auto de Vistoria do Corpo de Bombeiros (AVCB) em Aricanduva segue os tramites do Comando do Corpo de Bombeiros da Policia Militar do Estado de São Paulo (CBPMESP), hoje regidos pelo Decreto Estadual 69.118/2024 e pelas Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025. Por se tratar de uma região de forte comércio e reunião de público, a fiscalização nos eixos da Avenida Aricanduva e Avenida Itaquera e rigorosa quanto a lotação, saídas de emergência e sinalização.\n\nO processo comeca com o diagnóstico do imóvel: confirmar se o enquadramento correto e CLCB, AVCB com vistoria ou projeto técnico, e verificar se a planta aprovada corresponde ao uso atual. Divergências comuns em Aricanduva — fechamento de áreas, mezaninos e subdivisão de lojas — exigem a atualização do projeto ou o protocolo de um Formulario de Atendimento Técnico (FAT) junto ao sistema Via Fácil Bombeiros.\n\nEm seguida, os sistemas de segurança são preparados antes da vistoria: extintores, alarme, iluminação e sinalização de emergência, hidrantes, SPDA e laudo elétrico, todos com as respectivas ARTs. Com a DRD2 Engenharia, acompanhamos a vistoria presencialmente, de modo que qualquer questionamento do vistoriador seja resolvido na hora e o AVCB seja emitido com previsibilidade.",
    "custoDetalhe": "O custo da renovação em Aricanduva varia conforme a área construida, a quantidade de sistemas a revisar e a necessidade ou não de novo projeto técnico. Imóveis comerciais com lotação elevada e galerias com várias lojas tendem a exigir mais laudos e ARTs. O orçamento fechado e definido após o diagnóstico inicial, sem surpresas no meio do processo.",
  ...
  },
  {
    ...
    "avenidas": "Avenida Marques de São Vicente, Avenida Auro Soares de Moura Andrade e Rua Barra Funda",
    ...
    "problemasDesc": [
      "Imóveis que eram industriais e viraram escritórios ou eventos mantem projeto antigo incompatível com a nova ocupação.",
      "Estruturas amplas de galpão exigem revisão de compartimentação, rotas de fuga e carga de incêndio para o uso atual.",
      "Espaços de eventos precisam comprovar controle de acesso e lotação, item reforcado pelo regulamento atual."
    ],
    ...
    "faq2a": "Lotação compatível com as saídas, controle de acesso de público, iluminação e sinalização de emergência e sistemas de combate em ordem. O Decreto 69.118/2024 reforcou as exigências para locais de reunião de público.",
    "faq3q": "Quanto tempo leva a regularização de um galpão reconvertido na Barra Funda?",
    "faq3a": "Quando há mudança de uso, o prazo depende da elaboração do novo projeto e das adequações fisicas necessárias. O diagnóstico inicial define o cronograma realista, evitando promessas que não se cumprem.",
    "faq4q": "Prédio residencial novo na Barra Funda também precisa renovar o AVCB?",
    "faq4a": "Sim. Mesmo edificações novas tem AVCB com prazo de validade e dependem de manutenção continua dos sistemas. A renovação deve ser iniciada antes do vencimento para não interromper a regularidade do condomínio.",
    "guiaLegislacaoLocal": "A regularização junto ao CBPMESP na Barra Funda e regida pelo Decreto Estadual 69.118/2024 e pelas Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025. A região e marcada pela reconversão de galpões e fabricas, o que torna o enquadramento correto a etapa mais importante: o Corpo de Bombeiros avalia o uso real da edificação, não a destinação original do imóvel.\n\nQuando há mudança de uso — de industrial para escritório, coworking ou casa de eventos —, e obrigatório protocolar projeto técnico compatível com a nova ocupação pelo sistema Via Fácil Bombeiros. A compartimentação, as rotas de fuga, a carga de incêndio e a lotação precisam ser recalculadas. Para espaços de eventos, o controle de acesso de público passou a ser item de atenção no regulamento atual.\n\nA DRD2 Engenharia conduz esse processo do diagnóstico a vistoria: avalia a documentação existente, define o enquadramento, organiza laudos e ARTs de elétrica, SPDA, hidrantes e demais sistemas, e acompanha o vistoriador presencialmente na região da Avenida Marques de São Vicente e do Memorial da America Latina, garantindo a emissão do AVCB com segurança juridica.",
    "custoDetalhe": "Na Barra Funda, o custo e fortemente influenciado pela existencia ou não de mudança de uso. Imóveis que mantem a destinação original e so precisam de revisão de sistemas tem orçamento menor; galpões reconvertidos exigem novo projeto técnico e adequações fisicas. O valor final e fechado após o diagnóstico do imóvel.",
  ...
  },
  {
    ...
    "perfil": "comércio de rua forte, restaurantes, clínicas, prédios comerciais e condomínios residenciais de medio e alto padrão",
    "intro": "O Carrao combina um comércio de rua tradicional com prédios residenciais cada vez mais verticais e uma boa concentração de clínicas e restaurantes. Essa diversidade de ocupações faz com que a renovação do AVCB exija enquadramento preciso, já que o Decreto Estadual 69.118/2024 trata de forma diferente cada tipo de uso e nível de risco.",
    "box": "No Carrao, a reprovação costuma vir de imóveis que mudaram de função sem revisar o projeto: lojas que viraram restaurantes, casas que viraram clínicas. Essa troca de uso altera carga de incêndio, lotação e sistemas obrigatórios, e o projeto antigo deixa de representar a realidade.",
    "problemas": [
    ...
    "problemasDesc": [
      "Imóveis comerciais que trocaram de atividade mantem projeto incompatível com a carga de incêndio e a lotação atuais.",
    ...
    "faq1a": "Sim. Restaurante tem carga de incêndio, lotação e sistemas diferentes de uma loja. E necessário revisar o projeto e incluir itens como o laudo de estanqueidade de gás antes da renovação.",
    "faq2q": "Minha clínica no Carrao funciona em um sobrado adaptado. Isso complica a vistoria?",
    ...
    "faq3a": "O prazo depende da área, do tipo de ocupação e das pendencias de laudo. Comecar pela conferencia documental e por uma pre-vistoria reduz o risco de exigências e mantem o cronograma previsível.",
    "faq4q": "Condomínio residencial no Carrao pode ser multado por AVCB vencido?",
    "faq4a": "Sim. O síndico responde civil e criminalmente em caso de sinistro, e o AVCB vencido pode gerar autuação e problemas com o seguro predial. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB no Carrao segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A diversidade de ocupações da região — comércio, restaurantes, clínicas e condomínios ao longo da Avenida Conselheiro Carrao — exige atenção redobrada ao enquadramento correto de cada imóvel.\n\nO primeiro passo e confirmar se o caso e de CLCB, AVCB com vistoria ou projeto técnico, e verificar se a planta aprovada corresponde ao uso atual. Mudanças de atividade muito comuns no Carrao, como lojas que viraram restaurantes, alteram a carga de incêndio e a lotação e podem exigir revisão de projeto ou Formulario de Atendimento Técnico (FAT) protocolado pelo Via Fácil Bombeiros.\n\nA preparação dos sistemas vem antes do pedido de vistoria: extintores, alarme, iluminação e sinalização de emergência, hidrantes, SPDA, laudo elétrico e, para restaurantes, o laudo de estanqueidade de gás — todos acompanhados das ARTs. A DRD2 Engenharia organiza essa documentação e acompanha a vistoria presencialmente, garantindo que o AVCB do Carrao seja emitido sem retrabalho.",
    "custoDetalhe": "O custo da renovação no Carrao varia conforme o tipo de imóvel. Restaurantes e clínicas adaptados costumam exigir mais laudos do que lojas simples; condomínios dependem do número de sistemas a revisar. O orçamento e fechado após o diagnóstico, sem custos surpresa.",
    "ctaFinal": "AVCB perto de vencer no Carrao? Fale com um engenheiro e comece o diagnóstico antes que o documento trave a sua operação."
  },
  {
    "slug": "casa-verde",
    "nome": "Casa Verde",
    ...
    "intro": "A Casa Verde reune condomínios residenciais de diferentes idades, comércio de bairro e pequenas estruturas industriais e de serviço. Essa mistura faz da renovação do AVCB um processo que depende de diagnóstico individual, já que o Decreto Estadual 69.118/2024 exige adequação dos sistemas das edificações existentes as Instruções Técnicas atuais.",
    "box": "Na Casa Verde, o problema recorrente são prédios residenciais antigos que chegam ao vencimento do AVCB com sistemas que nunca foram modernizados — hidrantes sem teste de pressão, SPDA sem laudo e instalações elétricas sem inspeção. A renovação vira, na pratica, uma adequação técnica.",
    "problemas": [
    ...
    "problemasDesc": [
      "Prédios das decadas anteriores mantem hidrantes, bombas e alarme sem revisão compatível com as exigências atuais.",
    ...
    "faq1q": "Meu condomínio na Casa Verde e antigo. A renovação do AVCB exige obras?",
    "faq1a": "Pode exigir. Prédios antigos costumam precisar de adequações nos sistemas de segurança para atender as Instruções Técnicas atuais. O diagnóstico mostra com clareza o que e obrigatório antes da renovação.",
  ...
  },
  {
    ...
    "intro": "A Freguesia do Ó e um dos bairros mais antigos de São Paulo, com forte comércio de rua e muitos imóveis históricos adaptados ao longo dos anos. Essa caracteristica torna a renovação do AVCB delicada, porque o Decreto Estadual 69.118/2024 cobra que edificações antigas sejam adequadas as Instruções Técnicas atuais.",
    "box": "Na Freguesia do Ó, o obstaculo mais comum e a falta de planta atualizada. Imóveis antigos passaram por reformas e mudanças de uso sem documentação, e a vistoria reprova quando a edificação física não corresponde ao projeto que consta no Corpo de Bombeiros.",
    "problemas": [
    ...
    "problemasDesc": [
      "Construções tradicionais reformadas ao longo dos anos perderam a correspondencia com o projeto aprovado original.",
      "Edificações antigas tem corredores e saídas estreitos, que precisam de avaliação frente a lotação atual.",
      "Casas que viraram comércio ou serviço mantem enquadramento incompatível com a atividade real."
    ],
    "faq1q": "Meu imóvel na Freguesia do Ó e antigo e não tenho a planta. E agora?",
    "faq1a": "E preciso levantar a edificação e produzir uma planta compatível com a realidade física. Sem esse documento, a vistoria reprova. O diagnóstico inicial define se basta atualizar o projeto ou se há adequações a fazer.",
    "faq2q": "Transformei uma casa em comércio na Freguesia do Ó. Preciso de novo AVCB?",
    "faq2a": "Sim. A mudança de uso altera o enquadramento no Corpo de Bombeiros. E necessário projeto técnico compatível com a atividade comercial antes da emissão ou renovação do AVCB.",
    "faq3q": "Quanto tempo leva a renovação do AVCB na Freguesia do Ó?",
    "faq3a": "Em imóveis antigos, o prazo depende do levantamento da planta e das adequações necessárias. Comecar pelo diagnóstico evita exigências previsíveis e mantem o cronograma realista.",
    "faq4q": "Comércio com AVCB vencido na Freguesia do Ó corre risco de interdição?",
    "faq4a": "Sim. AVCB vencido expoe o imóvel a autuação, interdição, recusa de seguro e problemas com o alvará. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Freguesia do Ó segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, analisadas pelo CBPMESP. Por ser um bairro tradicional, com muitos imóveis antigos adaptados em torno do Largo da Matriz e da Avenida Itaberaba, o desafio central e comprovar a correspondencia entre a edificação física e o projeto aprovado.\n\nQuando há divergência — reformas, ampliações, fechamento de áreas ou mudança de uso —, e obrigatório atualizar o projeto ou protocolar um Formulario de Atendimento Técnico (FAT) pelo sistema Via Fácil Bombeiros. Edificações antigas também exigem atenção as rotas de fuga e a lotação, que precisam ser avaliadas frente ao uso atual do imóvel.\n\nA DRD2 Engenharia conduz o diagnóstico documental, faz o levantamento de campo, organiza os laudos e ARTs dos sistemas de segurança e acompanha a vistoria presencialmente na Freguesia do Ó. Esse acompanhamento garante que qualquer exigência do vistoriador seja resolvida na hora, resultando na emissão do AVCB sem retrabalho.",
    "custoDetalhe": "Na Freguesia do Ó, o custo da renovação depende muito do estado documental do imóvel. Quando e preciso levantar a planta e regularizar mudança de uso, o orçamento e maior do que em imóveis com documentação em dia. O valor e fechado após o diagnóstico.",
    "ctaFinal": "Imóvel antigo na Freguesia do Ó com AVCB vencido? Fale com um engenheiro e organize a regularização sem dor de cabeca."
  },
  {
    "slug": "itaquera",
    "nome": "Itaquera",
    ...
    "intro": "Itaquera reune grandes equipamentos de reunião de público, comércio em expansão e muitos condomínios residenciais. Esse perfil de alta circulação de pessoas torna a renovação do AVCB um ponto sensível, porque o Decreto Estadual 69.118/2024 reforcou as exigências de saídas, sinalização e controle de lotação para locais que recebem público.",
    "box": "Em Itaquera, a reprovação mais frequente esta ligada ao controle de acesso e a lotação em estabelecimentos comerciais e de eventos. Quando o número de pessoas supera o previsto no projeto, as rotas de fuga ficam subdimensionadas e a vistoria não aprova.",
    "problemas": [
    ...
    "problemasDesc": [
      ...
      "Estabelecimentos de público precisam comprovar controle de acesso e lotação, item reforcado no regulamento atual.",
    ...
    "faq1a": "Depende da área, da lotação e das pendencias de laudo. Em imóveis de reunião de público, o caminho mais rápido e comecar pelo diagnóstico e pela pre-vistoria, evitando exigências do CBPMESP que atrasam a liberação.",
    "faq2q": "Meu estabelecimento em Itaquera recebe muito público. O que preciso comprovar?",
    "faq2a": "Lotação compatível com as saídas de emergência, controle de acesso, iluminação e sinalização adequadas e sistemas de combate em ordem. O Decreto 69.118/2024 reforcou esses pontos para locais de reunião de público.",
    "faq3q": "Condomínio residencial em Itaquera também precisa renovar o AVCB?",
    "faq3a": "Sim. Todo AVCB tem prazo de validade e depende da manutenção continua dos sistemas. A renovação deve ser iniciada antes do vencimento para manter a regularidade do condomínio.",
    "faq4q": "AVCB vencido pode interditar meu negócio em Itaquera?",
    "faq4a": "Sim. AVCB vencido expoe o estabelecimento a autuação, interdição, recusa de seguro e responsabilidade civil em caso de sinistro. A renovação deve comecar com antecedencia.",
    "guiaLegislacaoLocal": "A renovação do AVCB em Itaquera segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. Por concentrar grandes equipamentos de reunião de público e comércio em expansão ao longo da Avenida Itaquera e da Radial Leste, a fiscalização na região e rigorosa quanto a lotação, saídas de emergência e controle de acesso.\n\nO processo comeca com o diagnóstico: confirmar o enquadramento correto — CLCB, AVCB com vistoria ou projeto técnico — e verificar se a planta aprovada corresponde ao uso real. Divergências de área e lotação exigem revisão de projeto ou protocolo de Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nAntes da vistoria, os sistemas são preparados: extintores, alarme, iluminação e sinalização de emergência, hidrantes, SPDA e laudo elétrico, todos com ART. A DRD2 Engenharia acompanha a vistoria presencialmente em Itaquera, de modo que qualquer questionamento técnico seja resolvido na hora e o AVCB seja emitido com previsibilidade.",
    "custoDetalhe": "O custo da renovação em Itaquera varia conforme a área, a lotação e a quantidade de sistemas a revisar. Estabelecimentos de reunião de público tendem a exigir mais laudos e ARTs do que imóveis menores. O orçamento fechado e definido após o diagnóstico inicial.",
  ...
  },
  {
    ...
    "intro": "O Jacana combina comércio de bairro, escolas, condomínios e pequenas indústrias, formando um conjunto variado de ocupações. Essa diversidade exige enquadramento preciso na renovação do AVCB, já que o Decreto Estadual 69.118/2024 trata de forma distinta cada tipo de uso e nível de risco.",
    "box": "No Jacana, a dificuldade mais comum e reunir os documentos e adequar os sistemas antes do vencimento do AVCB. Muitos imóveis chegam a renovação com manutenção em atraso e mudança de uso não regularizada, o que gera exigências previsíveis na vistoria.",
    "problemas": [
    ...
    "problemasDesc": [
      "Imóveis que trocaram de atividade sem regularizar o Formulario de Atendimento Técnico ficam com projeto incompatível.",
    ...
    "faq1a": "O prazo depende da área, do tipo de ocupação e das pendencias de laudo. Iniciar pela conferencia documental e pela pre-vistoria reduz o risco de exigências do CBPMESP e mantem o cronograma previsível.",
    "faq2q": "Minha escola no Jacana precisa de brigada de incêndio para renovar o AVCB?",
    "faq2a": "Depende do enquadramento da edificação. Quando a brigada e obrigatória, o treinamento precisa estar válido. O diagnóstico identifica o que e exigido para o seu imóvel.",
    "faq3q": "Quais documentos preciso para a renovação no Jacana?",
    "faq3a": "Planta aprovada, dados do imóvel e do responsável, laudos e ARTs dos sistemas, comprovantes de manutenção e o AVCB anterior. Organizar tudo com antecedencia acelera a análise.",
    ...
    "guiaLegislacaoLocal": "A renovação do AVCB no Jacana e regida pelo Decreto Estadual 69.118/2024 e pelas Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A variedade de ocupações da região — comércio, escolas, condomínios e pequenas indústrias ao longo da Avenida Guapira — torna o enquadramento correto a etapa decisiva do processo.\n\nO primeiro passo e confirmar se o caso e de CLCB, AVCB com vistoria ou projeto técnico, e verificar se a planta aprovada corresponde ao uso atual. Mudanças de atividade exigem revisão de projeto ou protocolo de Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros. Em imóveis que exigem brigada de incêndio, o treinamento precisa estar válido.\n\nA DRD2 Engenharia organiza a documentação, consolida os laudos e ARTs de elétrica, SPDA, hidrantes e demais sistemas e acompanha a vistoria presencialmente no Jacana. Esse acompanhamento garante que exigências sejam resolvidas na hora e o AVCB seja emitido com previsibilidade.",
    "custoDetalhe": "O custo da renovação no Jacana depende do tipo de imóvel e do estado dos sistemas. Escolas e pequenas indústrias costumam exigir mais laudos e brigada; comércios menores tem orçamento mais enxuto. O valor final e fechado após o diagnóstico.",
    "ctaFinal": "AVCB vencendo no Jacana? Fale com um engenheiro e organize a documentação antes que o prazo aperte."
  },
  {
    "slug": "liberdade",
    "nome": "Liberdade",
    ...
    "box": "Na Liberdade, o ponto crítico e a alta carga de incêndio combinada com rotas de fuga estreitas. Galerias e edifícios antigos acumulam comércio, estoque e cozinhas em estruturas que não foram projetadas para a densidade de público e de material que recebem hoje.",
    "problemas": [
    ...
    "problemasDesc": [
      ...
      "Edifícios antigos tem corredores e escadas estreitos, muitas vezes obstruidos por mercadoria.",
      "Prédios que misturam comércio, serviço e moradia precisam de enquadramento que reflita todos os usos."
    ],
    "faq1q": "Tenho uma loja em galeria na Liberdade. O AVCB e do imóvel todo ou so da minha loja?",
    "faq1a": "Em galerias e edifícios de uso misto, o AVCB normalmente abrange a edificação. E preciso avaliar a situação do prédio inteiro e a da sua unidade. O diagnóstico esclarece o enquadramento e o caminho da renovação.",
    "faq2q": "Por que a Liberdade e considerada área de risco maior pelo Corpo de Bombeiros?",
    ...
    "faq3a": "Depende do estado da edificação e das adequações necessárias. Em prédios antigos e densos, o diagnóstico inicial e essencial para definir um cronograma realista e evitar exigências.",
    "faq4q": "Comércio com AVCB vencido na Liberdade corre risco de interdição?",
    "faq4a": "Sim. Em área de alta circulação, a fiscalização e frequente. AVCB vencido expoe o imóvel a autuação, interdição e recusa de seguro. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Liberdade segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A região central, com comércio denso e edifícios antigos em torno da Rua Galvao Bueno e da Avenida da Liberdade, e tratada com rigor pela fiscalização por causa da elevada carga de incêndio e da circulação intensa de público.\n\nO enquadramento correto e a etapa decisiva: confirmar se o caso e CLCB, AVCB com vistoria ou projeto técnico, e verificar se a planta aprovada corresponde ao uso atual. Em edifícios de uso misto, e comum que o projeto antigo não represente a soma de comércio, serviço e moradia que existe hoje, exigindo revisão de projeto ou Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nA preparação dos sistemas — extintores, alarme, hidrantes, iluminação e sinalização de emergência, SPDA e laudo elétrico — precisa anteceder a vistoria, com as respectivas ARTs. A DRD2 Engenharia faz o diagnóstico, organiza a documentação e acompanha a vistoria presencialmente na Liberdade, garantindo a emissão do AVCB com segurança.",
    "custoDetalhe": "Na Liberdade, o custo da renovação e influenciado pela idade do prédio e pela densidade de uso. Edifícios antigos de uso misto, com rotas a adequar, tem orçamento maior do que unidades simples. O valor e fechado após o diagnóstico da edificação.",
  ...
  },
  {
    ...
    "perfil": "galpões, transportadoras, centros de distribuição menores, condomínios e comércio próximos a eixos logisticos",
    "intro": "O Limao e marcado por galpões, transportadoras e pequenos centros de distribuição próximos a importantes eixos viarios, ao lado de condomínios e comércio de bairro. Esse perfil logístico torna a renovação do AVCB sensível a carga de incêndio, item de atenção no Decreto Estadual 69.118/2024.",
    "box": "No Limao, a reprovação mais comum vem de galpões com carga de incêndio elevada e rotas de fuga bloqueadas por estoque. O empilhamento de mercadoria e a mudança de produto armazenado alteram o risco e podem deixar a edificação fora do que foi aprovado em projeto.",
    "problemas": [
    ...
    "problemasDesc": [
      ...
      "Empilhamento de mercadoria sobre rotas e saídas e um dos itens que mais geram exigência na vistoria.",
      "Galpões antigos chegam a renovação com instalações elétricas e SPDA sem inspeção e sem ART."
    ],
    "faq1q": "Mudei o tipo de produto que armazeno no meu galpão do Limao. Preciso revisar o AVCB?",
    "faq1a": "Sim. O tipo de material muda a carga de incêndio e pode exigir sistemas de combate diferentes. E necessário revisar o enquadramento antes da renovação para não reprovar na vistoria.",
    "faq2q": "O Corpo de Bombeiros cobra muito as rotas de fuga em galpões do Limao?",
    "faq2a": "Cobra. Saídas e corredores obstruidos por estoque são item recorrente de exigência. As rotas precisam estar livres e sinalizadas no momento da vistoria.",
    "faq3q": "Quanto tempo leva para renovar o AVCB de um galpão no Limao?",
    "faq3a": "Depende da área, da carga de incêndio e das pendencias de laudo. O diagnóstico inicial avalia os sistemas e define um cronograma realista, evitando exigências previsíveis.",
    "faq4q": "AVCB vencido em galpão do Limao atrapalha contrato e seguro?",
    ...
    "guiaLegislacaoLocal": "A renovação do AVCB no Limao segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. Por concentrar galpões e operações logisticas próximas a eixos viarios, a região exige atenção especial a carga de incêndio e a compatibilidade entre o material armazenado e o projeto aprovado.\n\nO diagnóstico inicial confirma o enquadramento — CLCB, AVCB com vistoria ou projeto técnico — e verifica se o uso atual corresponde a planta. Quando o tipo de produto ou o layout mudaram, e necessário revisar o projeto ou protocolar um Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros, recalculando a carga de incêndio e os sistemas de combate.\n\nAntes da vistoria, a DRD2 Engenharia organiza os laudos e ARTs de instalações elétricas, SPDA, hidrantes e bombas, e confere se as rotas de fuga estão livres e sinalizadas. Acompanhamos a vistoria presencialmente no Limao, resolvendo qualquer questionamento na hora e assegurando a emissão do AVCB.",
    "custoDetalhe": "No Limao, o custo da renovação depende da área do galpão, da carga de incêndio e dos sistemas exigidos. Operações com material de maior risco tendem a precisar de sistemas mais robustos. O orçamento fechado e definido após o diagnóstico técnico.",
    "ctaFinal": "Galpão com AVCB perto de vencer no Limao? Fale com um engenheiro e evite perder contrato, seguro ou sofrer interdição."
  },
  {
    "slug": "paraiso",
    "nome": "Paraiso",
    ...
    "perfil": "edifícios comerciais e corporativos, consultorios, clínicas, hospitais, hoteis e prédios residenciais verticais de alto padrão",
    "intro": "O Paraiso reune edifícios corporativos, uma forte concentração de clínicas e hospitais e prédios residenciais verticais de alto padrão, na transição entre a Avenida Paulista e a Vila Mariana. Esse perfil de edificações altas e de uso intenso torna a renovação do AVCB exigente diante do Decreto Estadual 69.118/2024.",
    "box": "No Paraiso, o ponto de atenção são os edifícios verticais altos: a renovação cobra de perto sistemas como hidrantes, alarme, iluminação de emergência e, em muitos casos, pressurização de escada. Prédios antigos chegam ao vencimento com esses sistemas defasados em relação a norma atual.",
    "problemas": [
      "Sistemas de prédios altos defasados",
      "Uso de saude com exigências específicas",
      "Documentação corporativa desencontrada"
    ],
    "problemasDesc": [
      "Edifícios verticais antigos tem hidrantes, alarme e escadas que precisam de adequação as Instruções Técnicas atuais.",
      "Clínicas e hospitais tem exigências próprias de rota, sinalização e sistemas, que pesam na vistoria.",
      "Em prédios corporativos com vários ocupantes, falta organização de laudos, ARTs e responsabilidades."
    ],
    "faq1q": "Meu edifício comercial no Paraiso e alto e antigo. A renovação exige adequações?",
    "faq1a": "Geralmente sim. Prédios verticais antigos costumam precisar de adequação em hidrantes, alarme, iluminação de emergência e, as vezes, na escada. O diagnóstico mostra o que e obrigatório antes da renovação.",
    "faq2q": "Tenho uma clínica no Paraiso. O AVCB tem exigências diferentes?",
    "faq2a": "Sim. Imóveis de saude tem exigências específicas de rotas, sinalização e sistemas de segurança. E importante avaliar o enquadramento correto para evitar exigências e atraso na vistoria.",
    "faq3q": "Quanto tempo leva a renovação do AVCB de um prédio no Paraiso?",
    ...
    "faq4q": "AVCB vencido em edifício do Paraiso traz risco para o condomínio?",
    "faq4a": "Sim. O documento vencido expoe a administração a autuação, a interdição e a recusa de seguro, além da responsabilidade civil. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB no Paraiso e regida pelo Decreto Estadual 69.118/2024 e pelas Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A região, com edifícios corporativos altos e forte presença de clínicas e hospitais entre a Avenida Paulista e a Rua Vergueiro, recebe fiscalização atenta a sistemas de combate, rotas de fuga e sinalização.\n\nO processo comeca com o diagnóstico do imóvel e a confirmação do enquadramento — CLCB, AVCB com vistoria ou projeto técnico. Em edifícios verticais antigos, e comum identificar a necessidade de adequar hidrantes, alarme e escadas as Instruções Técnicas atuais; quando há divergência de projeto, protocola-se a revisão ou um Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nA DRD2 Engenharia consolida os laudos e ARTs de elétrica, SPDA, hidrantes, bombas e demais sistemas e acompanha a vistoria presencialmente no Paraiso. Para imóveis de saude, atenção redobrada ao enquadramento específico. O acompanhamento garante que exigências sejam resolvidas na hora e o AVCB seja emitido com previsibilidade.",
    "custoDetalhe": "No Paraiso, o custo da renovação cresce com a altura e a idade do edifício e com a complexidade dos sistemas. Imóveis de saude e prédios altos exigem mais laudos e ARTs. O orçamento e fechado após o diagnóstico da edificação.",
    "ctaFinal": "Edifício ou clínica no Paraiso com AVCB vencendo? Fale com um engenheiro e antecipe as adequações para não travar a vistoria."
  },
  {
    "slug": "penha",
    "nome": "Penha",
    ...
    "intro": "A Penha e um bairro tradicional da Zona Leste, com forte comércio de rua, galerias e muitos imóveis antigos adaptados ao longo do tempo. Essa caracteristica torna a renovação do AVCB um processo de diagnóstico cuidadoso, já que o Decreto Estadual 69.118/2024 cobra a adequação das edificações existentes as Instruções Técnicas atuais.",
    "box": "Na Penha, muitos processos travam porque o imóvel mudou de uso ou ampliou o atendimento sem revisar projeto, lotação e sistemas de proteção. A vistoria reprova quando a edificação física não corresponde ao que esta aprovado no Corpo de Bombeiros.",
    "problemas": [
      "Mudança de uso sem revisão de projeto",
    ...
    "problemasDesc": [
      "Lojas e casas que trocaram de atividade mantem enquadramento incompatível com a lotação e a carga de incêndio atuais.",
      "Construções antigas tem corredores e saídas estreitos, que precisam ser avaliados frente ao uso de hoje.",
    ...
    "faq1a": "Imóveis antigos adaptados costumam ter rotas de fuga e sistemas que não acompanharam a nova função. Um diagnóstico técnico aponta o que precisa ser ajustado antes de protocolar a renovação no CBPMESP.",
    "faq2q": "Ampliei o atendimento da minha loja na Penha. Preciso atualizar o AVCB?",
    "faq2a": "Sim. Ampliar área ou aumentar o público altera lotação e rotas de fuga. E necessário revisar o projeto para que a edificação volte a corresponder ao que esta aprovado.",
    "faq3q": "Quanto tempo leva para renovar o AVCB na Penha?",
    "faq3a": "O prazo depende da área, do tipo de ocupação e das pendencias de laudo. Comecar pela conferencia documental e por uma pre-vistoria reduz o risco de exigências e mantem o cronograma previsível.",
    "faq4q": "AVCB vencido na Penha pode interditar meu imóvel?",
    "faq4a": "Sim. AVCB vencido expoe o imóvel a autuação, interdição, recusa de seguro e responsabilidade civil em caso de sinistro. A renovação deve ser iniciada antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Penha segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. Por ser um bairro tradicional, com muitos imóveis antigos adaptados em torno da Avenida Penha de Franca e do Largo do Rosario, o desafio central e comprovar a correspondencia entre a edificação física e o projeto aprovado.\n\nQuando o imóvel mudou de uso, ampliou o atendimento ou passou por reformas sem documentação, e necessário atualizar o projeto ou protocolar um Formulario de Atendimento Técnico (FAT) pelo sistema Via Fácil Bombeiros. As rotas de fuga e a lotação de construções antigas também exigem avaliação frente ao uso atual.\n\nA DRD2 Engenharia conduz o diagnóstico documental, faz o levantamento de campo, organiza os laudos e ARTs dos sistemas de segurança e acompanha a vistoria presencialmente na Penha. Esse acompanhamento garante que exigências do vistoriador sejam resolvidas na hora, resultando na emissão do AVCB sem retrabalho.",
    "custoDetalhe": "Na Penha, o custo da renovação depende do estado documental e físico do imóvel. Quando e preciso regularizar mudança de uso ou adequar rotas, o orçamento e maior do que em imóveis com documentação em dia. O valor e fechado após o diagnóstico.",
    "ctaFinal": "AVCB vencido na Penha? Fale com um engenheiro e organize a renovação antes que o documento trave a sua operação."
  },
  {
    "slug": "sapopemba",
    "nome": "Sapopemba",
    ...
    "perfil": "comércio de rua, condomínios residenciais, escolas, pequenas indústrias e galpões de pequeno porte",
    "intro": "Sapopemba e um bairro extenso da Zona Leste, com forte comércio de rua, condomínios, escolas e pequenas estruturas industriais. Essa variedade de ocupações faz com que a renovação do AVCB dependa de um enquadramento preciso, conforme exige o Decreto Estadual 69.118/2024.",
    "box": "Em Sapopemba, a dificuldade mais frequente e reunir a documentação e adequar os sistemas antes do vencimento. Imóveis comerciais e pequenas indústrias chegam a renovação com manutenção em atraso e, muitas vezes, sem o projeto aprovado em maos.",
    "problemas": [
      "Projeto aprovado indisponivel ou desatualizado",
      "Manutenção de sistemas em atraso",
      "Mudança de uso não regularizada"
    ],
    "problemasDesc": [
      "Sem o projeto aprovado, a vistoria não tem referência e o processo trava até a regularização documental.",
      "Extintores, alarme, iluminação e hidrantes costumam estar sem registro de manutenção atualizado.",
      "Imóveis que trocaram de atividade mantem enquadramento incompatível com o uso atual."
    ],
    "faq1q": "Não encontro o projeto aprovado do meu imóvel em Sapopemba. Consigo renovar o AVCB?",
    "faq1a": "E possível, mas primeiro e preciso regularizar a situação documental, levantando a edificação e produzindo a planta compatível. O diagnóstico define o caminho mais rápido para o seu caso.",
    "faq2q": "Quanto tempo leva para renovar o AVCB em Sapopemba?",
    "faq2a": "Depende da área, da ocupação e das pendencias de laudo e de projeto. Comecar pela conferencia documental reduz o risco de exigências e mantem o cronograma realista.",
    "faq3q": "Pequena indústria em Sapopemba tem exigências diferentes na renovação?",
    "faq3a": "Sim. O tipo de atividade e a carga de incêndio influenciam os sistemas obrigatórios. O diagnóstico avalia o enquadramento e indica o que e exigido para o seu imóvel.",
    "faq4q": "AVCB vencido em Sapopemba gera multa?",
    "faq4a": "Sim. AVCB vencido aumenta o risco de autuação, interdição e recusa de seguro, além da responsabilidade civil em caso de sinistro. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB em Sapopemba segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A extensão do bairro e a variedade de ocupações ao longo da Avenida Sapopemba — comércio, condomínios, escolas e pequenas indústrias — tornam o enquadramento correto a etapa decisiva do processo.\n\nO ponto de partida e o diagnóstico documental: verificar se o projeto aprovado existe e esta atualizado e confirmar se o caso e de CLCB, AVCB com vistoria ou projeto técnico. Quando o projeto não corresponde ao imóvel, e necessário atualiza-lo ou protocolar um Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nA DRD2 Engenharia faz o levantamento de campo, organiza os laudos e ARTs de elétrica, SPDA, hidrantes e demais sistemas e acompanha a vistoria presencialmente em Sapopemba. Esse acompanhamento garante que exigências sejam resolvidas na hora e o AVCB seja emitido sem retrabalho.",
    "custoDetalhe": "Em Sapopemba, o custo da renovação depende do estado documental e do tipo de imóvel. Quando e preciso levantar a planta ou regularizar mudança de uso, o orçamento e maior. O valor final e fechado após o diagnóstico inicial.",
    "ctaFinal": "AVCB vencendo em Sapopemba? Fale com um engenheiro e organize a documentação antes que o prazo aperte."
  },
  {
    "slug": "se",
    "nome": "Se",
    "zona": "Região Central",
    "tag": "Especialistas na Região Central",
    "avenidas": "Praça da Se, Rua Direita e Rua São Bento",
    "perfil": "edifícios históricos e muito antigos, comércio popular denso, galerias, prédios de escritórios e imóveis de uso misto",
    "intro": "A Se e o coração histórico de São Paulo, com edifícios muito antigos, comércio popular denso e prédios de escritórios de várias decadas. Essa concentração de construções antigas e alta circulação de público torna a renovação do AVCB um dos processos mais criteriosos da cidade diante do Decreto Estadual 69.118/2024.",
    "box": "Na Se, o ponto crítico e a idade das edificações. Prédios históricos tem escadas, rotas de fuga e instalações que foram concebidas muito antes das normas atuais, e a renovação do AVCB exige um plano de adequação proporcional e bem documentado.",
    "problemas": [
      "Edificações históricas fora da norma atual",
      "Carga de incêndio elevada no comércio popular",
      "Uso misto com responsabilidades difusas"
    ],
    "problemasDesc": [
      "Prédios antigos tem escadas e rotas concebidas antes das Instruções Técnicas vigentes, exigindo adequação proporcional.",
      "O comércio popular denso acumula estoque e mercadoria, elevando a carga de incêndio da edificação.",
      "Edifícios de uso misto tem comércio, serviço e moradia, o que dispersa a responsabilidade pela regularização."
    ],
    "faq1q": "Meu prédio na Se e histórico e muito antigo. E possível renovar o AVCB?",
    "faq1a": "E possível. Edificações antigas seguem regras de adequação proporcional: não há isenção, mas há um caminho técnico para compatibilizar o imóvel com a norma. O diagnóstico define esse plano.",
    "faq2q": "Por que a renovação do AVCB na Se e mais criteriosa?",
    "faq2a": "Pela combinação de prédios muito antigos, comércio popular denso e grande circulação de público. Isso eleva o risco e faz a fiscalização cobrar rotas, sistemas e sinalização com rigor.",
    "faq3q": "Quanto tempo leva a renovação do AVCB na Se?",
    "faq3a": "Depende do estado da edificação e das adequações necessárias. Em prédios históricos, o diagnóstico inicial e indispensavel para montar um cronograma realista.",
    "faq4q": "Comércio com AVCB vencido na Se corre risco de interdição?",
    "faq4a": "Sim. Na região central a fiscalização e frequente. AVCB vencido expoe o imóvel a autuação, interdição e recusa de seguro. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Se e regida pelo Decreto Estadual 69.118/2024 e pelas Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. O centro histórico, com edificações muito antigas e comércio popular denso em torno da Praça da Se e da Rua Direita, e tratado com rigor pela fiscalização por causa do risco elevado e da intensa circulação de público.\n\nPara edificações existentes e antigas, o regulamento preve a adequação proporcional: não existe isenção, mas e possível compatibilizar o imóvel com a norma por meio de um plano técnico bem fundamentado. Quando o projeto aprovado não corresponde a realidade física, e necessário atualiza-lo ou protocolar um Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nA DRD2 Engenharia conduz o diagnóstico, faz o levantamento da edificação, organiza os laudos e ARTs de elétrica, SPDA, hidrantes e demais sistemas e acompanha a vistoria presencialmente na Se. Esse acompanhamento e decisivo em prédios históricos, garantindo que cada exigência seja resolvida de forma técnica e o AVCB seja emitido com segurança juridica.",
    "custoDetalhe": "Na Se, o custo da renovação e influenciado pela idade e pela complexidade da edificação. Prédios históricos que exigem plano de adequação proporcional tem orçamento maior do que imóveis com documentação em dia. O valor e fechado após o diagnóstico.",
    "ctaFinal": "Imóvel na Se com AVCB vencido? Fale com um engenheiro e monte um plano técnico de regularização antes da próxima fiscalização."
  },
  {
    "slug": "vila-re",
    "nome": "Vila Ré",
    "zona": "Zona Leste",
    "tag": "Atendimento na Zona Leste",
    "avenidas": "Avenida Doutor Assis Ribeiro, Rua Tiburcio de Sousa e Avenida São Miguel",
    "perfil": "comércio de bairro, condomínios residenciais, escolas e imóveis de uso misto entre residencial e serviços",
    "intro": "A Vila Ré e um bairro residencial e comercial da Zona Leste, com condomínios, comércio local, escolas e imóveis de uso misto. Esse conjunto variado de ocupações faz com que a renovação do AVCB dependa de enquadramento individual, conforme as exigências do Decreto Estadual 69.118/2024.",
    "box": "Na Vila Ré, o problema mais comum e o imóvel residencial que ganhou função comercial — uma sala, uma garagem ou um térreo que viraram loja ou serviço — sem que o projeto e o enquadramento fossem revisados. A vistoria reprova essa incompatibilidade.",
    "problemas": [
      "Imóvel residencial com função comercial",
      "Manutenção de sistemas sem registro",
      "Documentação do imóvel incompleta"
    ],
    "problemasDesc": [
      "Terreos e garagens convertidos em comércio mantem enquadramento residencial incompatível com o uso atual.",
      "Extintores, alarme e iluminação de emergência costumam estar sem comprovante de manutenção.",
      "Falta a planta aprovada ou os dados completos do imóvel, o que atrasa o protocolo da renovação."
    ],
    "faq1q": "Transformei parte da minha casa em comércio na Vila Ré. Preciso de AVCB?",
    "faq1a": "Sim. A função comercial altera o enquadramento no Corpo de Bombeiros. E necessário projeto técnico compatível com a atividade antes da emissão ou renovação do AVCB.",
    "faq2q": "Quanto tempo leva para renovar o AVCB na Vila Ré?",
    "faq2a": "Depende da área, da ocupação e das pendencias de laudo e de projeto. Comecar pela conferencia documental e por uma pre-vistoria reduz o risco de exigências do CBPMESP.",
    "faq3q": "Quais documentos preciso para a renovação na Vila Ré?",
    "faq3a": "Planta aprovada, dados do imóvel e do responsável, laudos e ARTs dos sistemas, comprovantes de manutenção e o AVCB anterior. Organizar tudo antes acelera a análise.",
    "faq4q": "AVCB vencido na Vila Ré pode gerar multa ou interdição?",
    "faq4a": "Sim. AVCB vencido expoe o imóvel a autuação, interdição, recusa de seguro e responsabilidade civil em caso de sinistro. A renovação deve ser iniciada antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Vila Ré segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. A mistura de usos residencial, comercial e de serviços ao longo da Avenida Doutor Assis Ribeiro torna o enquadramento correto a etapa central do processo.\n\nO diagnóstico inicial confirma se o caso e de CLCB, AVCB com vistoria ou projeto técnico e verifica se a planta aprovada corresponde ao uso atual. Imóveis residenciais que passaram a abrigar comércio ou serviço exigem revisão de projeto ou protocolo de Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros.\n\nA DRD2 Engenharia organiza a documentação, consolida os laudos e ARTs de elétrica, SPDA, hidrantes e demais sistemas e acompanha a vistoria presencialmente na Vila Ré. Esse acompanhamento garante que exigências do vistoriador sejam resolvidas na hora, resultando na emissão do AVCB sem retrabalho.",
    "custoDetalhe": "Na Vila Ré, o custo da renovação depende do tipo de imóvel e da existencia ou não de mudança de uso. Imóveis com documentação em dia tem orçamento mais enxuto; quando há regularização de função comercial, o valor sobe. O orçamento e fechado após o diagnóstico.",
    "ctaFinal": "AVCB vencido na Vila Ré? Fale com um engenheiro e regularize o seu imóvel antes que o documento trave o alvará e o seguro."
  },
  {
    "slug": "vila-madalena",
    "nome": "Vila Madalena",
    ...
    "perfil": "casaroes e sobrados antigos adaptados para bares, restaurantes, galerias de arte, atelies, comércio e prédios residenciais de medio porte",
    "intro": "A Vila Madalena e um dos bairros de maior vida noturna da Zona Oeste, com bares, restaurantes, galerias e casaroes antigos adaptados para o comércio. Essa combinação de público intenso e edificações antigas torna a renovação do AVCB exigente diante do Decreto Estadual 69.118/2024.",
    "box": "Na Vila Madalena, a reprovação mais comum vem de casaroes e sobrados convertidos em bares e restaurantes sem revisão de projeto. A nova função traz cozinha, gás, público e carga de incêndio que a edificação antiga não foi projetada para suportar.",
    "problemas": [
      "Casarao adaptado para bar ou restaurante",
      "Gás e cozinha sem laudo",
      "Lotação noturna acima do projeto"
    ],
    "problemasDesc": [
      "Imóveis residenciais antigos convertidos em comércio mantem projeto incompatível com a carga de incêndio e a lotação atuais.",
      "Bares e restaurantes precisam de laudo de estanqueidade de gás e adequação da cozinha, itens decisivos na vistoria.",
      "O público da noite costuma superar a lotação prevista no projeto, deixando as saídas de emergência subdimensionadas."
    ],
    "faq1q": "Tenho um bar em casarao antigo na Vila Madalena. Preciso revisar o AVCB?",
    "faq1a": "Sim. Casaroes e sobrados que viraram bar ou restaurante mudam de uso: a carga de incêndio, a lotação e os sistemas exigidos são outros. E necessário revisar o projeto e incluir o laudo de gás antes da renovação.",
    "faq2q": "Por que a Vila Madalena recebe fiscalização mais frequente?",
    "faq2a": "Pela forte vida noturna e pela concentração de bares e restaurantes em imóveis antigos. Esse perfil eleva o risco e faz o Corpo de Bombeiros cobrar saídas, lotação e sistemas de combate com rigor.",
    "faq3q": "Quanto tempo leva para renovar o AVCB na Vila Madalena?",
    "faq3a": "Depende do uso do imóvel e das adequações necessárias. Em casaroes adaptados, o diagnóstico inicial e essencial para definir um cronograma realista e evitar exigências na vistoria.",
    "faq4q": "AVCB vencido na Vila Madalena pode interditar meu bar ou restaurante?",
    "faq4a": "Sim. Em um bairro de fiscalização frequente, AVCB vencido expoe o estabelecimento a autuação, interdição, recusa de seguro e responsabilidade civil. A renovação deve comecar antes do vencimento.",
    "guiaLegislacaoLocal": "A renovação do AVCB na Vila Madalena segue o Decreto Estadual 69.118/2024 e as Instruções Técnicas atualizadas pela Portaria CCB-003/800/2025, sob analise do CBPMESP. O bairro, com forte vida noturna e casaroes antigos adaptados para bares e restaurantes em torno da Rua Aspicuelta e da Rua Harmonia, recebe fiscalização atenta a lotação, saídas de emergência e sistemas de combate.\n\nO processo comeca com o diagnóstico e a confirmação do enquadramento - CLCB, AVCB com vistoria ou projeto técnico. Imóveis residenciais antigos que passaram a abrigar comércio noturno exigem revisão de projeto ou protocolo de Formulario de Atendimento Técnico (FAT) pelo Via Fácil Bombeiros, recalculando carga de incêndio, lotação e rotas de fuga.\n\nAntes da vistoria, a DRD2 Engenharia organiza os laudos e ARTs de elétrica, SPDA, hidrantes e o laudo de estanqueidade de gás, e confere as condições das saídas. Acompanhamos a vistoria presencialmente na Vila Madalena, resolvendo qualquer questionamento na hora e assegurando a emissão do AVCB.",
    "custoDetalhe": "Na Vila Madalena, o custo da renovação depende do tipo de imóvel e da existencia de mudança de uso. Bares e restaurantes em casaroes adaptados exigem mais laudos do que imóveis com documentação em dia. O orçamento e fechado após o diagnóstico.",
    "ctaFinal": "Bar, restaurante ou imóvel comercial na Vila Madalena com AVCB vencido? Fale com um engenheiro e regularize antes da próxima fiscalização."
  }
];
