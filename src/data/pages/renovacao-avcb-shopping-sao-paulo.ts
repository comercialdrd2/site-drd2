export const renovacaoAvcbContent = {
  ...
  badge: "GRUPO C-3 — SHOPPING CENTERS — RENOVAÇÃO 2026",
  h1: "Renovação de AVCB para Shoppings em São Paulo",
  intro: [
    "<strong>Shoppings com AVCB vencido em São Paulo</strong> correm sérios riscos. Shoppings sem AVCB regularizado enfrentam multas milionárias e perda do seguro patrimonial. A complexidade do sistema de sprinklers, alarmes e extração de fumaça exige engenharia especializada.<br/><br/>📲 <strong>Evite multas e interdições.</strong> Fale agora com um engenheiro: <a href='https://wa.me/5511993206900' class='text-green-600 font-bold underline'>Chamar no WhatsApp</a>",
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para shoppings e centros comerciais tem prazo crítico",
      content: [
        "Estabelecimentos do tipo shoppings e centros comerciais operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
