export const renovacaoAvcbContent = {
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para salões de festas e eventos tem prazo crítico",
      content: [
        "Estabelecimentos do tipo salões de festas e eventos operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
