export const renovacaoAvcbContent = {
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para pousadas tem prazo crítico",
      content: [
        "Estabelecimentos do tipo pousadas operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
