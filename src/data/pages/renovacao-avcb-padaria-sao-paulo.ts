export const renovacaoAvcbContent = {
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para padarias e confeitarias tem prazo crítico",
      content: [
        "Estabelecimentos do tipo padarias e confeitarias operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
