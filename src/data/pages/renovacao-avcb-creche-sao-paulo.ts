export const renovacaoAvcbContent = {
  ...
  badge: "GRUPO E-1 — ESCOLAS E CRECHES — RENOVAÇÃO 2026",
  h1: "Renovação de AVCB para Creches em São Paulo",
  intro: [
    "<strong>Creches com AVCB vencido em São Paulo</strong> correm sérios riscos. Creches sem AVCB válido podem ser fechadas pela Secretaria de Educação. A segurança de crianças pequenas exige rigor extremo em rotas de fuga, corrimãos e brigada de incêndio.<br/><br/>📲 <strong>Evite multas e interdições.</strong> Fale agora com um engenheiro: <a href='https://wa.me/5511993206900' class='text-green-600 font-bold underline'>Chamar no WhatsApp</a>",
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para creches e escolas infantis tem prazo crítico",
      content: [
        "Estabelecimentos do tipo creches e escolas infantis operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
