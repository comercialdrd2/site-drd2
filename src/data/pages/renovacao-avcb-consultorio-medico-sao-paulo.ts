export const renovacaoAvcbContent = {
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para consultórios médicos e clínicas tem prazo crítico",
      content: [
        "Estabelecimentos do tipo consultórios médicos e clínicas operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
