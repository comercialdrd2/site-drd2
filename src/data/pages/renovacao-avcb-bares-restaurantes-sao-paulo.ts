export const renovacaoAvcbContent = {
  ...
  sections: [
    {
      title: "Por que a renovação do AVCB para bares e restaurantes tem prazo crítico",
      content: [
        "Estabelecimentos do tipo bares e restaurantes operam sob fiscalização permanente. O AVCB válido é condição obrigatória para a renovação de alvarás de funcionamento.",
