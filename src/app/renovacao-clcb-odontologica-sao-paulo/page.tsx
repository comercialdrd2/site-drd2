...
import {
  ...
  ShieldX, Smile, ScanLine, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbOdontologicaContent as c } from "@/data/pages/renovacao-clcb-odontologica-sao-paulo";
...
export default function RenovacaoCLCBOdontologicaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-odontologica-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Clínica Odontológica em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Clínica Odontológica", item: "/renovacao-clcb-odontologica-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Clínica Odontológica em São Paulo — DRD2 Engenharia"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — CLÍNICA ODONTOLÓGICA E CONSULTÓRIO DENTÁRIO
              </span>
              <span className="text-2xl md:text-3xl lg:text-4xl italic text-red-500 mt-1 block leading-none">
                CLCB VENCIDO? CONVÊNIO PODE SUSPENDER CREDENCIAMENTO — RENOVE JÁ
              </span>
            </h1>
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  Consultórios com óxido nitroso para sedação consciente e tubulações de ar comprimido têm risco de incêndio específico por gás sob pressão. CLCB vencido nesse ambiente representa responsabilidade direta do cirurgião-dentista em caso de sinistro durante atendimento.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            CLCB do seu consultório vencido? Fale agora e receba diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="clínica odontológica em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 para o seu consultório?
              </h2>
              <div className="space-y-4">
                {[
                  "Especialistas em CLCB para clínicas odontológicas",
                  "Extintor CO₂ correto para sala de raio-X e equipamentos",
                  "Verificação da instalação de ar comprimido e óxido nitroso",
                  "Diagnóstico técnico gratuito sem surpresas",
                  "Documentação completa para convênios odontológicos",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Smile, l: "Consultórios Individuais" },
                { Icon: ScanLine, l: "Clínicas com Raio-X" },
                { Icon: Smile, l: "Clínicas de Implante" },
                { Icon: ScanLine, l: "Centros de Radiologia" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Clínica Odontológica</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-odontologica-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-odontologica-sao-paulo" />
      <NeighborhoodSilo currentSlug="/renovacao-clcb-odontologica-sao-paulo" />

      <OccupationAuthorityBlock occupation="Clínica Odontológica" currentSlug="/renovacao-clcb-odontologica-sao-paulo" />
      <OccupationDepthBlock occupation="Clínica Odontológica" currentSlug="/renovacao-clcb-odontologica-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-odontologica-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Clínica Odontológica em São Paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight italic">
            CLCB do seu consultório vencido ou próximo do vencimento?
          </h2>
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 renova sem interromper os atendimentos — com extintor correto para raio-X e documentação para convênios.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
