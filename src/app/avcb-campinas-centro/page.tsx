...
export default function ExpansionLandingPage() {
  ...
  const faqItems = [
    { question: "Prédio muito antigo no Centro tem anistia?", answer: "Não. Existe o 'Regulamento de Segurança contra Incêndio das Edificações Existentes' (Decreto 69.118/2024), que permite adaptações proporcionais, mas nunca isenção." },
