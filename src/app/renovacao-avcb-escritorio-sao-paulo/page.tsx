...
import { renovacaoAvcbContent as c } from "@/data/pages/renovacao-avcb-escritorio-sao-paulo";
...
export default function RenovacaoAVCBEscritorioPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Escritórios em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação AVCB Escritório SP", item: c.meta.canonical },
        ],
      });
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[40px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          src="/images/hero-escritorio-moderno.webp"
          alt="Alvará do Bombeiro para Escritório Comercial"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Escritórios em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Escritórios" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto">
              Conheça os pontos que mais geram exigências e atrasam a renovação de escritórios.
            </p>
          </div>
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            AVCB do escritório vencendo? Não arrisque o compliance corporativo.
          </p>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Renovação de AVCB para Escritórios</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          <h2 className="text-4xl md:text-6xl font-black mb-6 uppercase tracking-tighter italic leading-none">
            Renove o AVCB<br/>
            <span className="text-red-500 not-italic">do seu Escritório Hoje</span>
          </h2>
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-500 opacity-60">
            DRD2 Engenharia — Renovação de AVCB para Escritórios em São Paulo
          </p>
        </div>
      </section>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/renovacao-avcb-escritorio-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/renovacao-avcb-escritorio-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-escritorio-sao-paulo" />
