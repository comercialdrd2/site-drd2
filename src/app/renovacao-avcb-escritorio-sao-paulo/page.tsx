  ...
  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-avcb-escritorio-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Escritórios Corporativos em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Escritórios Corporativos", item: "/renovacao-avcb-escritorio-sao-paulo" },
        ],
      })} />
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-3xl lg:text-4xl font-black mb-2 leading-[0.9] tracking-tighter uppercase italic text-white flex flex-col">
              ...
              <span className="text-red-600 not-italic text-3xl md:text-3xl lg:text-4xl mt-2 block drop-shadow-2xl">
                PARA ESCRITÓRIOS CORPORATIVOS EM SP
              </span>
            </h1>
            <div className="mb-4">
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Escritórios Corporativos" },
        ]}
        dark
      />
      <TrustBar dark />
