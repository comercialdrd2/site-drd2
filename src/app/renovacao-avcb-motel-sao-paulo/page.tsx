...
import {
  ...
  ShieldX, AlertTriangle, MapPin, Bed, Activity, Zap, Lock, Users
} from "lucide-react";
...
import { renovacaoAvcbMotelContent as c } from "@/data/pages/renovacao-avcb-motel-sao-paulo";
...
export default function RenovacaoAVCBMotelPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const _schema = generateMasterSchema({
        slug: "/renovacao-avcb-motel-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Motel em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Motel", item: "/renovacao-avcb-motel-sao-paulo" },
        ],
      });
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[500px] lg:min-h-[600px] pt-[100px] pb-[60px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          src="/images/hero-motel.webp"
          alt="Renovação de AVCB para Motel"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="max-w-3xl">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-4 shadow-lg shadow-red-900/20">
              Setor de Motéis — Renovação 2026
            </span>
            ...
            <div className="space-y-4 mb-8">
              <p className="text-lg md:text-xl lg:text-2xl text-white leading-tight font-black max-w-2xl border-l-4 border-red-600 pl-5 italic drop-shadow-lg">
                AVCB do motel vencido? Uma interdição inesperada no final de semana pode causar prejuízos irreparáveis e danos à imagem do seu estabelecimento.
              </p>
              <p className="text-base md:text-lg text-gray-200 leading-relaxed font-bold max-w-2xl drop-shadow-md">
                Nossa engenharia garante a regularização total com a discrição que o setor exige, evitando multas e fechamentos inesperados.
              </p>
            </div>
            ...
            <div className="mt-10 flex items-center gap-4 text-[10px] font-black text-white uppercase tracking-widest bg-black/40 backdrop-blur-sm p-3 rounded-2xl border border-white/10 inline-flex">
              ...
              <span className="drop-shadow-md">+300 Motéis Regularizados pela DRD2</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Motel em SP" },
        ]}
        dark
      />
      <TrustBar dark />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-none uppercase tracking-tighter mb-8 italic">
                Por que o AVCB do Motel{" "}
                <span className="text-red-600 not-italic font-black italic">Vence e Coloca a Operação em Risco?</span>
              </h2>
              ...
              <p className="mt-6 font-bold text-slate-900">Situações que complicam a renovação de motéis:</p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              Quais são os Riscos para o Proprietário do Motel com{" "}
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Não arrisque a exposição do seu negócio. Fale com um engenheiro especialista.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico para Motel"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Renovação do AVCB do Motel?</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
                {c.h2_discricao.heading.replace(" Renovação com Discrição", "Renovação Com Discrição")} na{" "}
                <span className="text-red-600 not-italic text-4xl">Operação</span>
              </h2>
              <p className="text-lg text-slate-700 leading-relaxed font-medium mb-10" dangerouslySetInnerHTML={{ __html: c.h2_discricao.intro }} />
              <div className="space-y-6">
                {c.h2_discricao.itens.map((item, i) => (
                  <div key={i} className="flex items-start gap-5 bg-slate-50 rounded-2xl p-6 border border-slate-200">
                    <div className="w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Lock className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <p className="text-slate-900 font-black mb-1">{item.nome}</p>
            ...
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden">
               ...
               <h3 className="font-black text-2xl uppercase italic mb-6 relative z-10">
                {c.h2_tematicas.heading.replace(" Motel com Suítes Temáticas", "Suítes Temáticas")}
              </h3>
              <p className="text-slate-400 mb-8 relative z-10 leading-relaxed" dangerouslySetInnerHTML={{ __html: c.h2_tematicas.intro }} />
              <ul className="space-y-6 relative z-10">
                {c.h2_tematicas.itens.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Reformou as suítes ou instalou novos equipamentos? Seu AVCB pode estar desatualizado.
          </p>
          <CtaWhatsApp
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">AVCB do seu Motel</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic">
                Atendemos Renovações de AVCB em Motéis em{" "}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">Renovação para Motel</span>
            </h2>
          </div>
          <div className="space-y-4">
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            Não deixe seu motel parar por falta de AVCB.
          </p>
      ...
      <OccupationAuthorityBlock
        occupation="Motel"
        currentSlug="/renovacao-avcb-motel-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="Renovação de AVCB para Motéis"
      />

      <ServiceClusterLinks currentSlug="/renovacao-avcb-motel-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-motel-sao-paulo" />

      <NeighborhoodSilo currentSlug="/renovacao-avcb-motel-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Renovação de AVCB para Motel em SP
          </p>
        </div>
      </section>
