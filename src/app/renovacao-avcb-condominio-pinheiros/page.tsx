...
const _slug = "/renovacao-avcb-condominio-pinheiros";
const _pageTitle = "Renovação de AVCB para Condomínio em Pinheiros | DRD2 Engenharia";
const _pageDesc = "Especialistas em renovação de AVCB para condomínios em Pinheiros. Adequação de prédios antigos, laudos técnicos, ART e aprovação no Corpo de Bombeiros.";
...
const faqs = [
  { q: "Qual a validade do AVCB para condomínios residenciais em Pinheiros?", a: "Para condomínios residenciais em São Paulo (incluindo Pinheiros), o AVCB tem validade de até 5 anos. Já para edifícios de uso misto ou comerciais, a validade cai para 3 anos." },
  { q: "O AVCB do meu prédio residencial é o mesmo da loja comercial do térreo?", a: "A edificação deve ter um único AVCB Geral, mas o Projeto Técnico deve prever o 'risco misto'. O condomínio pode ser responsabilizado e perder o seguro se o comércio do térreo alterar a carga de incêndio (ex: virar um restaurante) sem readequar os sistemas." },
  ...
  { q: "O Corpo de Bombeiros vistoria o condomínio na renovação?", a: "Sim. Em processos de renovação de Projeto Técnico (PT), o CBPMESP agenda uma vistoria presencial. A DRD2 Engenharia acompanha essa vistoria no seu condomínio em Pinheiros para garantir que não haja 'comunique-se' (exigências extras)." },
  { q: "Posso ser multado se o AVCB do meu prédio em Pinheiros estiver vencido?", a: "Sim. O Decreto Estadual 69.118/2024 permite que o CBPMESP aplique multas pesadas. Além disso, a ausência de AVCB válido anula a cobertura do seguro predial e transfere a responsabilidade civil e criminal diretamente para o síndico em caso de sinistro." },
  { q: "Quanto tempo demora a renovação do AVCB na região de Pinheiros?", a: "Se o condomínio estiver com a manutenção em dia, o processo leva entre 15 e 30 dias. Se houver necessidade de adequações físicas (como troca de bombas ou adequação de hidrantes), o cronograma dependerá da execução das obras." },
];
...
export default function RenovacaoCondominioPage() {
  ...
  const _schema = generateMasterSchema({
    ...
    title: _pageTitle,
    description: _pageDesc,
    serviceName: "Renovação de AVCB para Condomínio em Pinheiros",
    faqs: faqs.map((f) => ({ question: f.q, answer: f.a })),
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Renovações", item: "/renovacao-avcb" },
      { name: "Condomínio em Pinheiros", item: _slug },
    ],
  });
  ...
  return (
    <>
      ...
      <HeroSection 
        ...
        title={<><span className="opacity-80 font-bold tracking-widest block mb-2 text-xl md:text-2xl">RENOVAÇÃO DE AVCB PARA CONDOMÍNIO</span><span className="italic text-red-500 block leading-tight">EM PINHEIROS — SEGURANÇA E LEGALIDADE</span></>}
        subtitle="Síndico, proteja seu patrimônio e evite a perda da cobertura do seguro. Engenharia especializada em adequação de prédios antigos e modernos em Pinheiros."
        address="Rua Teodoro Sampaio, Cardeal Arcoverde e Av. Rebouças"
        showForm={true}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div>
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-none uppercase tracking-tighter mb-8 italic">
                A urgência da renovação do AVCB em <span className="text-red-600 not-italic font-black italic">Pinheiros</span>
              </h2>
              <div className="space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
                <p>
                  O bairro de <strong>Pinheiros</strong>, localizado na <strong>Zona Oeste</strong>, possui uma característica singular: uma alta concentração de mescla de prédios antigos tradicionais e novos condomínios-clube (uso misto). Para o Corpo de Bombeiros (CBPMESP), a idade ou o porte da edificação não isentam o rigor técnico.
                </p>
                <p>
                ...
                <p>
                  A responsabilidade pela manutenção do AVCB recai integralmente sobre o síndico. Em condomínios de Pinheiros, a ausência de um AVCB válido ou a negligência na renovação resulta em três consequências severas: a <strong>nulidade imediata da apólice de seguro predial</strong> em caso de sinistro, a aplicação de <strong>multas estaduais (Decreto 69.118/2024)</strong> e a responsabilização civil e criminal direta do gestor caso ocorram danos físicos aos moradores.
                </p>
                ...
                <div className="bg-slate-950 p-10 rounded-[2.5rem] text-white my-10 shadow-2xl border-l-8 border-red-600 relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-black mb-4 uppercase italic tracking-tight">O Cenário Imobiliário de Pinheiros</h4>
                  <p className="text-slate-400 text-sm mb-4 leading-relaxed font-medium">
                    Em Pinheiros, a principal causa de embargo e multa pelo Bombeiro é a alteração de layout das áreas comuns sem atualização da planta do AVCB. Fechamento de varandas gourmet, ampliação de academias e criação de coworkings no térreo invalidam o AVCB anterior se o Projeto Técnico não for atualizado.
                  </p>
...
Após a adequação física e documental, todos os laudos (ARTs de elétrica, SPDA, gás e bombas) são consolidados e submetidos eletronicamente. A vistoria do CBPMESP na região de Pinheiros é rigorosa e os tenentes vistoriadores testam na prática o funcionamento das bombas de recalque e o acionamento do alarme geral. Com a DRD2 Engenharia, acompanhamos o vistoriador presencialmente em seu endereço próximo à Rua Teodoro Sampaio, Cardeal Arcoverde e Av. Rebouças, garantindo que qualquer questionamento técnico seja sanado imediatamente, resultando na emissão rápida e segura do seu AVCB.
      ...
      <section className="py-24 bg-slate-950 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <h2 className="text-4xl font-black mb-16 tracking-tighter uppercase italic">
            Problemas Comuns que <span className="text-red-500 not-italic">Reprovam Condomínios em Pinheiros</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              { e: "Problema 1", t: "Alteração de planta não comunicada", d: "Reformas nas áreas comuns (salão de festas, academia) realizadas sem submissão de nova planta ao Corpo de Bombeiros.", c: "bg-slate-900" },
              { e: "Problema 2", t: "Falta de compartimentação de shafts", d: "Furos nas lajes por onde passam os cabos de TV/Internet abertos, permitindo que fumaça suba rapidamente pelos andares.", c: "bg-red-900" },
              { e: "Problema 3", t: "Gás instalado irregularmente", d: "Moradores usando botijões P13 em edifícios com rede de gás encanado (prática estritamente proibida).", c: "bg-slate-900" },
            ].map((item, i) => (
      ...
      <OccupationDepthBlock
        occupation="Condominio Pinheiros"
        currentSlug="/renovacao-avcb-condominio-pinheiros"
      />

      <InternalLinksBlock currentSlug={_slug} mode="renovacao" maxLinks={8} titulo="Renovação Condomínio em SP" />

      <ServiceClusterLinks currentSlug="/renovacao-avcb-condominio-pinheiros" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-condominio-pinheiros" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900 mt-24">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter uppercase italic leading-[0.9]">
            Regularize o AVCB do seu condomínio misto em Pinheiros
          </h2>
