...
import { avcbMotelContent as c } from "@/data/pages/avcb-motel-sao-paulo";
...
export default function AVCBMotelPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "AVCB para Motel em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "AVCB para Motel em São Paulo", item: "/avcb-motel-sao-paulo" },
        ],
      });
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[20px] flex items-center bg-slate-950 border-b-8 border-red-600  ">
        <Image
          src="/images/hero_motel_avcb.webp"
          alt="Alvará do Bombeiro para Motel"
          fill
        ...
        <div className="absolute inset-0 opacity-10"
          style={{ backgroundImage: "radial-gradient(circle at 20% 60%, rgba(220,38,38,0.4) 0%, transparent 60%)" }}
        />
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "AVCB para Motel em São Paulo" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      {/* ── H2 #2: DESAFIOS TÉCNICOS ── */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              Por que o AVCB de Motel tem{" "}
              <span className="text-red-600 not-italic">Desafios Técnicos Específicos?</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium" dangerouslySetInnerHTML={{ __html: c.h2_desafios.intro }} />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {c.h2_desafios.itens.map((item, i) => (
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Corpo de Bombeiros em Motéis</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Seu motel tem todos esses sistemas aprovados pelo CBPMESP?
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito"
            occupationType="motel"
            variant="primary"
            centered
          />
        </div>
      ...
      {/* ── H2 #4: RISCOS DO AVCB VENCIDO ── */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter uppercase italic">
              AVCB Vencido —{" "}
              <span className="text-red-600 not-italic">Riscos Reais para o Proprietário de Motel</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium" dangerouslySetInnerHTML={{ __html: c.h2_riscos.intro }} />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {c.h2_riscos.riscos.map((risco, i) => (
              <div key={i} className="bg-red-600/5 border border-red-600/20 rounded-[2.5rem] p-8 hover:border-red-600/50 hover:shadow-xl transition-all">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-red-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <ShieldX className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <p className="text-slate-900 font-black text-lg mb-2">{risco.titulo}</p>
                    <p className="text-slate-600 font-medium leading-relaxed text-sm">{risco.desc}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Pronto para regularizar seu motel com discrição?
          </p>
          <CtaWhatsApp
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">AVCB para Motel SP</span>
            </h2>
          </div>
      ...
      <OccupationAuthorityBlock
        occupation="Motel"
        currentSlug="/avcb-motel-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="AVCB para Motéis em SP"
      />

      <ServiceClusterLinks currentSlug="/avcb-motel-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-motel-sao-paulo" />

      <NeighborhoodSilo currentSlug="/avcb-motel-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — AVCB para Motéis em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-red-600">AVCB em Motel São Paulo</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Motel São Paulo precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-red-600 p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 realiza auditoria documental gratuita antes do protocolo. Identificamos divergencias de área, laudos vencidos e irregularidades antes de submeter o processo ao Corpo de Bombeiros de Motel São Paulo. Evite exigencias e atrasos.
          </div>
        </div>
      </section>
