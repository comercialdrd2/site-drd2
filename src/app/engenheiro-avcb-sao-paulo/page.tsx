  ...
  return (
    <>
      ...
      <section className="relative bg-slate-950 text-white pt-32 pb-24 overflow-hidden border-b-8 border-primary">
        <Image src="/images/eng-samuel-oficial.webp" alt="Engenheiro especialista em projetos de AVCB e segurança contra incêndio" fill className="object-cover object-center opacity-30 grayscale-[30%]" priority sizes="100vw" quality={65} />
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-3/5">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[0.9] tracking-tighter text-white">
                Engenheiro de AVCB em <span className="text-primary italic text-6xl md:text-8xl">São Paulo</span>
              </h1>
