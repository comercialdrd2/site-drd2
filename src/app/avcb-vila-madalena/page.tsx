...
const _pageTitle = "AVCB em Vila Madalena SP | Especialistas na Região da Aspicuelta | DRD2";
const _pageDesc = "Regularização de AVCB e CLCB no Vila Madalena. Engenheiros credenciados no CREA para bares, restaurantes de calçada e coworkings culturais e estabelecimentos com emissão ágil.";

export const metadata = {
  title: "AVCB em Vila Madalena SP | Especialistas na Região da Aspicuelta | DRD2",
  description: "Regularização de AVCB e CLCB no Vila Madalena. Engenheiros credenciados no CREA para bares, restaurantes de calçada e coworkings culturais e estabelecimentos com emissão ágil.",
  alternates: {
    canonical: "/avcb-vila-madalena",
  },
};

export default function VilaMadalenaLandingPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Renovar a licença em Bares é difícil perante Lei?",
      answer: "Sem o parceiro certo, os limites acústicos fecham em cima de hidrantes inoperantes e rotas estreitas. Promovemos auditorias plenas de bares antes de qualquer multa acontecer ou fechar."
    },
    {
      question: "Qual o prazo para obter o AVCB em Vila Madalena?",
    ...
    {
      question: "Meu imóvel em Vila Madalena precisa de AVCB completo ou CLCB simplificado?",
    ...
    {
      question: "O AVCB vencido impede a renovacao do alvará de funcionamento em Vila Madalena?",
    ...
    {
      question: "Qual a documentação para iniciar o AVCB em Vila Madalena?",
  ...
  const services = [
    { 
      name: "Lotação Especializada de Público Noturno", 
      desc: "Desenvolvimento preventivo (Grupo F - Eventos Bar Noturno); A prioridade é não falir pela ausência da vistoria em operações lotadas.",
      icon: Building2,
      slug: "service"
    },
    { 
      name: "Coworking Modernos e Imóveis Residenciais Transformados", 
      desc: "Engenharia de mudança de Layout perante subprefeituras.",
      icon: Building2,
      slug: "service"
    }
  ];
  ...
  const _schema = generateMasterSchema({
        ...
        breadcrumbs: [
          ...
          { name: "Vila Madalena", item: "/avcb-vila-madalena" }
        ]
      });
  ...
  return (
    <>
      ...
      <HeroSection 
        ...
        tag="Nightlife, Boêmios e Agências Criativas"
        title={<><span className="text-white">AVCB NA</span> <span className="text-red-500 not-italic tracking-tighter uppercase font-black">VILA MADALENA</span></>}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <div className="inline-flex items-center gap-2 text-primary font-black text-xs uppercase tracking-widest leading-none">
                <BadgeInfo className="w-4 h-4" /> Nightlife, Boêmios e Agências Criativas
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-secondary leading-[1.1] tracking-tighter uppercase mb-6 text-left border-l-8 border-primary pl-6">
                AUTORIDADE <br /> TÉCNICA EM <br /> <span className="text-primary">VILA MADALENA</span>
              </h2>
              <p className="text-xl text-gray-500 leading-relaxed text-balance text-left font-medium">
                A região da Vila Madalena exige engenharia de precisão com foco em bares, restaurantes de calçada e coworkings culturais. A regularização do AVCB no CBPMESP precisa seguir rigorosamente as normas 2025 do Decreto Estadual, cobrindo com assertividade tudo o que prefeituras e órgãos exigem dos empreendimentos no eixo da  Rua Aspicuelta.
              </p>
            ...
            <div className="relative">
              <div className="bg-slate-900 rounded-[3rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl group transition-all border-b-8 border-primary text-left">
                ...
                <div className="space-y-6 text-base text-gray-300 leading-relaxed text-left font-medium">
                  <p>Operar bares e casas noturnas em Vila Madalena sem o cálculo exato de saídas de emergência e lotação é um risco jurídico imenso. Regularizamos seu estabelecimento focando na segurança dos clientes e na validade do seu alvará.</p>
                ...
                <div className="mt-10 p-8 bg-white/5 border border-white/10 rounded-[2rem] italic text-[11px] text-gray-400 font-black uppercase tracking-[0.3em] leading-relaxed text-center shadow-inner font-black shadow-primary/10">
                   "A inteligência técnica nos restaurantes e coberturas de Vila Madalena."
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-6xl text-center">
           <div className="text-center mb-16">
              ...
              <p className="text-gray-500 font-bold uppercase tracking-widest text-xs text-center">Expertise em Gastronomia e Corporativo: Vila Madalena SP</p>
           </div>
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Precisa de AVCB em Vila Madalena? Fale agora com um engenheiro especialista.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="imóvel em Vila Madalena"
            variant="primary"
            centered
          />
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-10 leading-[1.1]">
                  PRESENÇA <br /><span className="text-primary">VILA MADALENA SP</span>
                </h2>
      ...
      <SocialProof
        testimonial={{
          text: "A DRD2 regularizou nosso estabelecimento em Vila Madalena com agilidade e sem burocracia. AVCB aprovado sem nenhuma pendência. Recomendo a todos os empresários da região.",
          author: "Cliente DRD2 Engenharia",
          role: "Empresário — Vila Madalena, São Paulo",
        }}
      />
      ...
      <section className="py-24 bg-white border-t border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="text-center mb-16 underline decoration-primary decoration-4 underline-offset-16">
             <h2 className="text-4xl font-black text-secondary uppercase italic tracking-tighter text-center font-black tracking-tighter">Dúvidas <span className="text-primary not-italic text-sm font-bold tracking-tighter text-center font-black">VILA MADALENA</span></h2>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-slate-300 text-xl font-black uppercase italic tracking-tight mb-2">
            Não arrisque seu CNPJ em Vila Madalena.
          </p>
      ...
      <section className="py-24 md:py-32 bg-slate-50 border-t border-slate-200 text-center relative overflow-hidden italic shadow-inner">
        <div className="container mx-auto px-4 max-w-6xl text-center">
            <h2 className="text-4xl md:text-6xl lg:text-[6rem] font-black text-secondary leading-[1.1] uppercase tracking-tighter mb-12 italic text-center">
              Vila Madalena Seguro <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter">EFICIÊNCIA MASTER</span>
            </h2>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-primary">AVCB em Vila Madalena</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Vila Madalena precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-primary p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 faz auditoria documental gratuita antes de qualquer protocolo em Vila Madalena. Evite exigencias, rejeicoes e atrasos identificando documentos pendentes antes de submeter ao CBPMESP.
          </div>
        </div>
      </section>
      ...
      <NeighborhoodAuthorityBlock
        neighborhood="Vila Madalena"
        zone="Zona Oeste"
        currentSlug="/avcb-vila-madalena"
      />

      <OccupationDepthBlock
        occupation="/Avcb Vila Madalena"
        currentSlug="/avcb-vila-madalena"
      />
      ...
      <InternalLinksBlock
        ...
        mode="bairro"
        maxLinks={6}
        titulo="Serviços de AVCB em Vila Madalena"
      />
