...
import {
  ...
  ShieldX, Beer, Music, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbBarContent as c } from "@/data/pages/renovacao-clcb-bar-sao-paulo";
...
export default function RenovacaoCLCBBarPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-bar-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Bar em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Bar e Pub", item: "/renovacao-clcb-bar-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Bar em São Paulo — DRD2 Engenharia"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — BAR, PUB E BOTECO
              </span>
              <span className="text-2xl md:text-3xl lg:text-4xl italic text-red-500 mt-1 block leading-none">
                CLCB VENCIDO? INTERDIÇÃO NOTURNA E ALVARÁ SUSPENSO — RENOVE JÁ
              </span>
            </h1>
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  Bar interditado às 23h com clientes dentro é a pior situação para o proprietário — responsabilidade civil, dano à reputação e custo de regularização emergencial. O CBPMESP intensificou fiscalizações em bares e casas noturnas após tragédias do setor.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            CLCB do seu bar vencido? Fale agora e receba diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="bar em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 para o seu bar?
              </h2>
              <div className="space-y-4">
                {[
                  "Especialistas em CLCB para bares e estabelecimentos noturnos",
                  "Verificação da compatibilidade do alarme com o sistema de som",
                  "Diagnóstico técnico gratuito sem surpresas",
                  "Adequações feitas durante o dia sem afetar o funcionamento noturno",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Beer, l: "Bares e Botecos" },
                { Icon: Music, l: "Pubs com Música ao Vivo" },
                { Icon: Beer, l: "Petiscarias e Chopperias" },
                { Icon: Music, l: "Bares com Pista de Dança" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Bar</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-bar-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-bar-sao-paulo" />
      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-clcb-bar-sao-paulo" />

      <OccupationAuthorityBlock occupation="Bar" currentSlug="/renovacao-clcb-bar-sao-paulo" />
      <OccupationDepthBlock occupation="Bar" currentSlug="/renovacao-clcb-bar-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-bar-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Bar em São Paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight italic">
            CLCB do seu bar vencido ou próximo do vencimento?
          </h2>
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 renova sem afetar o funcionamento noturno — do diagnóstico técnico à entrega do certificado.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
