  ...
  faqs: [
    {
      ...
      answer: "Não. A legislação é estadual (Decreto 63.911/18 e Instruções Técnicas), portanto o Corpo de Bombeiros de Mogi das Cruzes cobra os mesmos padrões da capital.",
    },
    {
