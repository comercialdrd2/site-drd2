...
const pageData: UniversalPageData = {
  slug: "/avcb-mogi-das-cruzes",
  meta: {
    title: "Regularização de AVCB em Mogi das Cruzes SP | DRD2 Engenharia",
    description: "Regularização e projeto de AVCB e CLCB em Mogi das Cruzes. Adequação para indústrias, galpões, condomínios e comércio no Alto Tietê. Sem burocracia e com aprovação garantida.",
  },
  eyebrow: "Regularização AVCB - Mogi das Cruzes",
  h1Line1: "Regularização de AVCB",
  h1Line2: "em Mogi das Cruzes",
  heroBg: "/images/blog/blog_hero_avcb_galpao.webp",
  introP1: "A DRD2 Engenharia oferece serviços especializados de regularização de AVCB (Auto de Vistoria do Corpo de Bombeiros) para indústrias, condomínios, centros logísticos e comércio em Mogi das Cruzes e região do Alto Tietê.",
  ...
  breadcrumbs: [
    ...
    { label: "AVCB Mogi das Cruzes" },
  ],
  h2_principal: {
    heading: "Sua Edificação em Mogi das Cruzes Está Regularizada?",
    body: "Muitos galpões industriais e condomínios na região de Mogi das Cruzes operam com AVCB vencido ou sequer possuem o documento, expondo-se a riscos graves. O Corpo de Bombeiros fiscaliza intensamente o Alto Tietê devido à alta concentração industrial e logística.",
  ...
  h2_riscos: {
    heading: "Riscos da Falta do AVCB em Mogi das Cruzes",
    intro: "Empresas sem AVCB sofrem penalidades severas que travam os negócios na região do Alto Tietê.",
    itens: [
      {
        titulo: "Interdição",
        desc: "O Corpo de Bombeiros e a Prefeitura de Mogi das Cruzes podem interditar totalmente a operação do estabelecimento.",
      },
      {
  ...
  h2_processo: {
    heading: "Processo de Regularização em Mogi das Cruzes",
    etapas: [
      { numero: "01", titulo: "Vistoria Técnica", desc: "Analisamos sua planta em Mogi das Cruzes e os sistemas de incêndio." },
  ...
  h2_detalhes: {
    ...
    itens: [
      { titulo: "Cálculo Hidráulico", desc: "Dimensionamos hidrantes e sprinklers para o risco exato do seu negócio em Mogi das Cruzes." },
  ...
  h2_quando: {
    heading: "Qual o Prazo para o AVCB em Mogi das Cruzes?",
  ...
  h2_escolher: {
    heading: "Por que escolher a DRD2 em Mogi das Cruzes?",
  ...
  h2_cobertura: {
    ...
    body1: "Atendemos Mogi das Cruzes, Itaquaquecetuba, Arujá, Ferraz de Vasconcelos, Biritiba Mirim, Guararema e região.",
  ...
  faqs: [
    {
      question: "O Corpo de Bombeiros de Mogi das Cruzes tem regras diferentes da capital?",
      answer: "Não. A legislação é estadual (Decreto 69.118/2024 e Instruções Técnicas), portanto o Corpo de Bombeiros de Mogi das Cruzes cobra os mesmos padrões da capital.",
    },
    {
      question: "Qual a diferença entre AVCB e CLCB em Mogi das Cruzes?",
    ...
    {
      question: "Meu galpão em Mogi das Cruzes já está pronto, mas o bombeiro pediu adequações. Vocês fazem?",
