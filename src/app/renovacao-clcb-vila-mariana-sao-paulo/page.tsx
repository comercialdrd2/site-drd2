...
const _slug = "/renovacao-clcb-vila-mariana-sao-paulo";
const _pageTitle = "Renovação de CLCB em Vila Mariana SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Vila Mariana com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura R. Domingos de Morais, Vergueiro, Paraíso e todo o bairro. DRD2 Engenharia.";
...
export default function RenovacaoClcbVilaMariana() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Vila Mariana?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Em Vila Mariana, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB em Vila Mariana exige obras?",
    ...
    {
      question: "Tenho um consultório ou restaurante na Rua Domingos de Morais com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. A proximidade com o Hospital São Paulo e a UNIFESP faz de Vila Mariana um polo de saúde com fiscalização frequente. Consultórios também correm risco de suspensão de credenciamentos de planos de saúde.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Vila Mariana precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — consultórios, clínicas, escritórios, salões de beleza, pequenos restaurantes. AVCB é exigido para imóveis maiores ou com risco elevado. A DRD2 define qual certificado se aplica no diagnóstico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Vila Mariana?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Vila Mariana, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região do Paraíso, Saúde e Ipiranga.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Vila Mariana" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Vila Mariana — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Vila Mariana:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido em Vila Mariana é risco real de interdição e bloqueio do alvará. Um dos maiores polos de saúde da Zona Sul, o bairro concentra consultórios, clínicas e restaurantes que precisam do certificado em dia para operar com segurança.
            </p>
            <div className="flex flex-col sm:flex-row gap-5">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl bg-[#25D366] px-10 py-6 text-xl font-black shadow-[0_0_40px_rgba(220,38,38,0.5)] hover:bg-[#1EBE5A] hover:-translate-y-1 transition-all text-white border border-red-500 uppercase tracking-tighter">
                Renovar CLCB em Vila Mariana Agora
              </a>
            </div>
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico em Vila Mariana",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Quem Precisa de Renovação de CLCB em Vila Mariana?
              </h2>
              <p className="text-slate-600 font-medium mb-6 leading-relaxed">Vila Mariana é um dos maiores polos de saúde da cidade, com centenas de consultórios e clínicas próximos ao Hospital São Paulo e à UNIFESP. A maioria opera em espaços menores que 750 m² — perfil exato do CLCB.</p>
              <ul className="space-y-4">
                {[
                  "Consultórios médicos e odontológicos na Rua Domingos de Morais",
                  "Clínicas de reabilitação e fisioterapia próximas ao Hospital São Paulo",
                  "Restaurantes e bares na cena gastronômica da Domingos de Morais",
                  "Salões de beleza e espaços estéticos no miolo do bairro",
                  "Escritórios e coworkings ao longo da Rua Vergueiro",
                ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido em Vila Mariana?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP pode interditar o estabelecimento em qualquer fiscalização. Em Vila Mariana, a alta concentração de serviços de saúde atrai inspeções conjuntas com a Vigilância Sanitária." },
              ...
              { icon: FileCheck, title: "Credenciamentos em Risco", text: "Consultórios e clínicas perdem credenciamento de planos de saúde com CLCB vencido. É exigência direta de operadoras como Amil, Unimed e Bradesco Saúde." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado em Vila Mariana?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Reforma ou Ampliação do Espaço</h3>
              <p className="text-slate-600 font-medium">Reformas em consultórios para adequação à NR-32 ou ampliações de salas em clínicas de Vila Mariana exigem atualização do CLCB antes de retomar o atendimento normalmente.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Renovação do Alvará Municipal</h3>
              <p className="text-slate-600 font-medium">A Prefeitura de São Paulo exige CLCB válido na renovação do alvará de funcionamento. Sem o certificado atualizado, o alvará não é emitido e a atividade fica irregular.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Auditorias de Planos de Saúde</h3>
              <p className="text-slate-600 font-medium">Operadoras de saúde realizam auditorias periódicas nos estabelecimentos credenciados. CLCB vencido em clínicas e consultórios de Vila Mariana é motivo de descredenciamento imediato.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="mt-16 bg-red-600 text-white rounded-[2rem] p-10 max-w-3xl mx-auto shadow-2xl font-black uppercase flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h4 className="text-2xl mb-4">Prazos de Renovação em Vila Mariana</h4>
              <ul className="text-sm font-medium space-y-2 opacity-90 normal-case mb-4">
                <li>• Consultórios e clínicas com sistemas OK: 15 a 30 dias</li>
      ...
      <SocialProof
        testimonial={{
          text: "Meu consultório de fisioterapia em Vila Mariana estava com CLCB vencido e recebi uma notificação da operadora de saúde. A DRD2 foi ágil, resolveu tudo sem eu precisar interromper os atendimentos e o credenciamento foi mantido.",
          author: "Cliente DRD2 Engenharia",
          role: "Fisioterapeuta — Vila Mariana, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Vila Mariana</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Toda Vila Mariana e Região</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB na Rua Domingos de Morais, Rua Vergueiro, Av. Prof. Paulino Werneck, e em todo o bairro — além dos bairros vizinhos: Moema, Paraíso, Saúde, Ipiranga e Chácara Klabin.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB em Vila Mariana Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-white text-sm font-bold mb-8">Cada dia sem renovação é um dia a mais de exposição para você e seu negócio em Vila Mariana.</p>
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Vila Mariana" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB em Vila Mariana e Zona Sul" />
      <LeadForm />
