...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[60vh] flex items-start bg-[#0a0a0e] pt-8 pb-10 lg:pt-12">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12 mt-4">
            
            {/* Texto Esquerda */}
            <div className="lg:w-[55%] text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-600/10 border border-red-500/30 backdrop-blur-md mb-4 animate-fade-in-up">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-4 leading-[1.1] tracking-tighter drop-shadow-2xl">
                AVCB e CLCB em São Paulo, <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-500 to-red-600 animate-gradient-x">do Comércio ao Condomínio.</span>
              </h1>
              
              <p className="text-lg md:text-xl text-slate-300 mb-6 font-medium leading-relaxed max-w-2xl border-l-4 border-red-600 pl-6 bg-gradient-to-r from-slate-900/50 to-transparent py-4 rounded-r-2xl backdrop-blur-sm">
                Aprovação ágil do <strong className="text-white">AVCB e CLCB</strong> para comércios, clínicas, igrejas, empresas e condomínios em São Paulo e Grande SP. Sem terceirizações, sem surpresas na vistoria.
              </p>
