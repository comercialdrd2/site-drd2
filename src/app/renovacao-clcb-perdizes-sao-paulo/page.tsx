...
const _slug = "/renovacao-clcb-perdizes-sao-paulo";
const _pageTitle = "Renovação de CLCB em Perdizes SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Perdizes com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Rua Cardoso de Almeida, Rua Turiassu, Av. Pompéia e toda a região. DRD2 Engenharia.";
...
export default function RenovacaoClcbPerdizesPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Perdizes?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Em Perdizes, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB em Perdizes exige obras?",
    ...
    {
      question: "Tenho uma clínica ou escola em Perdizes com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. Em Perdizes, clínicas médicas perdem o credenciamento em planos de saúde com CLCB vencido, e escolas e cursos ficam sujeitos a interdição pelo Corpo de Bombeiros com reflexo no MEC e na Secretaria de Educação.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Perdizes precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — consultórios, clínicas, comércio, escolas de idiomas, academias, salões, cafés. AVCB é exigido para imóveis maiores ou de risco elevado. A DRD2 define qual certificado se aplica no diagnóstico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Perdizes?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Perdizes, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Vila Madalena, Pompéia, Higienópolis, Sumaré e Santa Cecília.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Perdizes" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Perdizes — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Perdizes:<br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-3xl leading-relaxed">
              Perdizes reúne clínicas, consultórios, cursos e comércio tradicional na Zona Oeste.
              CLCB vencido bloqueia credenciamento em planos de saúde e expõe o imóvel à interdição pelo CBPMESP.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
                ...
                <RefreshCw className="w-5 h-5" /> Renovar CLCB em Perdizes
              </a>
              <a href="#diagnostico"
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-2"><Map className="w-4 h-4 text-blue-400" /> Perdizes · Pompéia · Vila Madalena</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4">
            Quem Precisa de Renovação de CLCB em Perdizes?
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            Perdizes é um bairro residencial consolidado com forte atividade comercial e de saúde.
            Rua Cardoso de Almeida, Rua Turiassu, Rua Ministro Godói e Av. Pompéia concentram
            consultórios, clínicas, escolas de idiomas, academias e comércio de bairro
            que precisam do CLCB válido para funcionar e manter credenciamentos.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Estabelecimentos que mais renovam em Perdizes</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Consultórios médicos e odontológicos na Rua Cardoso de Almeida</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Clínicas de fisioterapia e psicologia no entorno da PUC-SP</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Escolas de idiomas e cursos profissionalizantes na Rua Turiassu</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Academias, studios de pilates e dança</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Restaurantes e padarias na Av. Pompéia e Rua Ministro Godói</li>
            ...
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Por que Perdizes exige atenção com o CLCB?</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Presença da PUC-SP concentra cursos e escolas que precisam de CLCB para funcionar conforme MEC</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Alta densidade de clínicas cria frequência elevada de auditorias de planos de saúde</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Comércio de bairro consolidado tem renovações periódicas de contrato que exigem CLCB válido</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Subprefeitura Lapa realiza vistorias conjuntas com CBPMESP na região</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">
            O Que Acontece com CLCB Vencido em Perdizes?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              { icon: Clock, title: "Credenciamento Suspenso", desc: "Planos como Amil, Unimed e Bradesco Saúde suspendem o credenciamento de clínicas sem CLCB válido." },
              { icon: FileCheck, title: "Embargo de Curso ou Escola", desc: "Cursos e escolas com CLCB vencido ficam sujeitos a embargo, com reflexo em autorizações do MEC e SEE." },
            ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Map, title: "Abertura de novo ponto", desc: "Clínica, escola ou comércio em Perdizes precisa de CLCB antes de iniciar atividades." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8">
                Como Funciona a Renovação de CLCB em Perdizes
              </h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8">
              <h3 className="font-black text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Clock className="w-6 h-6 text-amber-500" /> Prazo de Renovação em Perdizes
              </h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-black mb-4">Diagnóstico Gratuito para Renovação de CLCB em Perdizes</h2>
              ...
              <ul className="space-y-3 text-slate-300">
                {["Diagnóstico técnico gratuito", "Sem obras desnecessárias", "Engenheiro responsável pelo processo", "Cobertura: Perdizes e toda Zona Oeste"].map((item) => (
      ...
      <SocialProof
        testimonial={{
          text: "Tenho uma escola de idiomas na Rua Turiassu e recebi notificação do CBPMESP. Meu CLCB estava vencido há quase um ano. A DRD2 resolveu em 35 dias sem obras — e ainda me orientou a regularizar a sinalização de emergência antes do protocolo para não ter exigência.",
          author: "Camila Ferraz",
          role: "Diretora de escola de idiomas, Perdizes",
        }}
      />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-10 text-center">Perguntas Frequentes — CLCB Perdizes</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">Cobertura: Perdizes e Região</h2>
          <p className="text-center text-slate-500 mb-8 max-w-2xl mx-auto">
            Além de Perdizes, a DRD2 atende renovações de CLCB nos bairros vizinhos da Zona Oeste e Centro.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {["Vila Madalena", "Pompéia", "Sumaré", "Alto de Pinheiros", "Higienópolis", "Santa Cecília", "Barra Funda", "Lapa"].map((bairro) => (
      ...
      <CtaWhatsApp label="CLCB Vencido em Perdizes? Fale com um Engenheiro Agora" />
      ...
      <nav aria-label="Breadcrumb" className="py-4 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <li className="text-slate-300">/</li>
            <li className="text-slate-800 font-medium">Perdizes</li>
          </ol>
        </div>
      </nav>
    </>
