            ...
            <div key={i} className="mb-24 last:mb-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {block.services.map((srv) => (
                  <Link 
                    key={srv.slug} 
                    href={srv.slug === "avcb-sao-paulo" ? "/avcb-sao-paulo" : srv.slug === "clcb-sao-paulo" ? "/clcb-sao-paulo" : srv.slug === "renovacao-avcb-condominio-sao-paulo" ? "/renovacao-avcb-condominio-sao-paulo" : srv.slug === "projetos-seguranca-incendio" ? "/projetos-incendio" : srv.slug === "projeto-escada-pressurizada-avcb-sao-paulo" ? "/projeto-escada-pressurizada-avcb-sao-paulo" : srv.slug === "projeto-pet-sp" ? "/projeto-pet" : srv.slug === "laudo-estanqueidade-gas-sao-paulo" ? "/laudo-estanqueidade-gas-sao-paulo" : srv.slug === "avcb-condominio-sao-paulo" ? "/avcb-para-condominio-sao-paulo" : srv.slug === "avcb-galpao-industrial-sao-paulo" ? "/avcb-galpao-industrial-sao-paulo" : srv.slug === "avcb-hospital-clinica-sao-paulo" ? "/avcb-hospital-clinica-sao-paulo" : srv.slug === "avcb-comercial-escritorio-sao-paulo" ? "/avcb-para-escritorio-sao-paulo" : srv.slug === "avcb-escola-faculdade-sao-paulo" ? "/avcb-para-escola-sao-paulo" : srv.slug === "alarme-de-incendio-para-condominio-sao-paulo" ? "/alarme-de-incendio-para-condominio-sao-paulo" : srv.slug === "alarme-de-incendio-galpao-industrial-sp" ? "/alarme-de-incendio-galpao-industrial-sp" : srv.slug === "alarme-de-incendio-hospital-clinica-sp" ? "/alarme-de-incendio-hospital-clinica-sp" : srv.slug === "alarme-de-incendio-comercial-escritorio-sp" ? "/alarme-de-incendio-comercial-escritorio-sp" : srv.slug === "alarme-de-incendio-escola-faculdade-sp" ? "/alarme-de-incendio-escola-faculdade-sp" : srv.slug === "chuveiro-automatico-sprinkler-sao-paulo" ? "/sprinklers" : srv.slug === "instalacao-hidrante-sao-paulo" ? "/hidrantes" : srv.slug === "spda-para-raios-sao-paulo" ? "/spda" : srv.slug === "manutencao-sistemas-incendio" ? "/manutencao" : srv.slug === "treinamento-brigada-incendio" ? "/treinamento-brigada" : `/servicos/${srv.slug}`}  
