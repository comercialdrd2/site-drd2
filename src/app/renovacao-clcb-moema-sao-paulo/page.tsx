...
const _slug = "/renovacao-clcb-moema-sao-paulo";
const _pageTitle = "Renovação de CLCB em Moema SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Moema com engenheiro especializado. CLCB vencido? Regularize antes de interdição, multa ou bloqueio do alvará. Cobertura Moema Pássaros, Moema Índios, Av. Ibirapuera e todo o bairro. DRD2 Engenharia.";
...
export default function RenovacaoClcbMoemaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Moema?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Em Moema, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB em Moema exige obras?",
    ...
    {
      question: "Tenho uma clínica ou restaurante em Moema com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará. Clínicas perdem credenciamento de planos de saúde. Restaurantes e estabelecimentos alimentícios em Moema também correm risco de autuação pela Vigilância Sanitária, que verifica o CLCB durante inspeções.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Moema precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — comércio, clínicas, salões de beleza, escritórios, pequenos restaurantes. AVCB é exigido para imóveis maiores ou de maior risco. A DRD2 define qual se aplica no diagnóstico técnico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Moema?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Moema, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro, Moema Pássaros, Moema Índios e a região da Zona Sul.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Moema" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Moema — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Moema:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido em Moema é risco real de interdição e bloqueio do alvará. Clínicas na Alameda dos Arapanés, restaurantes na Av. Ibirapuera, salões em Moema Pássaros — qualquer estabelecimento pode ser autuado pelo CBPMESP a qualquer momento.
            </p>
            ...
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico em Moema",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Quem Precisa de Renovação de CLCB em Moema?
              </h2>
              <p className="text-slate-600 font-medium mb-6 leading-relaxed">Moema concentra uma das maiores densidades de estabelecimentos de saúde, beleza e gastronomia da Zona Sul. A maioria opera em espaços menores que 750 m² — exatamente o perfil do CLCB.</p>
              <ul className="space-y-4">
                {[
                  "Clínicas médicas e odontológicas na Alameda dos Arapanés e Av. Moaci",
                  "Salões de beleza e clínicas estéticas em Moema Pássaros",
                  "Restaurantes e cafeterias na Av. Ibirapuera e arredores do parque",
                  "Escritórios e consultórios em Moema Índios",
                  "Academias e estúdios de pilates em todo o bairro",
                ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido em Moema?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP pode interditar o estabelecimento em qualquer fiscalização — sem aviso. Moema é bairro de alto movimento, o que atrai fiscalizações com mais frequência." },
              { icon: ShieldX, title: "Multas e Autuações", text: "Além da interdição, o responsável recebe multa proporcional ao tempo de irregularidade. Em Moema, os estabelecimentos são conhecidos e qualquer irregularidade tem visibilidade." },
              { icon: FileCheck, title: "Credenciamentos em Risco", text: "Clínicas perdem credenciamento de planos de saúde. Restaurantes sofrem autuação da Vigilância Sanitária. Sem CLCB válido, nenhum desses processos avança." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado em Moema?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              ...
              <p className="text-slate-600 font-medium">Em Moema, reformas em clínicas e ampliações de restaurantes são comuns. Qualquer alteração no layout ou no uso do espaço exige atualização do CLCB antes de retomar as atividades normais.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Renovação do Alvará Municipal</h3>
              <p className="text-slate-600 font-medium">A Prefeitura de São Paulo exige CLCB válido na renovação do alvará de funcionamento. Sem o certificado atualizado, o alvará não é renovado e a atividade fica irregular.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Credenciamentos e Contratos</h3>
              <p className="text-slate-600 font-medium">Clínicas com planos de saúde, restaurantes em guias gastronômicos e estabelecimentos em condomínios comerciais de Moema precisam de CLCB válido para manter seus credenciamentos e contratos.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="mt-16 bg-red-600 text-white rounded-[2rem] p-10 max-w-3xl mx-auto shadow-2xl font-black uppercase flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h4 className="text-2xl mb-4">Prazos de Renovação em Moema</h4>
              <ul className="text-sm font-medium space-y-2 opacity-90 normal-case mb-4">
                <li>• Salões, clínicas e escritórios com sistemas OK: 15 a 30 dias</li>
      ...
      <SocialProof
        testimonial={{
          text: "Minha clínica estética em Moema estava com CLCB vencido e estava travando a renovação do credenciamento de um plano de saúde. A DRD2 resolveu tudo em menos de 20 dias, sem fechar a clínica. Muito profissional.",
          author: "Cliente DRD2 Engenharia",
          role: "Proprietária de Clínica Estética — Moema, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Moema</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Todo Moema e a Zona Sul</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB em Moema Pássaros, Moema Índios, Av. Ibirapuera, Av. Moaci, Alameda dos Arapanés e em todo o bairro — além dos bairros vizinhos: Vila Mariana, Campo Belo, Brooklin e Santo Amaro.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB em Moema Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-white text-sm font-bold mb-8">Cada dia sem renovação é um dia a mais de exposição para você e seu negócio em Moema.</p>
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Moema" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB em Moema e Zona Sul" />
      <LeadForm />
