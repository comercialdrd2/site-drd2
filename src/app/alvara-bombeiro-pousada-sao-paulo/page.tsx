...
import { alvaraBombeiroContent as c } from "@/data/pages/alvara-bombeiro-pousada-sao-paulo";
...
export default function AlvaraBombeiroPousadaPage() {
  ...
  const schema = generateMasterSchema({
    ...
    title: c.meta.title,
    description: c.meta.description,
    serviceName: "Alvará do Corpo de Bombeiros para Pousadas em São Paulo",
    faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Serviços", item: "/servicos" },
      { name: "Alvará Bombeiro Pousada SP", item: c.meta.canonical },
    ],
  });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Pousada em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Pousada" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Pousada com AVCB irregular? Regularize agora.
          </p>
          <p className="text-red-200 text-sm font-bold mb-6">
            A DRD2 Engenharia regulariza com 98% de aprovação na 1ª análise.
          </p>
          <CtaWhatsApp label="Solicitar vistoria diagnóstica gratuita" occupationType="pousada" variant="primary" centered />
        </div>
      </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Pousada</span>
          </h2>
      ...
      <OccupationAuthorityBlock occupation="Pousada" currentSlug={c.meta.canonical} />
      <OccupationDepthBlock occupation="Pousada" currentSlug={c.meta.canonical} />
      <InternalLinksBlock currentSlug={c.meta.canonical} mode="ocupação" maxLinks={8} titulo="Alvará Bombeiro para Pousada em SP" />
