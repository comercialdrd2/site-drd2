...
const data: UniversalPageData = {
  ...
  "breadcrumbs": [
    ...
    {
      "label": "AVCB para Renovação de Seguro"
    }
  ],
  ...
  "h2_riscos": {
    ...
    "itens": [
      {
        "titulo": "Apólice cancelada sem comunicação prévia suficiente",
        "desc": "Seguradoras podem cancelar a apólice com 30 dias de aviso. Sem cobertura ativa, o imóvel fica desprotegido contra incêndio, explosão, desabamento e responsabilidade civil — risco integral para o proprietário."
      },
      {
        "titulo": "Sinistro negado com AVCB vencido",
        "desc": "Se houver sinistro com a apólice tecnicamente vigente mas AVCB vencido, a seguradora pode negar o pagamento com base na cláusula de manutenção de sistemas — argumento que tem sustentação jurídica quando o AVCB está vencido há mais de 30 dias."
      },
      {
        "titulo": "Renovação negada — período sem cobertura",
        "desc": "Sem renovação aprovada pela seguradora, o imóvel fica sem cobertura patrimonial. Nesse período, qualquer incidente representa perda financeira integral — responsabilidade do proprietário."
      },
      {
        "titulo": "Aumento de prêmio por risco elevado",
        "desc": "Algumas seguradoras mantêm a cobertura mas elevam o prêmio significativamente enquanto o AVCB está irregular — custo direto mensurável que pode superar o custo da regularização."
      },
      {
        "titulo": "Notificação a financiadores e locatários",
        "desc": "Quando o imóvel é financiado, o banco que concedeu o crédito é geralmente beneficiário da apólice e é notificado do cancelamento — podendo acionar cláusulas de rescisão ou exigência de novo seguro mais caro."
      },
      {
        "titulo": "Responsabilidade civil ampliada",
        "desc": "Com apólice cancelada, o proprietário assume integralmente qualquer indenização por danos a terceiros em caso de incêndio propagado do imóvel — sem o respaldo da seguradora para defender e pagar eventuais ações."
      }
    ]
  },
  "h2_detalhes": {
    ...
    "itens": [
      {
        "titulo": "AVCB válido emitido pelo CBPMESP",
        "desc": "O certificado de conformidade emitido após aprovação na vistoria do Corpo de Bombeiros — documento mais completo e aceito por todas as seguradoras, sem questionamentos adicionais."
      },
      {
        "titulo": "CLCB (Certificado de Licença do Corpo de Bombeiros)",
        "desc": "Para imóveis de baixo risco e menor área, o CLCB é equivalente ao AVCB e igualmente aceito pelas seguradoras. Processo mais rápido e com custo menor."
      },
      {
        "titulo": "Laudo técnico de sistemas com ART",
        "desc": "Para seguradoras que aceitam laudos intermediários enquanto o processo de AVCB está em andamento — a DRD2 emite laudo técnico de alarme, hidrante ou sprinkler com ART CREA-SP em até 48h."
      },
      {
        "titulo": "Protocolo do processo no CBPMESP",
        "desc": "Algumas seguradoras aceitam o número de protocolo do processo em andamento no Corpo de Bombeiros como evidência de regularização em curso — a DRD2 protocola com urgência e entrega o número para o segurado apresentar à seguradora."
      }
    ],
  ...
  "h2_processo": {
    ...
    "etapas": [
      {
        "numero": "ETAPA 01",
        "titulo": "Diagnóstico em 24h",
        "desc": "Levantamento completo do imóvel: estado dos sistemas, documentação existente, histórico no CBPMESP e verificação de Comunique-ses em aberto. Definição do caminho mais rápido para a regularização."
      },
      {
        "numero": "ETAPA 02",
        "titulo": "Enquadramento e estratégia",
        "desc": "Definição entre AVCB e CLCB conforme o imóvel. Para imóveis que se enquadram em CLCB, o processo é mais rápido — estratégia relevante quando a seguradora tem prazo curto."
      },
      {
        "numero": "ETAPA 03",
        "titulo": "Adequação dos sistemas",
        "desc": "Execução das obras necessárias: extintores, sinalização, iluminação de emergência, hidrante, alarme ou sprinkler conforme exigido para o tipo de imóvel. A DRD2 executa com equipe própria."
      },
      {
        "numero": "ETAPA 04",
        "titulo": "Laudos técnicos intermediários",
        "desc": "Quando a seguradora aceita laudos parciais durante o processo, emitimos laudos de cada sistema com ART CREA-SP para documentar o estado de regularização progressiva."
      },
      {
        "numero": "ETAPA 05",
        "titulo": "Protocolo priorizado no CBPMESP",
        "desc": "Protocolo do processo com documentação pré-auditada para entrar sem pendências na fila de análise. Entregamos o número de protocolo para apresentação imediata à seguradora."
      },
      {
        "numero": "ETAPA 06",
        "titulo": "AVCB emitido e entregue",
        "desc": "Após a vistoria e aprovação, entregamos o AVCB emitido pelo CBPMESP — documento final que encerra definitivamente a exigência da seguradora e permite renovação sem restrições."
      }
    ]
  },
  "h2_quando": {
  ...
  "faqs": [
    {
      "question": "A seguradora pode cancelar o seguro por falta de AVCB?",
      "answer": "Sim. A maioria das apólices de seguro patrimonial e empresarial inclui como cláusula a manutenção de sistemas de segurança contra incêndio certificados. Com AVCB vencido ou ausente, a seguradora pode não renovar a apólice ou, em alguns casos, cancelar a vigência com aviso de 30 dias."
    },
    {
      "question": "Seguradora aceitou o protocolo do processo como documento provisório. É seguro?",
      "answer": "Sim, desde que o protocolo seja real, verificável no sistema do CBPMESP e o processo esteja efetivamente em andamento. A DRD2 protocola com documentação completa e entrega o número de protocolo acompanhado de declaração técnica descrevendo o andamento do processo."
    },
    {
      "question": "Quanto tempo leva para ter o AVCB para apresentar à seguradora?",
      "answer": "O processo completo leva de 60 a 120 dias. Para seguradoras com prazo menor, a DRD2 emite laudos técnicos intermediários de cada sistema com ART CREA-SP em até 48h — documentos aceitos por muitas seguradoras como evidência de regularização em curso."
    },
    {
      "question": "O laudo técnico de engenheiro substitui o AVCB para a seguradora?",
    ...
    {
      "question": "Tenho 30 dias para apresentar o AVCB à seguradora. É possível regularizar nesse prazo?",
