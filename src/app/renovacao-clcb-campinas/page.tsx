...
const _slug = "/renovacao-clcb-campinas";
const _pageTitle = "Renovação de CLCB em Campinas SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Campinas com engenheiro especializado. CLCB vencido? Regularize antes de interdição, multa ou bloqueio do alvará. Cobertura Cambuí, Centro, Taquaral, Barão Geraldo e toda Campinas. DRD2 Engenharia.";
...
export default function RenovacaoClcbCampinasPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Campinas?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP (4ª UGBM). Em Campinas, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico.",
    },
    {
      question: "A renovação de CLCB em Campinas exige obras?",
      answer: "Na maioria dos casos, não. Se os extintores estão no prazo, a sinalização está correta e as saídas estão desobstruídas, a renovação não exige obras. A DRD2 faz o diagnóstico técnico gratuito para mapear qualquer pendência antes de protocolar.",
    },
    {
      question: "Tenho um escritório ou clínica no Cambuí com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP (4ª UGBM), multa e bloqueio do alvará pela Prefeitura de Campinas. Clínicas que atendem planos de saúde também correm risco de suspensão do credenciamento junto à Vigilância Sanitária. Regularize com urgência.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Campinas precisa?",
    ...
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Campinas?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Campinas, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o município, Barão Geraldo, Nova Campinas e a região metropolitana de Campinas.",
    },
  ];
  ...
  const _schema = generateMasterSchema({
    ...
    serviceName: "Renovação de CLCB em Campinas",
    faqs: faqItems,
    breadcrumbs: [
      { name: "Home", item: "/" },
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Campinas" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Campinas — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Campinas:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido em Campinas é risco real de interdição pela 4ª UGBM do CBPMESP e bloqueio do alvará municipal. Escritórios no Cambuí, clínicas no Centro ou salões em Taquaral — a irregularidade pode paralisar seu negócio a qualquer momento.
            </p>
            <div className="flex flex-col sm:flex-row gap-5">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl bg-[#25D366] px-10 py-6 text-xl font-black shadow-[0_0_40px_rgba(220,38,38,0.5)] hover:bg-[#1EBE5A] hover:-translate-y-1 transition-all text-white border border-red-500 uppercase tracking-tighter">
                Renovar CLCB em Campinas Agora
              </a>
            </div>
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico em Campinas",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Processo Completo de Renovação de CLCB em Campinas:<br />
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  "Protocolo de renovação junto ao CBPMESP (4ª UGBM — Campinas).",
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido em Campinas?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP (4ª UGBM) pode interditar o estabelecimento em qualquer fiscalização — sem aviso prévio. Lojas, clínicas e escritórios em Campinas param instantaneamente." },
              ...
              { icon: FileCheck, title: "Alvará Bloqueado", text: "A Prefeitura de Campinas exige CLCB válido para renovar o alvará de funcionamento. Sem renovação, o estabelecimento opera na ilegalidade." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado em Campinas?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-white p-10 rounded-[2.5rem] border border-red-600 shadow-xl relative overflow-hidden">
              ...
              <p className="text-slate-600 font-medium">CLCB expirado exige renovação imediata. Não espere notificação — a 4ª UGBM fiscaliza a qualquer momento. Inicie o processo assim que perceber que o vencimento está se aproximando.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              ...
              <p className="text-slate-600 font-medium">Qualquer alteração no uso do espaço exige atualização do CLCB. Em Campinas, reformas em consultórios no Cambuí, coworkings em Barão Geraldo e expansões de lojas no Centro são causas frequentes de renovação antecipada.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Renovação do Alvará Municipal</h3>
              <p className="text-slate-600 font-medium">A Prefeitura de Campinas exige CLCB válido na renovação do alvará de funcionamento. Sem o certificado atualizado, o alvará não é emitido e a atividade fica irregular perante a municipalidade.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Credenciamentos e Contratos</h3>
              <p className="text-slate-600 font-medium">Clínicas com planos de saúde, startups com contratos corporativos e estabelecimentos em condomínios comerciais de Campinas precisam de CLCB válido para manter credenciamentos e contratos ativos.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {[
              ...
              { step: "4", title: "Protocolo", desc: "Submissão no CBPMESP Campinas." },
      ...
      <SocialProof
        testimonial={{
          text: "Meu estúdio de pilates no Cambuí estava com CLCB vencido e precisava regularizar antes da renovação do alvará. A DRD2 resolveu tudo em menos de três semanas, sem fechar o estúdio. Excelente serviço.",
          author: "Cliente DRD2 Engenharia",
          role: "Proprietária de Estúdio — Campinas, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Campinas</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Toda Campinas e a Região Metropolitana</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB em Cambuí, Centro, Taquaral, Barão Geraldo, Nova Campinas, Guanabara, Mansões Santo Antônio, Castelo e em todo o município — além de Sumaré, Hortolândia, Valinhos, Vinhedo e demais cidades da RMC.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB em Campinas Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Campinas" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB em Campinas e Região Metropolitana" />
      <LeadForm />
