...
import {
  ...
  Building2, Utensils, Hotel, Dumbbell, Church, Factory, Heart, Bed
} from "lucide-react";
...
import { renovacaoAvcbContent as c } from "@/data/pages/renovacao-avcb";
...
const occupationIcons: Record<string, any> = {
  "Renovação para Condomínio": Building2,
  "Renovação para Restaurante": Utensils,
  "Renovação para Hotel": Hotel,
  "Renovação para Academia": Dumbbell,
  "Renovação para Igreja": Church,
  "Renovação para Galpão Industrial": Factory,
  "Renovação para Casa de Repouso": Heart,
  "Renovação para Hostel": Bed,
  "Renovação para Motel": Bed,
};
  ...
  return (
    <>
      <JsonLD schema={generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB em São Paulo", item: "/renovacao-avcb" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de AVCB em São Paulo"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-300 mb-6 leading-relaxed font-medium max-w-2xl">
              {c.intro[1]}
            </p>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB em São Paulo" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            AVCB vencido? Fale agora com um engenheiro pelo WhatsApp e receba o diagnóstico gratuito.
          </p>
          <CtaWhatsApp
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden">
              ...
              <ul className="space-y-6 relative z-10">
                {[
                  { t: "90 dias antes", d: "Início recomendado do diagnóstico" },
                  { t: "60 dias antes", d: "Execução de adequações técnicas" },
                  { t: "30 dias antes", d: "Protocolo no Corpo de Bombeiros" },
                  { t: "AVCB Vencido", d: "Risco imediato de interdição e multa" }
                ].map((item, i) => (
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-red-600 p-10 rounded-[3rem] shadow-2xl">
                ...
                <p className="text-red-100 font-bold mb-8 leading-relaxed italic">Atendimento emergencial para renovação de AVCB em todas as regiões metropolitanas.</p>
                <CtaWhatsApp
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              {"Dúvidas Frequentes sobre Renovação de AVCB"}
            </h2>
          </div>
      ...
      <ServiceClusterLinks currentSlug="/renovacao-avcb" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb" />

      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-avcb" />
