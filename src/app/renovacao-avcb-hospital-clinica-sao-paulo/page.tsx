...
import {
  ...
  ShieldX, AlertTriangle, MapPin, Activity, Stethoscope, Zap,
  BriefcaseMedical, HeartPulse, Microscope, Thermometer, Droplets,
...
import { renovacaoAvcbHospitalContent as c } from "@/data/pages/renovacao-avcb-hospital-clinica-sao-paulo";
...
export default function RenovacaoAVCBHospitalPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const _schema = generateMasterSchema({
        slug: "/renovacao-avcb-hospital-clinica-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Hospital e Clínica em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Hospital e Clínica", item: "/renovacao-avcb-hospital-clinica-sao-paulo" },
        ],
      });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de AVCB para Hospital e Clínica em São Paulo"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-3xl lg:text-4xl font-black mb-2 leading-[0.9] tracking-tighter uppercase italic text-white flex flex-col">
              ...
              <span className="text-red-600 not-italic text-2xl md:text-3xl lg:text-4xl mt-2 block drop-shadow-2xl text-wrap">
                PARA HOSPITAL E CLÍNICA EM SP — A SEGURANÇA DOS PACIENTES
              </span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Hospital e Clínica" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 font-bold text-slate-900 uppercase italic tracking-tight">Situações que complicam a renovação de hospitais e clínicas:</p>
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            AVCB do hospital ou clínica vencido? Fale agora com um engenheiro pelo WhatsApp e receba o diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico para Saúde"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                    <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic leading-none" dangerouslySetInnerHTML={{ __html: c.h2_diferenca.heading }} />
                    <p className="text-lg text-slate-700 leading-relaxed font-medium mb-10 italic" dangerouslySetInnerHTML={{ __html: c.h2_diferenca.intro }} />
                    ...
                    <p className="mt-8 font-bold text-slate-900 uppercase italic tracking-tight" dangerouslySetInnerHTML={{ __html: c.h2_diferenca.closing }} />
                </div>

                <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden h-full">
                    <HeartPulse className="absolute -bottom-10 -right-10 w-64 h-64 text-red-600 opacity-10" />
                    <h2 className="font-black text-2xl uppercase italic mb-6 relative z-10 text-red-500 leading-tight" dangerouslySetInnerHTML={{ __html: c.h2_impacto.heading }} />
                    <p className="text-slate-400 mb-8 relative z-10 leading-relaxed italic" dangerouslySetInnerHTML={{ __html: c.h2_impacto.intro }} />
                    <div className="space-y-6 relative z-10">
                        {c.h2_impacto.itens.map((item, i) => (
                            <div key={i} className="flex items-start gap-4">
                                <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2.5 flex-shrink-0" />
                                <div>
                                    <p className="text-white font-black text-sm uppercase italic tracking-tight mb-1">{item.nome}</p>
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic" dangerouslySetInnerHTML={{ __html: c.h2_processo.heading }} />
          </div>
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            A segurança dos seus pacientes não pode esperar.
          </p>
          <p className="text-xl text-slate-300 font-medium mb-10 italic">
            Fale com um engenheiro e receba seu diagnóstico gratuito hoje para sua instituição.
          </p>
          <CtaWhatsApp
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/renovacao-avcb-hospital-clinica-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/renovacao-avcb-hospital-clinica-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-hospital-clinica-sao-paulo" />

      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-avcb-hospital-clinica-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Especialista em Renovação de AVCB para Hospitais e Clínicas em SP
          </p>
        </div>
      </section>
