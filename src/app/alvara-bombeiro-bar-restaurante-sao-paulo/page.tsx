...
import { alvaraBombeiroContent as c } from "@/data/pages/alvara-bombeiro-bar-restaurante-sao-paulo";
...
export default function AlvaraBombeiroBarRestaurantePage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Alvará do Corpo de Bombeiros para Bares e Restaurantes em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Alvará Bombeiro Bares e Restaurantes SP", item: c.meta.canonical },
        ],
      });
    ...
    <>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Bares e Restaurantes" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto">
              Itens verificados pelo Corpo de Bombeiros na vistoria de bares e restaurantes.
            </p>
          </div>
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Bar ou restaurante com AVCB irregular? Regularize agora.
          </p>
      ...
      {c.sections[6] && (
        <section className="py-24 bg-slate-50 border-y border-slate-200">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-10 uppercase tracking-tighter italic"
              dangerouslySetInnerHTML={{ __html: c.sections[6].title }} />
            <div className="space-y-6">
              {c.sections[6].content.map((p, i) => (
                <div key={i} className="text-lg text-slate-700 leading-relaxed font-medium"
                  dangerouslySetInnerHTML={{ __html: p }} />
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Bares e Restaurantes</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-500 opacity-60">
            DRD2 Engenharia — Alvará do Bombeiro para Bares e Restaurantes em São Paulo
          </p>
        </div>
      </section>
      ...
      <ServiceClusterLinks currentSlug="/alvara-bombeiro-bar-restaurante-sao-paulo" />
      <ServiceBlogLinks currentSlug="/alvara-bombeiro-bar-restaurante-sao-paulo" />
