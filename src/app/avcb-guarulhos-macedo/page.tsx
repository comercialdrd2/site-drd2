...
const _slug = "/avcb-guarulhos-macedo";
const _pageTitle = "AVCB e CLCB em Macedo, Guarulhos SP | DRD2 Engenharia";
const _pageDesc = "Regularização de AVCB e CLCB em Macedo, Guarulhos SP. Foco em segurança contra incêndio, aprovação técnica e renovação no Corpo de Bombeiros com projeto especializado.";
...
export default function ExpansionLandingPage() {
  ...
  const faqItems = [
    { question: "Hospital precisa de brigada de incêndio?", answer: "Sim, e a brigada deve ser composta por funcionários treinados para lidar com a evacuação de pacientes acamados." },
    { question: "O que muda no AVCB para clínicas?", answer: "O foco é a compartimentação de áreas críticas e a garantia de que os gases medicinais estejam em locais seguros." },
    { question: "Prédios antigos no Macedo podem ser clínicas?", answer: "Sim, desde que adequem as rotas de fuga e garantam a largura mínima das portas para passagem de macas." },
    { question: "Vigilância Sanitária exige AVCB?", answer: "É o primeiro documento solicitado. Sem AVCB/CLCB, a licença sanitária (LTA) não é emitida." },
    { question: "Qual o prazo para obter o AVCB em Macedo?", answer: "Em média de 30 a 90 dias, dependendo da complexidade técnica. A DRD2 acelera o processo com protocolos prioritários." }
  ];
  ...
  const _schema = generateMasterSchema({
    ...
    description: _pageDesc,
    neighborhood: "Macedo",
    serviceName: "AVCB e Regularização em Macedo",
    faqs: faqItems,
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Expansão", item: "#" },
      { name: "Macedo", item: _slug }
    ]
  });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-gray-900 border-b-4 border-red-600">
        <Image
          ...
          alt="Regularização de AVCB em Macedo"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              Sem AVCB válido em Macedo, sua empresa pode ser <strong className="text-white bg-red-600/30 px-2">interditada</strong> e seu <strong className="text-white bg-red-600/30 px-2">responsável pode ser autuado</strong>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                Falar com engenheiro especialista em Macedo
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="prose prose-lg text-slate-700">
               <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                ...
                <span className="text-red-600">Macedo</span>
              </h2>
              <p>
                Regularizar uma edificação em <strong>Macedo</strong> exige conhecimento das normas técnicas locais e estaduais. A região de Grande São Paulo é estratégica e possui rigorosa fiscalização.
              </p>
              <p>
                O Macedo é um bairro consolidado que abriga importantes hospitais e clínicas de Guarulhos. Edificações de saúde possuem exigências de AVCB muito superiores (IT-21), com foco em planos de abandono para pessoas com mobilidade reduzida.
              </p>
              <p>
      ...
      <section className="py-24 bg-slate-950 text-white">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="bg-red-900/20 border-l-8 border-red-600 p-10 rounded-r-[3rem] relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black mb-6 uppercase italic tracking-tight">Cenário Local: Macedo</h3>
              <p className="text-slate-300 text-lg leading-relaxed font-medium mb-6">
                Clínicas no Macedo que possuem internação ou procedimentos cirúrgicos são classificadas como Risco Especial. A ausência de AVCB válido aqui não gera apenas multas, mas a suspensão imediata do convênio médico e da vigilância sanitária.
              </p>
              <p className="text-red-400 font-bold uppercase italic tracking-tighter">
                ⚠️ Atendimento prioritário para a região: Av. Monteiro Lobato, Av. Papa Pio XII
              </p>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">Riscos Identificados em Macedo</h2>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { t: "Planos de abandono inexistentes", d: "Falta de treinamento de brigada para remover pacientes em caso de fumaça." },
                { t: "Sinalização tátil e visual precária", d: "Ausência de placas que orientem saídas em hospitais e clínicas de grande porte." },
                { t: "Central de GLP irregular", d: "Cilindros de oxigênio e gás de cozinha próximos demais, sem barreira de proteção." },
              ].map((prob, i) => (
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800 text-center">
         <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">Precisa de AVCB em Macedo? Fale agora conosco.</p>
         <CtaWhatsApp label="Agendar Vistoria Técnica" occupationType="imóvel em Macedo" variant="primary" centered />
      </div>
      ...
      <LeadForm />
      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={8} titulo="Serviços em Macedo" />

      <ServiceClusterLinks currentSlug="/avcb-guarulhos-macedo" />
      <ServiceBlogLinks currentSlug="/avcb-guarulhos-macedo" />
      ...
      <section className="py-24 bg-red-900 text-white text-center relative overflow-hidden">
         <div className="container mx-auto px-4 max-w-4xl relative z-10">
            <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter uppercase italic">Regularize sua clínica ou prédio no Macedo</h2>
            <p className="text-xl text-red-100 mb-12 font-medium italic">Focado em sinalização técnica e treinamento de brigada hospitalar.</p>
            <a href={whatsappLink} target="_blank" className="bg-white text-red-900 font-black px-10 py-5 rounded-2xl shadow-2xl hover:bg-slate-900 hover:text-white transition-all uppercase tracking-widest">
               Falar com Especialista em Macedo
            </a>
         </div>
      </section>
    </>
