...
const _slug = "/renovacao-clcb-santana-sao-paulo";
const _pageTitle = "Renovação de CLCB em Santana SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Santana com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Av. Braz Leme, Voluntários da Pátria, Tucuruvi e todo o bairro. DRD2 Engenharia.";
...
export default function RenovacaoClcbSantanaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Santana?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Em Santana, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB em Santana exige obras?",
    ...
    {
      question: "Tenho uma loja ou clínica na Av. Braz Leme com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. Santana é o principal polo comercial da Zona Norte, com fiscalização frequente em lojas, clínicas e serviços próximos ao terminal e ao shopping. Regularize sem esperar notificação.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Santana precisa?",
    ...
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Santana?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Santana, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Tucuruvi, Casa Verde, Mandaqui e Vila Guilherme.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Santana" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Santana — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Santana:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido em Santana é risco real de interdição e bloqueio do alvará. Principal polo comercial da Zona Norte, o bairro concentra lojas, clínicas e restaurantes sujeitos à fiscalização do CBPMESP a qualquer momento — sem aviso prévio.
            </p>
            ...
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico em Santana",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Quem Precisa de Renovação de CLCB em Santana?
              </h2>
              <p className="text-slate-600 font-medium mb-6 leading-relaxed">Santana reúne o maior volume de estabelecimentos comerciais da Zona Norte, com fluxo intenso na Av. Braz Leme, entorno do Shopping Santana e do Terminal Santana. A maioria dos negócios opera em espaços menores que 750 m² — perfil exato do CLCB.</p>
              <ul className="space-y-4">
                {[
                  "Lojas e serviços na Av. Braz Leme e Rua Voluntários da Pátria",
                  "Clínicas e consultórios médicos e odontológicos no bairro",
                  "Restaurantes e lanchonetes próximos ao Terminal Santana",
                  "Salões de beleza e clínicas estéticas espalhados pelo bairro",
                  "Academias e estúdios fitness ao longo da Av. Eng. Caetano Álvares",
                ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido em Santana?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP pode interditar o estabelecimento em qualquer fiscalização. Em Santana, a alta densidade comercial entorno do terminal e do shopping atrai fiscalizações com frequência." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado em Santana?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              ...
              <p className="text-slate-600 font-medium">Qualquer reforma ou mudança no uso do espaço exige atualização do CLCB. Em Santana, reconversões de lojas em clínicas e de escritórios em academias são causas frequentes de renovação antecipada.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              ...
              <p className="text-slate-600 font-medium">Clínicas com planos de saúde, franqueados e lojistas em galerias de Santana precisam de CLCB válido para manter credenciamentos e honrar obrigações contratuais com redes e operadoras.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="mt-16 bg-red-600 text-white rounded-[2rem] p-10 max-w-3xl mx-auto shadow-2xl font-black uppercase flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h4 className="text-2xl mb-4">Prazos de Renovação em Santana</h4>
      ...
      <SocialProof
        testimonial={{
          text: "Minha clínica odontológica em Santana estava com CLCB vencido há quatro meses. A DRD2 fez o diagnóstico em um dia, regularizou os extintores e entregou o CLCB renovado em três semanas. Processo sem complicação.",
          author: "Cliente DRD2 Engenharia",
          role: "Dentista — Santana, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Santana</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Todo Santana e a Zona Norte</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB na Av. Braz Leme, Rua Voluntários da Pátria, Av. Eng. Caetano Álvares e em todo o bairro — além dos bairros vizinhos: Tucuruvi, Casa Verde, Mandaqui, Vila Guilherme e Jaçanã.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB em Santana Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-white text-sm font-bold mb-8">Cada dia sem renovação é um dia a mais de exposição para você e seu negócio em Santana.</p>
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Santana" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB em Santana e Zona Norte" />
      <LeadForm />
