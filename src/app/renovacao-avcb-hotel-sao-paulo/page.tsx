...
import {
  ...
  ShieldX, AlertTriangle, MapPin, Building2, Bed, Calendar, Wrench,
} from "lucide-react";
...
import { renovacaoAvcbHotelContent as c } from "@/data/pages/renovacao-avcb-hotel-sao-paulo";
...
export default function RenovacaoAVCBHotelPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Hotel em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Hotel", item: "/renovacao-avcb-hotel-sao-paulo" },
        ],
      });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-3 shadow-lg shadow-red-900/20">
              Setor Hoteleiro — Renovação 2026
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                <Phone className="w-6 h-6" /> QUERO RENOVAR DO MEU HOTEL
              </a>
            </div>
          </div>
        </div>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Hotel em SP" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              Quais são os Riscos para o Hotel com{" "}
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Fale agora com um engenheiro e receba o diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico para Hotel"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Renovação do AVCB do Hotel?</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic ">
                Renovação com Mínimo Impacto na{" "}
                <span className="text-red-600 not-italic">Operação do Hotel</span>
              </h2>
            ...
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white">
              <h3 className="font-black text-2xl uppercase italic mb-6">
                {c.h2_tipos.heading.replace(" — Tem Diferença na Renovação?", "")}
              </h3>
              <p className="text-slate-400 mb-8" dangerouslySetInnerHTML={{ __html: c.h2_tipos.intro }} />
              <div className="space-y-6">
                {c.h2_tipos.formatos.map((formato, i) => (
                  <div key={i} className="mb-4 pb-4 border-b border-slate-800 last:border-0 last:mb-0 last:pb-0">
                    <p className="font-black text-white text-base mb-2">{formato.nome}</p>
                    <p className="text-slate-400 font-medium text-sm leading-relaxed">{formato.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">AVCB do seu Hotel</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic ">
                Atendemos Renovações de AVCB em Hotéis em{" "}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">Renovação de AVCB para Hotel SP</span>
            </h2>
          </div>
          <div className="space-y-4">
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            Não deixe seu hotel ser interditado.
          </p>
      ...
      <OccupationAuthorityBlock
        occupation="Hotel"
        currentSlug="/renovacao-avcb-hotel-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/renovacao-avcb-hotel-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-hotel-sao-paulo" />

      <NeighborhoodSilo currentSlug="/renovacao-avcb-hotel-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Renovação de AVCB para Hotéis em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
