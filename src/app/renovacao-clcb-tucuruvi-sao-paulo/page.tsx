...
const _slug = "/renovacao-clcb-tucuruvi-sao-paulo";
const _pageTitle = "Renovação de CLCB no Tucuruvi SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB no Tucuruvi com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Av. Tucuruvi, Av. Deputado Emílio Carlos, metrô Tucuruvi e toda a região. DRD2 Engenharia.";
...
export default function RenovacaoClcbTucuruViPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido no Tucuruvi?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. No Tucuruvi, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB no Tucuruvi exige obras?",
    ...
    {
      question: "Tenho uma clínica ou loja no Tucuruvi com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. No Tucuruvi, o corredor comercial da Av. Tucuruvi e o entorno do metrô concentram clínicas e farmácias sujeitas a auditorias de planos de saúde — e a subprefeitura Santana realiza fiscalizações conjuntas na região.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel no Tucuruvi precisa?",
    ...
    {
      question: "A DRD2 atende renovações urgentes de CLCB no Tucuruvi?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente no Tucuruvi, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Santana, Jaçanã, Vila Guilherme, Tremembé e Vila Medeiros.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB no Tucuruvi" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido no Tucuruvi — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB no Tucuruvi:<br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-3xl leading-relaxed">
              O Tucuruvi é o polo comercial da Zona Norte com maior acesso via metrô.
              Clínicas, farmácias e comércio na Av. Tucuruvi precisam do CLCB em dia
              para manter alvará e credenciamentos. A DRD2 regulariza em até 45 dias —
              sem obras desnecessárias.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
                ...
                <RefreshCw className="w-5 h-5" /> Renovar CLCB no Tucuruvi
              </a>
              <a href="#diagnostico"
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-2"><Map className="w-4 h-4 text-blue-400" /> Tucuruvi · Santana · Jaçanã</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4">
            Quem Precisa de Renovação de CLCB no Tucuruvi?
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            O Tucuruvi concentra o comércio da Zona Norte ao redor da estação de metrô de mesmo nome,
            terminal de ônibus e corredor comercial na Av. Tucuruvi e Av. Deputado Emílio Carlos.
            Clínicas populares, farmácias, academias e restaurantes que atendem moradores de
            toda a região precisam do CLCB válido para operar.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Estabelecimentos que mais renovam no Tucuruvi</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Clínicas populares de saúde e odontologia na Av. Tucuruvi</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Farmácias e drogarias no entorno do metrô Tucuruvi</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Restaurantes e lanchonetes no corredor comercial da Av. Deputado Emílio Carlos</li>
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Salões de beleza, barbearias e serviços de bairro</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Lojas de calçados, vestuário e conveniência no comércio local</li>
              </ul>
            </div>
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Por que o Tucuruvi exige atenção com o CLCB?</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Terminal de metrô e ônibus geram alto fluxo — CBPMESP e Prefeitura fiscalizam o entorno regularmente</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Planos de saúde populares realizam auditorias frequentes em clínicas do corredor</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Subprefeitura Santana realiza vistorias conjuntas com CBPMESP na Zona Norte</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Comércio consolidado com renovações periódicas de contrato exige CLCB válido</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">
            O Que Acontece com CLCB Vencido no Tucuruvi?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Map, title: "Abertura de novo ponto", desc: "Clínica, farmácia ou loja no Tucuruvi precisa de CLCB antes de iniciar atividades." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8">
                Como Funciona a Renovação de CLCB no Tucuruvi
              </h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8">
              <h3 className="font-black text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Clock className="w-6 h-6 text-amber-500" /> Prazo de Renovação no Tucuruvi
              </h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-black mb-4">Diagnóstico Gratuito para Renovação de CLCB no Tucuruvi</h2>
              ...
              <ul className="space-y-3 text-slate-300">
                {["Diagnóstico técnico gratuito", "Sem obras desnecessárias", "Engenheiro responsável pelo processo", "Cobertura: Tucuruvi e toda Zona Norte"].map((item) => (
      ...
      <SocialProof
        testimonial={{
          text: "Tenho uma clínica odontológica na Av. Tucuruvi e o Bradesco Saúde pediu o CLCB em uma auditoria. Estava vencido há 9 meses. A DRD2 resolveu em 33 dias sem obras e sem precisar fechar um único dia. Mantive todos os convênios.",
          author: "Dr. Fábio Nascimento",
          role: "Cirurgião-dentista, Av. Tucuruvi — Zona Norte",
        }}
      />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-10 text-center">Perguntas Frequentes — CLCB Tucuruvi</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">Cobertura: Tucuruvi e Região</h2>
          <p className="text-center text-slate-500 mb-8 max-w-2xl mx-auto">
            Além do Tucuruvi, a DRD2 atende renovações de CLCB nos bairros vizinhos da Zona Norte.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {["Santana", "Jaçanã", "Vila Guilherme", "Tremembé", "Vila Medeiros", "Mandaqui", "Água Fria", "Parada Inglesa"].map((bairro) => (
      ...
      <CtaWhatsApp label="CLCB Vencido no Tucuruvi? Fale com um Engenheiro Agora" />
      ...
      <nav aria-label="Breadcrumb" className="py-4 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <li className="text-slate-300">/</li>
            <li className="text-slate-800 font-medium">Tucuruvi</li>
          </ol>
        </div>
      </nav>
    </>
