...
import {
  ...
  Store, HeartPulse, Scissors, Utensils,
} from "lucide-react";
...
const _pageTitle = "Renovação de CLCB na Zona Oeste de São Paulo 2026 | DRD2 Engenharia";
const _pageDesc = "Renovação de CLCB na Zona Oeste de SP para comércio, clínicas, salões e restaurantes. DRD2 Engenharia — diagnóstico gratuito e processo simplificado conforme Decreto 69.118/2024.";

export const metadata = {
  title: _pageTitle,
  description: _pageDesc,
  alternates: {
    canonical: "/renovacao-clcb-zona-oeste-sao-paulo",
  },
};

const faqs = [
  {
    question: "Quais bairros da Zona Oeste a DRD2 atende para renovação de CLCB?",
    answer: "A DRD2 atende todos os bairros da Zona Oeste de São Paulo, incluindo Pinheiros, Vila Madalena, Perdizes, Lapa, Vila Leopoldina, Alto de Pinheiros, Butantã, Morumbi, Vila Sônia, Raposo Tavares, Rio Pequeno e demais regiões da zona.",
  },
  {
    question: "Meu estabelecimento na Zona Oeste tem menos de 200 m² — precisa de CLCB?",
  ...
  {
    question: "Quanto tempo leva a renovação de CLCB na Zona Oeste de SP?",
  ...
  {
    question: "Posso renovar o CLCB sem fechar meu negócio na Zona Oeste?",
  ...
  {
    question: "Qual o custo da renovação de CLCB na Zona Oeste?",
...
const bairrosZonaOeste = [
  "Pinheiros", "Vila Madalena", "Perdizes", "Lapa",
  "Vila Leopoldina", "Alto de Pinheiros", "Butantã", "Morumbi",
  "Vila Sônia", "Raposo Tavares", "Rio Pequeno", "Jaguaré",
  "Pompeia", "Água Branca", "Barra Funda", "Cerqueira César",
  "Sumaré", "Pacaembu", "Vila Ipojuca", "Osasco (divisa)",
];
...
export default function RenovacaoCLCBZonaOestePage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const schema = generateMasterSchema({
    slug: "/renovacao-clcb-zona-oeste-sao-paulo",
    title: _pageTitle,
    description: _pageDesc,
    neighborhood: "Zona Oeste",
    serviceName: "Renovação de CLCB na Zona Oeste de São Paulo",
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB na Zona Oeste de São Paulo — DRD2 Engenharia"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-3 shadow-lg shadow-red-900/20">
              CLCB — ZONA OESTE DE SÃO PAULO — RENOVAÇÃO 2026
            </span>
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — ZONA OESTE SP
              </span>
              <span className="text-2xl md:text-3xl lg:text-4xl italic text-red-500 mt-1 block leading-none">
                CLCB VENCIDO NA ZONA OESTE? DIAGNÓSTICO GRATUITO EM ATÉ 2 HORAS
              </span>
            </h1>
            <p className="text-base md:text-lg text-gray-200 mb-6 leading-relaxed font-medium max-w-2xl border-l-4 border-red-600 pl-6 py-1">
              A DRD2 Engenharia renova o CLCB para comércios, clínicas, salões, restaurantes e demais estabelecimentos da Zona Oeste de São Paulo com processo simplificado e conformidade total com o Decreto Estadual nº 69.118/2024.
            </p>
            <a
              href={whatsappLink}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              <h2 className="text-3xl font-black text-slate-900 uppercase italic tracking-tight">
                Renovação de CLCB na <span className="text-red-600">Zona Oeste de São Paulo</span>
              </h2>
              <p>
                A Zona Oeste de São Paulo reúne alguns dos bairros mais dinâmicos da capital — de Pinheiros e Vila Madalena, com alta concentração de restaurantes, cafés e espaços culturais, até Perdizes, Lapa e Butantã, com forte presença de clínicas, consultórios e comércio de bairro. A maioria desses estabelecimentos se enquadra no processo simplificado de CLCB e precisa do certificado válido para manter o alvará de funcionamento ativo.
              </p>
              <p>
                A DRD2 Engenharia atende toda a Zona Oeste com equipe técnica própria — diagnóstico presencial rápido e processo conduzido do início ao fim pela mesma equipe, sem terceirizações.
              </p>
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  CLCB vencido = alvará em risco. Estabelecimentos da Zona Oeste com CLCB vencido podem ser interditados em qualquer fiscalização de rotina do Corpo de Bombeiros ou da Vigilância Sanitária.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter mb-4">
              Bairros Atendidos na Zona Oeste
            </h2>
            <p className="text-slate-400 font-medium text-lg max-w-2xl mx-auto">
              Atendimento presencial com engenheiro em toda a Zona Oeste de São Paulo.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {bairrosZonaOeste.map((bairro, i) => (
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Estabelecimento na Zona Oeste com CLCB vencido? Fale agora.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="estabelecimento na Zona Oeste"
            variant="primary"
            centered
          />
        </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
              Renovação de CLCB por Tipo de Estabelecimento na Zona Oeste
            </h2>
      ...
      {/* ── POR QUE DRD2 NA ZONA OESTE ── */}
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 na Zona Oeste?
              </h2>
              <div className="space-y-4">
                {[
                  "Equipe técnica própria com cobertura em toda a Zona Oeste",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Building2, l: "Pinheiros e Vila Madalena" },
                { Icon: Store, l: "Perdizes e Pompeia" },
                { Icon: Building2, l: "Lapa e Vila Leopoldina" },
                { Icon: Store, l: "Butantã e Morumbi" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB Zona Oeste SP</span>
          </h2>
          <div className="space-y-4">
            {faqs.map((faq, i) => (
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              { label: "Renovação CLCB Zona Norte", href: "/renovacao-clcb-zona-norte-sao-paulo" },
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-zona-oeste-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-zona-oeste-sao-paulo" />
      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-clcb-zona-oeste-sao-paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight italic">
            Estabelecimento na Zona Oeste com CLCB vencido?
          </h2>
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 atende toda a Zona Oeste — diagnóstico presencial em até 2 horas e renovação sem fechar as portas.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
          ...
          <p className="mt-10 text-sm font-black uppercase tracking-[0.3em] opacity-80 italic">
            Zona Oeste SP — Decreto 69.118/2024 — DRD2 Engenharia
          </p>
        </div>
      </section>
