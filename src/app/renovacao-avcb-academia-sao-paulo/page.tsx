...
import {
  ...
  ShieldX, AlertTriangle, MapPin, Dumbbell, Zap, Activity, Clock
} from "lucide-react";
...
import { renovacaoAvcbAcademiaContent as c } from "@/data/pages/renovacao-avcb-academia-sao-paulo";
...
export default function RenovacaoAVCBAcademiaPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Academia em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Academia", item: "/renovacao-avcb-academia-sao-paulo" },
        ],
      });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                <Phone className="w-6 h-6" /> QUERO RENOVAR DA MINHA ACADEMIA
              </a>
            </div>
          </div>
        </div>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Academia em SP" },
        ]}
        dark
      />
      <TrustBar dark />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-none uppercase tracking-tighter mb-8 italic ">
                Por que o AVCB da Academia{" "}
                <span className="text-red-600 not-italic font-black italic">Vence sem que o Dono Perceba?</span>
              </h2>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              Quais são os Riscos para o Dono da Academia com{" "}
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <CtaWhatsApp
            label="Solicitar diagnóstico para Academia"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Renovação do AVCB da Academia?</span>
            </h2>
      ...
      {/* ── H2 #4: CUIDADO REDOBRADO ── */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic ">
                Academia que Cresceu desde o Último AVCB —{" "}
                <span className="text-red-600 not-italic">Cuidado Redobrado</span>
              </h2>
              <p className="text-lg text-slate-700 leading-relaxed font-medium mb-10" dangerouslySetInnerHTML={{ __html: c.h2_cuidado.intro }} />
              <div className="space-y-6">
                {c.h2_cuidado.cenarios.map((cenario, i) => (
              ...
              <p className="mt-8 text-lg text-slate-900 font-bold border-l-4 border-red-600 pl-5 italic" dangerouslySetInnerHTML={{ __html: c.h2_cuidado.closing }} />
            </div>

            <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden">
               <Dumbbell className="absolute -bottom-10 -right-10 w-64 h-64 text-red-600 opacity-10" />
               <h3 className="font-black text-2xl uppercase italic mb-6 relative z-10">
                Por que a DRD2 Engenharia?
              </h3>
              <p className="text-slate-400 mb-8 relative z-10 leading-relaxed">
                Entendemos que uma academia tem horários de pico e não pode ter aulas paralisadas. Executamos vistorias e adequações em horários alternativos.
              </p>
              <ul className="space-y-4 relative z-10">
                {[
                  "Especialistas em espaços fitness",
                  "Sem impacto nas aulas e alunos",
                  "Diagnóstico completo gratuito",
                  "Projeto técnico e ART inclusos (quando aplicável)"
                ].map((item, i) => (
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Aumentou a capacidade de alunos? Seu AVCB pode estar desatualizado.
          </p>
          <CtaWhatsApp
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">AVCB da sua Academia</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic ">
                Atendemos Renovações de AVCB em Academias em{" "}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">Renovação de AVCB para Academia SP</span>
            </h2>
          </div>
          <div className="space-y-4">
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            Não deixe seu negócio parar por falta de AVCB.
          </p>
      ...
      <OccupationAuthorityBlock
        occupation="Academia"
        currentSlug="/renovacao-avcb-academia-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="Renovação de AVCB para Academias"
      />

      <ServiceClusterLinks currentSlug="/renovacao-avcb-academia-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-academia-sao-paulo" />

      <NeighborhoodSilo currentSlug="/renovacao-avcb-academia-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Renovação de AVCB para Academias em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
