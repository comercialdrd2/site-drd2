...
import {
  ...
  Users, MapPin, ShieldX, Utensils, Zap,
} from "lucide-react";
...
import { avcbRestauranteContent as c } from "@/data/pages/avcb-restaurante-sao-paulo";
...
const sistemaIcons: Record<string, React.ReactNode> = {
  ...
  "Sistema de supressão de incêndio na coifa": <Flame className="w-7 h-7" />,
...
export default function AVCBRestaurantePage() {
  ...
  const _schema = generateMasterSchema({
    ...
    title: c.meta.title,
    description: c.meta.description,
    serviceName: "AVCB para Restaurantes e Bares em São Paulo",
    faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Serviços", item: "/servicos" },
      { name: "AVCB para Restaurantes e Bares em São Paulo", item: "/avcb-restaurante-sao-paulo" },
    ],
  });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[20px] flex items-center bg-slate-950 border-b-8 border-red-600  ">
        <Image
          ...
          alt="Interior de restaurante com sistemas de segurança contra incêndio"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-3 shadow-lg shadow-red-900/20">
              Grupo F — Locais de Reunião de Público — Exigências 2026
            </span>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "AVCB para Restaurantes e Bares em São Paulo" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      {/* ── H2 #2: EXIGÊNCIAS ESPECÍFICAS PARA COZINHA ── */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              Por que o AVCB de Restaurante tem{" "}
              <span className="text-red-600 not-italic">Exigências Específicas para Cozinha?</span>
            </h2>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Corpo de Bombeiros em Restaurantes</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Seu restaurante ou bar tem todos esses sistemas aprovados pelo CBPMESP?
          </p>
          <CtaWhatsApp
      ...
      {/* ── H2 #4: SHOPPING, GALERIA OU IMÓVEL HISTÓRICO ── */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-white mb-8 tracking-tighter uppercase italic">
                Restaurante em{" "}
                <span className="text-red-600 not-italic">Shopping, Galeria ou Imóvel Histórico</span>
              </h2>
              <div className="space-y-6 mt-2">
                {c.h2_especiais.itens.map((item, i) => (
            ...
            <div className="bg-slate-50 rounded-[3rem] border border-slate-200 p-10">
              ...
              {[
                ...
                "Bloqueio na renovação da licença sanitária CVS",
      ...
      {/* ── H2 #5: COMO A DRD2 REGULARIZA ── */}
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-20">
            <span className="text-red-500 font-black uppercase tracking-widest text-xs">Grupo F — Processo Especializado</span>
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter leading-none uppercase italic mt-4">
              Como a DRD2 Regulariza seu{" "}
              <span className="text-red-600 not-italic">Restaurante no Corpo de Bombeiros</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Pronto para regularizar seu restaurante ou bar?
          </p>
          <CtaWhatsApp
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-white mb-8 tracking-tighter uppercase italic">
                Atendemos Restaurantes e Bares em{" "}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">AVCB para Restaurante e Bar SP</span>
            </h2>
          </div>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/avcb-restaurante-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="AVCB para Restaurantes e Bares em SP"
      />

      <ServiceClusterLinks currentSlug="/avcb-restaurante-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-restaurante-sao-paulo" />

      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/avcb-restaurante-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — AVCB para Restaurantes e Bares em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-red-600">AVCB em Restaurante ou Bar São Paulo</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Restaurante ou Bar São Paulo precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-red-600 p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 realiza auditoria documental gratuita antes do protocolo. Identificamos divergencias de área, laudos vencidos e irregularidades antes de submeter o processo ao Corpo de Bombeiros de Restaurante ou Bar São Paulo. Evite exigencias e atrasos.
          </div>
        </div>
      </section>
