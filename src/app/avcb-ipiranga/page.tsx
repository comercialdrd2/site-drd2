...
const _pageTitle = "AVCB em Ipiranga SP | Especialistas na Região da do | DRD2";
const _pageDesc = "Regularização de AVCB e CLCB no Ipiranga. Engenheiros credenciados no CREA para galpões em avenida do estado, condomínio histórico e comércios e estabelecimentos com emissão ágil.";

export const metadata = {
  title: "AVCB em Ipiranga SP | Especialistas na Região da do | DRD2",
  description: "Regularização de AVCB e CLCB no Ipiranga. Engenheiros credenciados no CREA para galpões em avenida do estado, condomínio histórico e comércios e estabelecimentos com emissão ágil.",
  alternates: {
    canonical: "/avcb-ipiranga",
  },
};

export default function IpirangaLandingPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Edifícios sem escada enclausurada reprovam em SP?",
      answer: "O projeto precisa mapear escapes por sacadas interligadas (escada marinheiro frontal e dutos ou pressões neutras das aprovações antigas com FAT legalizado via Engenheiro especialista DRD2)."
    },
    {
      question: "Qual o prazo para obter o AVCB em Ipiranga?",
    ...
    {
      question: "Meu imóvel em Ipiranga precisa de AVCB completo ou CLCB simplificado?",
    ...
    {
      question: "O AVCB vencido impede a renovacao do alvará de funcionamento em Ipiranga?",
    ...
    {
      question: "Qual a documentação para iniciar o AVCB em Ipiranga?",
  ...
  const services = [
    { 
      name: "Gestão Atacadistas Av. Estado", 
      desc: "Estudos pautados nas renovações e adequações imediatas nas áreas atacadistas vitais na ZS.",
      icon: Building2,
      slug: "service"
    },
    { 
      name: "Museus e Museologia (Casarões)", 
      desc: "Engenharia especial zelando e impedindo tragédias históricas museológicas através controle preventivo a curtos-circuitos antigos (SPDA validado contínuo e Detectores automáticos).",
      icon: Building2,
      slug: "service"
    }
  ];
  ...
  const _schema = generateMasterSchema({
        ...
        breadcrumbs: [
          ...
          { name: "Ipiranga", item: "/avcb-ipiranga" }
        ]
      });
    ...
    <>
      ...
      <section className="relative bg-slate-950 text-white min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center overflow-hidden border-b-8 border-primary  italic">
        <Image
          ...
          alt="Bairro de Ipiranga e Rua dos Ipiranga - Regularização AVCB Master"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8 text-left">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-3/5">
              <span className="inline-block bg-primary text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 border border-white/10 leading-none shadow-xl tracking-tighter shadow-primary/20">Avenida do Estado, História e Comércio e Transportes</span>
              <h1 className="text-3xl md:text-[5.5rem] font-black mb-4 leading-[0.8] tracking-tighter uppercase italic text-white flex flex-col">
                <span className="text-white">AVCB NO(A) <br/> <span className="text-primary not-italic tracking-tighter uppercase font-black">IPIRANGA</span></span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-5 mb-12">
                ...
                >
                  <Phone className="w-8 h-8" /> Falar com engenheiro especialista em Ipiranga
                </a>
              </div>
            </div>
            ...
            <div className="lg:w-2/5">
                <div className="bg-white p-8 rounded-[4rem] shadow-4xl relative overflow-hidden text-slate-900 border-t-8 border-primary italic">
                  ...
                  <h3 className="text-2xl font-black text-secondary mb-4 flex items-center gap-3 italic uppercase text-center justify-center underline decoration-primary/10">
                    Diagnóstico <span className="text-primary not-italic uppercase tracking-tighter font-black">Ipiranga</span>
                  </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <div className="inline-flex items-center gap-2 text-primary font-black text-xs uppercase tracking-widest leading-none">
                <BadgeInfo className="w-4 h-4" /> Avenida do Estado, História e Comércio e Transportes
              </div>
              <h2 className="text-4xl md:text-[5.5rem] font-black text-secondary leading-[0.85] tracking-tighter uppercase italic underline decoration-primary/20 decoration-8 underline-offset-16 text-left font-black">
                AUTORIDADE <br /> TÉCNICA EM <br /> <span className="text-primary not-italic tracking-tighter uppercase font-black tracking-tighter">IPIRANGA</span>
              </h2>
              <p className="text-xl text-gray-500 font-bold leading-relaxed uppercase tracking-tight text-balance border-l-8 border-primary/20 pl-8 text-left font-black">
                A região da Ipiranga exige engenharia de precisão com foco em galpões em avenida do estado, condomínio histórico e comércios. A regularização do AVCB no CBPMESP precisa seguir rigorosamente as normas 2025 do Decreto Estadual, cobrindo com assertividade tudo o que prefeituras e órgãos exigem dos empreendimentos no eixo da  Avenida do Estado.
              </p>
            ...
            <div className="relative">
              <div className="bg-slate-900 rounded-[4rem] p-12 md:p-14 text-white relative overflow-hidden shadow-2xl group hover:shadow-primary/20 transition-all border-b-12 border-primary italic text-left shadow-primary/10">
                ...
                <div className="space-y-8 text-xs text-gray-400 font-black leading-relaxed uppercase tracking-widest text-left font-black">
                  <p>Operar bares e casas noturnas em Ipiranga sem o cálculo exato de saídas de emergência e lotação é um risco jurídico imenso. Regularizamos seu estabelecimento focando na segurança dos clientes e na validade do seu alvará.</p>
                ...
                <div className="mt-10 p-8 bg-white/5 border border-white/10 rounded-[2rem] italic text-[11px] text-gray-400 font-black uppercase tracking-[0.3em] leading-relaxed text-center shadow-inner font-black shadow-primary/10">
                   "A inteligência técnica nos restaurantes e coberturas de Ipiranga."
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-6xl text-center">
           <div className="text-center mb-20 underline decoration-primary decoration-4 underline-offset-16">
              ...
              <p className="text-gray-400 font-black uppercase tracking-[0.4em] text-[10px] italic text-center font-black">Expertise em Gastronomia e Corporativo: Ipiranga SP</p>
           </div>
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Precisa de AVCB em Ipiranga? Fale agora com um engenheiro especialista.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="imóvel em Ipiranga"
            variant="primary"
            centered
          />
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="text-4xl md:text-[6rem] font-black uppercase italic tracking-tighter mb-10 leading-[0.8] underline decoration-primary decoration-8 underline-offset-16 font-black font-black">
                  PRESENÇA <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black">IPIRANGA SP</span>
                </h2>
      ...
      <SocialProof
        testimonial={{
          text: "A DRD2 regularizou nosso estabelecimento em Ipiranga com agilidade e sem burocracia. AVCB aprovado sem nenhuma pendência. Recomendo a todos os empresários da região.",
          author: "Cliente DRD2 Engenharia",
          role: "Empresário — Ipiranga, São Paulo",
        }}
      />
      ...
      <section className="py-24 bg-white border-t border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="text-center mb-16 underline decoration-primary decoration-4 underline-offset-16">
             <h2 className="text-4xl font-black text-secondary uppercase italic tracking-tighter text-center font-black tracking-tighter">Dúvidas <span className="text-primary not-italic text-sm font-bold tracking-tighter text-center font-black">IPIRANGA</span></h2>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-slate-300 text-xl font-black uppercase italic tracking-tight mb-2">
            Não arrisque seu CNPJ em Ipiranga.
          </p>
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-200 text-center relative overflow-hidden italic shadow-inner">
        <div className="container mx-auto px-4 max-w-6xl text-center">
            <h2 className="text-4xl md:text-[8rem] font-black text-secondary leading-[0.75] uppercase tracking-tighter mb-12 italic underline decoration-primary decoration-8 underline-offset-[2rem] text-center font-black font-black">
              Ipiranga Seguro <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black font-black">EFICIÊNCIA MASTER</span>
            </h2>
      ...
      <section className="py-24 bg-white border-t border-slate-100 text-slate-700 italic border-b-4 border-primary font-bold">
        <div className="container mx-auto px-4 max-w-4xl prose prose-slate font-black uppercase text-[11px] tracking-tight leading-relaxed text-left">
          <h2 className="text-3xl font-black text-secondary uppercase tracking-tighter italic mb-10 border-l-12 border-primary pl-10 leading-none underline decoration-primary/5 text-left font-black tracking-tighter font-black">Aprovação de AVCB Master na região de Ipiranga</h2>
          <p className="text-left font-black">Ipiranga consolidou-se como o coração pulsante da gastronomia e do entretenimento noturno em São Paulo, exercendo um papel de vanguarda cultural e econômica. Com a maior densidade de novos estabelecimentos comerciais da Zona Oeste, a regularização do AVCB (Auto de Vistoria do Corpo de Bombeiros) é uma demanda fundamental para garantir a segurança física dos frequentadores e a validade jurídica das licenças de funcionamento.</p>
          <p className="text-left font-black">A DRD2 Engenharia fornece consultoria técnica master em Ipiranga, assegurando que proprietários de bares, restaurantes premiados e síndicos de condomínios de alto padrão tenham acesso à melhor documentação técnica do mercado, com processos ágeis junto ao CBPMESP e suporte total em todas as etapas de conformidade com o Decreto Estadual nº 69.118/2024.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-primary">AVCB em Ipiranga</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Ipiranga precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-primary p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 faz auditoria documental gratuita antes de qualquer protocolo em Ipiranga. Evite exigencias, rejeicoes e atrasos identificando documentos pendentes antes de submeter ao CBPMESP.
          </div>
        </div>
      </section>
      ...
      <NeighborhoodAuthorityBlock
        neighborhood="Ipiranga"
        zone="Zona Leste"
        currentSlug="/avcb-ipiranga"
      />



      <ServiceClusterLinks currentSlug="/avcb-ipiranga" />
      <ServiceBlogLinks currentSlug="/avcb-ipiranga" />


      <OccupationDepthBlock
        occupation="/Avcb Ipiranga"
        currentSlug="/avcb-ipiranga"
      />
      ...
      <InternalLinksBlock
        ...
        mode="bairro"
        maxLinks={6}
        titulo="Serviços de AVCB em Ipiranga"
      />
</>
  );
}
