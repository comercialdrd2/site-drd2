    ...
    <>
      <JsonLD schema={{
        ...
        "@graph": [
          {
            "@type": "Article",
            "@id": "https://www.drd2.com.br/blog/quem-paga-o-avcb-proprietario-ou-inquilino/#article",
            "headline": "Quem Paga o AVCB: Proprietário ou Inquilino? Guia Definitivo",
            "description": _pageDesc,
            "image": "https://www.drd2.com.br/images/blog/fire_safety_equipment_premium.webp",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.drd2.com.br/blog/quem-paga-o-avcb-proprietario-ou-inquilino"
            }
          }
        ]
      }} />
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-200 text-center relative overflow-hidden italic shadow-inner">
        <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="mt-24 pt-24 border-t border-slate-200 flex flex-wrap justify-center gap-12 text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] italic leading-none">
               ...
               <Link href="/avcb-vencido-o-que-fazer" className="hover:text-primary transition-colors underline decoration-primary/10 tracking-[0.5em]">→ AVCB VENCIDO</Link>
