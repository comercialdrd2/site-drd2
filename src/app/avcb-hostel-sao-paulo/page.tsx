...
import {
  ...
  Wind, Layers, Users, MapPin, Globe,
} from "lucide-react";
...
import { avcbHostelContent as c } from "@/data/pages/avcb-hostel-sao-paulo";
...
export default function AVCBHostelPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "AVCB para Hostel em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "AVCB para Hostel em São Paulo", item: "/avcb-hostel-sao-paulo" },
        ],
      });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[20px] flex items-center bg-slate-950 border-b-8 border-red-600  ">
        <Image
          ...
          alt="Alvará do Bombeiro para Hostel"
          fill
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "AVCB para Hostel em São Paulo" },
        ]}
        dark
      />
      <TrustBar dark />

      {/* ── H2 #1: HOSTEL PRECISA DE AVCB? ── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              ...
              <div className="space-y-5 text-lg text-slate-700 leading-relaxed font-medium">
                ...
                <p className="font-bold text-slate-900" dangerouslySetInnerHTML={{ __html: c.h2_precisaDeAvcb.intro_lista }} />
                ...
                <div className="bg-slate-950 p-10 rounded-[2.5rem] text-white mt-10 shadow-2xl border-l-8 border-red-600">
                  <p className="text-slate-200 font-bold leading-relaxed italic" dangerouslySetInnerHTML={{ __html: c.h2_precisaDeAvcb.closing }} />
                </div>
              </div>
            </div>
      ...
      {/* ── H2 #2: PARTICULARIDADES TÉCNICAS ── */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              Por que o AVCB de Hostel tem{" "}
              <span className="text-red-600 not-italic">Particularidades Técnicas?</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium" dangerouslySetInnerHTML={{ __html: c.h2_particularidades.intro }} />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {c.h2_particularidades.itens.map((item, i) => (
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Corpo de Bombeiros em Hostels</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Seu hostel tem todos esses sistemas aprovados pelo CBPMESP?
          </p>
          <CtaWhatsApp
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-white mb-8 tracking-tighter uppercase italic">
                ...
                <span className="text-red-600 not-italic">Hostelworld e Booking</span>
              </h2>
              <p className="text-lg text-slate-700 leading-relaxed font-medium mb-8" dangerouslySetInnerHTML={{ __html: c.h2_plataformas.intro }} />
              <div className="space-y-4">
                {c.h2_plataformas.plataformas.map((plat, i) => (
                  <div key={i} className="flex items-start gap-4 bg-slate-50 rounded-2xl p-6 border border-slate-200">
                    <Globe className="w-6 h-6 text-amber-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-slate-950 rounded-[3rem] p-10 text-white">
              <div className="flex items-center gap-4 mb-8">
                <Globe className="w-10 h-10 text-red-600 flex-shrink-0" />
                <p className="font-black text-xl uppercase italic">Plataformas que exigem AVCB</p>
              </div>
              {["Hostelworld", "Booking.com", "Airbnb (comercial)", "HostelsClub", "Gomio", "Tripadvisor"].map((plat, i) => (
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter leading-none uppercase italic mt-4">
              ...
              <span className="text-red-600 not-italic">AVCB para Hostel em SP</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Pronto para regularizar seu hostel?
          </p>
          <CtaWhatsApp
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-slate-950 rounded-[3rem] p-10 text-white">
              <div className="flex items-center gap-4 mb-8">
                ...
                <p className="font-black text-xl uppercase italic">Bairros Atendidos</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-red-600 flex-shrink-0" />
                    <span className="text-gray-200 font-medium text-sm">{bairro}</span>
                  </div>
                ))}
              </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">AVCB para Hostel SP</span>
            </h2>
          </div>
          <div className="space-y-4">
      ...
      <OccupationAuthorityBlock
        occupation="Hostel"
        currentSlug="/avcb-hostel-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/avcb-hostel-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-hostel-sao-paulo" />

      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/avcb-hostel-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — AVCB para Hostels em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-red-600">AVCB em Hostel São Paulo</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Hostel São Paulo precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-red-600 p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 realiza auditoria documental gratuita antes do protocolo. Identificamos divergencias de área, laudos vencidos e irregularidades antes de submeter o processo ao Corpo de Bombeiros de Hostel São Paulo. Evite exigencias e atrasos.
          </div>
        </div>
      </section>
