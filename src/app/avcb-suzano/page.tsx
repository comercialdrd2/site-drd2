...
const pageData: UniversalPageData = {
  slug: "/avcb-suzano",
  meta: {
    title: "Regularização de AVCB em Suzano SP | DRD2 Engenharia",
    description: "Regularização e projeto de AVCB e CLCB em Suzano. Adequação para indústrias, galpões, condomínios e comércio no Alto Tietê. Sem burocracia e com aprovação garantida.",
  },
  eyebrow: "Regularização AVCB - Suzano",
  h1Line1: "Regularização de AVCB",
  h1Line2: "em Suzano",
  heroBg: "/images/blog/blog_hero_mooca_industrial_avcb.png",
  introP1: "A DRD2 Engenharia oferece serviços especializados de regularização de AVCB (Auto de Vistoria do Corpo de Bombeiros) para indústrias, condomínios, centros logísticos e comércio em Suzano e região do Alto Tietê.",
  ...
  h2_principal: {
    heading: "Sua Edificação em Suzano Está Regularizada?",
    body: "Muitos galpões industriais e condomínios na região de Suzano operam com AVCB vencido ou sequer possuem o documento, expondo-se a riscos graves. O Corpo de Bombeiros fiscaliza intensamente o Alto Tietê devido à alta concentração industrial e logística.",
  ...
  h2_riscos: {
    heading: "Riscos da Falta do AVCB em Suzano",
    intro: "Empresas sem AVCB sofrem penalidades severas que travam os negócios na região do Alto Tietê.",
    itens: [
      {
        titulo: "Interdição",
        desc: "O Corpo de Bombeiros e a Prefeitura de Suzano podem interditar totalmente a operação do estabelecimento.",
      },
      {
  ...
  h2_processo: {
    heading: "Processo de Regularização em Suzano",
    etapas: [
      { numero: "01", titulo: "Vistoria Técnica", desc: "Analisamos sua planta em Suzano e os sistemas de incêndio." },
  ...
  h2_detalhes: {
    ...
    itens: [
      { titulo: "Cálculo Hidráulico", desc: "Dimensionamos hidrantes e sprinklers para o risco exato do seu negócio em Suzano." },
  ...
  h2_quando: {
    heading: "Qual o Prazo para o AVCB em Suzano?",
  ...
  h2_escolher: {
    heading: "Por que escolher a DRD2 em Suzano?",
  ...
  h2_cobertura: {
    ...
    body1: "Atendemos Suzano, Itaquaquecetuba, Arujá, Ferraz de Vasconcelos, Biritiba Mirim, Guararema e região.",
