...
const _slug = "/renovacao-clcb-saude-sao-paulo";
const _pageTitle = "Renovação de CLCB na Saúde SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB na Saúde com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Av. Jabaquara, Rua Domingos de Morais, Praça da Árvore e toda a região. DRD2 Engenharia.";
...
export default function RenovacaoClcbSaudePage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido na Saúde?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Na Saúde, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB na Saúde exige obras?",
    ...
    {
      question: "Tenho uma clínica ou restaurante na Saúde com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. O bairro da Saúde tem alta concentração de clínicas e consultórios próximos à Vila Mariana e ao metrô Ana Rosa — e planos de saúde realizam auditorias periódicas que exigem o CLCB válido para manter o credenciamento.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel na Saúde precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — clínicas, consultórios, comércio, restaurantes, salões, farmácias. AVCB é exigido para imóveis maiores ou de risco elevado. A DRD2 define qual certificado se aplica no diagnóstico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB na Saúde?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente na Saúde, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Jabaquara, Vila Mariana, Mirandópolis, Ipiranga e Cursino.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB na Saúde" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido na Saúde — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB na Saúde:<br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-3xl leading-relaxed">
              O bairro da Saúde concentra clínicas, consultórios e comércio de bairro entre
              Vila Mariana e Jabaquara. CLCB vencido suspende credenciamentos em planos de saúde
              e expõe o imóvel à interdição pelo CBPMESP.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
                ...
                <RefreshCw className="w-5 h-5" /> Renovar CLCB na Saúde
              </a>
              <a href="#diagnostico"
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-2"><Map className="w-4 h-4 text-blue-400" /> Saúde · Vila Mariana · Jabaquara</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4">
            Quem Precisa de Renovação de CLCB na Saúde?
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            O bairro da Saúde é um polo residencial e de serviços de saúde entre Vila Mariana
            e Jabaquara, com forte comércio local na Av. Jabaquara e na Rua Domingos de Morais.
            A Praça da Árvore e o entorno do metrô Ana Rosa concentram clínicas, consultórios,
            farmácias e serviços que precisam do CLCB em dia para operar.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Estabelecimentos que mais renovam na Saúde</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Clínicas médicas, odontológicas e de exames na Av. Jabaquara</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Consultórios de fisioterapia, psicologia e nutrição</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Farmácias e drogarias no corredor comercial</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Restaurantes e padarias na Rua Domingos de Morais</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Academias e studios de pilates próximos à Praça da Árvore</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Salões de beleza e serviços de bairro consolidados</li>
              </ul>
            </div>
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Por que a Saúde exige atenção com o CLCB?</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Alta concentração de clínicas atrai auditorias frequentes de planos de saúde que exigem CLCB válido</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Metrô Ana Rosa e corredor Jabaquara mantêm fiscalização ativa de toda a subprefeitura</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Comércio consolidado com imóveis antigos tem instalações que o CBPMESP acompanha de perto</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Renovações de contrato em imóveis valorizados exigem documentação completa incluindo CLCB</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">
            O Que Acontece com CLCB Vencido na Saúde?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              { icon: FileCheck, title: "Rescisão Contratual", desc: "Proprietários de imóveis na Saúde podem rescindir a locação por descumprimento das exigências legais." },
            ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Map, title: "Abertura de novo ponto", desc: "Clínica, farmácia ou comércio na Saúde precisa de CLCB antes de iniciar atividades." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8">
                Como Funciona a Renovação de CLCB na Saúde
              </h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8">
              <h3 className="font-black text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Clock className="w-6 h-6 text-amber-500" /> Prazo de Renovação na Saúde
              </h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-black mb-4">Diagnóstico Gratuito para Renovação de CLCB na Saúde</h2>
              ...
              <ul className="space-y-3 text-slate-300">
                {["Diagnóstico técnico gratuito", "Sem obras desnecessárias", "Engenheiro responsável pelo processo", "Cobertura: Saúde e toda Zona Sul"].map((item) => (
      ...
      <SocialProof
        testimonial={{
          text: "Sou nutricionista e tenho consultório na Rua Domingos de Morais. O plano de saúde me enviou e-mail pedindo o CLCB atualizado em uma auditoria. Estava vencido há 11 meses. A DRD2 resolveu em 28 dias sem obras — mantive todos os convênios sem interrupção.",
          author: "Ana Luiza Pereira",
          role: "Nutricionista, Saúde — São Paulo",
        }}
      />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-10 text-center">Perguntas Frequentes — CLCB Saúde</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">Cobertura: Saúde e Região</h2>
          <p className="text-center text-slate-500 mb-8 max-w-2xl mx-auto">
            Além da Saúde, a DRD2 atende renovações de CLCB nos bairros vizinhos da Zona Sul.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {["Jabaquara", "Vila Mariana", "Mirandópolis", "Ipiranga", "Cursino", "Sacomã", "Moema", "Paraíso"].map((bairro) => (
      ...
      <CtaWhatsApp label="CLCB Vencido na Saúde? Fale com um Engenheiro Agora" />
      ...
      <nav aria-label="Breadcrumb" className="py-4 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <li className="text-slate-300">/</li>
            <li className="text-slate-800 font-medium">Saúde</li>
          </ol>
        </div>
      </nav>
    </>
