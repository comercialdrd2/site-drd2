  ...
  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-avcb-salao-de-festas-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Salões de Festas em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Salões de Festas", item: "/renovacao-avcb-salao-de-festas-sao-paulo" },
        ],
      })} />
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Salões de Festas" },
        ]}
        dark
      />
      <TrustBar dark />
