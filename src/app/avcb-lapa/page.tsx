...
const _pageTitle = "AVCB em Lapa SP | Especialistas na Região da Doze | DRD2";
const _pageDesc = "Regularização de AVCB e CLCB no Lapa. Engenheiros credenciados no CREA para mercados, condomínios residenciais e estabelecimentos comerciais e estabelecimentos com emissão ágil.";

export const metadata = {
  title: "AVCB em Lapa SP | Especialistas na Região da Doze | DRD2",
  description: "Regularização de AVCB e CLCB no Lapa. Engenheiros credenciados no CREA para mercados, condomínios residenciais e estabelecimentos comerciais e estabelecimentos com emissão ágil.",
  alternates: {
    canonical: "/avcb-lapa",
  },
};

export default function LapaLandingPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Os mercados livres na rua 12 de Outubro são isentos do bombeiro?",
      answer: "Lojas instaladas nas ruas com fachadas frontais precisam (com exceção de quiosques de via de passeio que não possuam edificações com parede física em lajes)."
    },
    {
      question: "Qual o prazo para obter o AVCB em Lapa?",
    ...
    {
      question: "Meu imóvel em Lapa precisa de AVCB completo ou CLCB simplificado?",
    ...
    {
      question: "O AVCB vencido impede a renovacao do alvará de funcionamento em Lapa?",
    ...
    {
      question: "Qual a documentação para iniciar o AVCB em Lapa?",
  ...
  const services = [
    { 
      name: "Varejo Centro Lapa", 
      desc: "Assessoramento jurídico das adaptações aos lojistas antiquados para viabilizarem o seu alvará e passarem nas fiscalizações do PSI.",
      icon: Building2,
      slug: "service"
    },
    { 
      name: "Condomínios Retrofit das linhas férreas", 
      desc: "Suporte completo as manutenções das Torres com base nas diretrizes das legislações.",
      icon: Building2,
      slug: "service"
    }
  ];
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-gray-900 border-b-4 border-red-600">
        <Image
          ...
          alt="Bairro de Lapa e Rua dos Lapa - Regularização AVCB Master"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
                          <span className="inline-block bg-primary text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 border border-white/10 leading-none shadow-xl tracking-tighter shadow-primary/20">Distrito Histórico Misto e Mercados</span>
              <h1 className="text-3xl md:text-[5.5rem] font-black mb-4 leading-[0.8] tracking-tighter uppercase italic text-white flex flex-col">
                <span className="text-white">AVCB NO(A) <br/> <span className="text-primary not-italic tracking-tighter uppercase font-black">LAPA</span></span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-5 mb-12">
                ...
                >
                  <Phone className="w-8 h-8" /> Falar com engenheiro especialista em Lapa
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <div className="inline-flex items-center gap-2 text-primary font-black text-xs uppercase tracking-widest leading-none">
                <BadgeInfo className="w-4 h-4" /> Distrito Histórico Misto e Mercados
              </div>
              <h2 className="text-4xl md:text-[5.5rem] font-black text-secondary leading-[0.85] tracking-tighter uppercase italic underline decoration-primary/20 decoration-8 underline-offset-16 text-left font-black">
                AUTORIDADE <br /> TÉCNICA EM <br /> <span className="text-primary not-italic tracking-tighter uppercase font-black tracking-tighter">LAPA</span>
              </h2>
              <p className="text-xl text-gray-500 font-bold leading-relaxed uppercase tracking-tight text-balance border-l-8 border-primary/20 pl-8 text-left font-black">
                A região da Lapa exige engenharia de precisão com foco em mercados, condomínios residenciais e estabelecimentos comerciais. A regularização do AVCB no CBPMESP precisa seguir rigorosamente as normas 2025 do Decreto Estadual, cobrindo com assertividade tudo o que prefeituras e órgãos exigem dos empreendimentos no eixo da  Rua Doze de Outubro.
              </p>
            ...
            <div className="relative">
              <div className="bg-slate-900 rounded-[4rem] p-12 md:p-14 text-white relative overflow-hidden shadow-2xl group hover:shadow-primary/20 transition-all border-b-12 border-primary italic text-left shadow-primary/10">
                ...
                <div className="space-y-8 text-xs text-gray-400 font-black leading-relaxed uppercase tracking-widest text-left font-black">
                  <p>Operar bares e casas noturnas em Lapa sem o cálculo exato de saídas de emergência e lotação é um risco jurídico imenso. Regularizamos seu estabelecimento focando na segurança dos clientes e na validade do seu alvará.</p>
                ...
                <div className="mt-10 p-8 bg-white/5 border border-white/10 rounded-[2rem] italic text-[11px] text-gray-400 font-black uppercase tracking-[0.3em] leading-relaxed text-center shadow-inner font-black shadow-primary/10">
                   "A inteligência técnica nos restaurantes e coberturas de Lapa."
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-6xl text-center">
           <div className="text-center mb-20 underline decoration-primary decoration-4 underline-offset-16">
              ...
              <p className="text-gray-400 font-black uppercase tracking-[0.4em] text-[10px] italic text-center font-black">Expertise em Gastronomia e Corporativo: Lapa SP</p>
           </div>
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Precisa de AVCB em Lapa? Fale agora com um engenheiro especialista.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="imóvel em Lapa"
            variant="primary"
            centered
          />
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="text-4xl md:text-[6rem] font-black uppercase italic tracking-tighter mb-10 leading-[0.8] underline decoration-primary decoration-8 underline-offset-16 font-black font-black">
                  PRESENÇA <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black">LAPA SP</span>
                </h2>
      ...
      <SocialProof
        testimonial={{
          text: "A DRD2 regularizou nosso estabelecimento em Lapa com agilidade e sem burocracia. AVCB aprovado sem nenhuma pendência. Recomendo a todos os empresários da região.",
          author: "Cliente DRD2 Engenharia",
          role: "Empresário — Lapa, São Paulo",
        }}
      />
      ...
      <section className="py-24 bg-white border-t border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="text-center mb-16 underline decoration-primary decoration-4 underline-offset-16">
             <h2 className="text-4xl font-black text-secondary uppercase italic tracking-tighter text-center font-black tracking-tighter">Dúvidas <span className="text-primary not-italic text-sm font-bold tracking-tighter text-center font-black">LAPA</span></h2>
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-200 text-center relative overflow-hidden italic shadow-inner">
        <div className="container mx-auto px-4 max-w-6xl text-center">
            <h2 className="text-4xl md:text-[8rem] font-black text-secondary leading-[0.75] uppercase tracking-tighter mb-12 italic underline decoration-primary decoration-8 underline-offset-[2rem] text-center font-black font-black">
              Lapa Seguro <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black font-black">EFICIÊNCIA MASTER</span>
            </h2>
      ...
      <section className="py-24 bg-white border-t border-slate-100 text-slate-700 italic border-b-4 border-primary font-bold">
        <div className="container mx-auto px-4 max-w-4xl prose prose-slate font-black uppercase text-[11px] tracking-tight leading-relaxed text-left">
          <h2 className="text-3xl font-black text-secondary uppercase tracking-tighter italic mb-10 border-l-12 border-primary pl-10 leading-none underline decoration-primary/5 text-left font-black tracking-tighter font-black">Aprovação de AVCB Master na região de Lapa</h2>
          <p className="text-left font-black">Lapa consolidou-se como o coração pulsante da gastronomia e do entretenimento noturno em São Paulo, exercendo um papel de vanguarda cultural e econômica. Com a maior densidade de novos estabelecimentos comerciais da Zona Oeste, a regularização do AVCB (Auto de Vistoria do Corpo de Bombeiros) é uma demanda fundamental para garantir a segurança física dos frequentadores e a validade jurídica das licenças de funcionamento.</p>
          <p className="text-left font-black">A DRD2 Engenharia fornece consultoria técnica master em Lapa, assegurando que proprietários de bares, restaurantes premiados e síndicos de condomínios de alto padrão tenham acesso à melhor documentação técnica do mercado, com processos ágeis junto ao CBPMESP e suporte total em todas as etapas de conformidade com o Decreto Estadual nº 69.118/2024.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-primary">AVCB em Lapa</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Lapa precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-primary p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 faz auditoria documental gratuita antes de qualquer protocolo em Lapa. Evite exigencias, rejeicoes e atrasos identificando documentos pendentes antes de submeter ao CBPMESP.
          </div>
        </div>
      </section>
      ...
      <NeighborhoodAuthorityBlock
        neighborhood="Lapa"
        zone="Zona Oeste"
        currentSlug="/avcb-lapa"
      />



      <OccupationDepthBlock
        occupation="/Avcb Lapa"
        currentSlug="/avcb-lapa"
      />
      ...
      <InternalLinksBlock
        ...
        mode="bairro"
        maxLinks={6}
        titulo="Serviços de AVCB em Lapa"
      />
      <LeadForm />

      <ServiceClusterLinks currentSlug="/avcb-lapa" />
      <ServiceBlogLinks currentSlug="/avcb-lapa" />

      <NeighborhoodSilo currentSlug="/avcb-lapa" />
    </>
  );
}
