...
import {
  ...
  ShieldX, AlertTriangle, MapPin, Church, Activity, Zap, Info,
  History, Users
} from "lucide-react";
...
export default function RenovacaoAVCBIgrejaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const _schema = generateMasterSchema({
        slug: "/renovacao-avcb-igreja-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Igreja em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Igreja", item: "/renovacao-avcb-igreja-sao-paulo" },
        ],
      });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de AVCB para Igreja em São Paulo"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-3 shadow-lg shadow-red-900/20">
              Setor Religioso — Renovação 2026
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-4xl font-black mb-2 leading-[0.9] tracking-tighter uppercase italic text-white flex flex-col">
              ...
              <span className="text-red-600 not-italic text-2xl md:text-3xl lg:text-4xl mt-2 block drop-shadow-2xl text-wrap">
                PARA IGREJA EM SP — PROTEJA SEUS FIÉIS E SUA CONGREGAÇÃO
              </span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Igreja em SP" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 font-bold text-slate-900 uppercase italic tracking-tight">Situações que complicam a renovação de igrejas:</p>
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            AVCB da igreja vencido? Fale agora com um engenheiro pelo WhatsApp e receba o diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico para Igreja"
      ...
      {/* ── H2 #4: IMÓVEL HISTÓRICO ── */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 tracking-tighter uppercase italic leading-none text-center" dangerouslySetInnerHTML={{ __html: c.h2_tombado.heading }} />
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                    <p className="text-lg text-slate-700 leading-relaxed font-medium mb-10 italic" dangerouslySetInnerHTML={{ __html: c.h2_tombado.body1 }} />
                    <div className="space-y-6">
                        {c.h2_tombado.itens.map((item, i) => (
                ...
                <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden h-full">
                    <Church className="absolute -bottom-10 -right-10 w-64 h-64 text-red-600 opacity-10" />
                    <h2 className="font-black text-2xl uppercase italic mb-6 relative z-10 text-red-500 leading-tight" dangerouslySetInnerHTML={{ __html: c.h2_salaoEventos.heading }} />
                    <p className="text-slate-400 mb-8 relative z-10 leading-relaxed italic" dangerouslySetInnerHTML={{ __html: c.h2_salaoEventos.intro }} />
                    <div className="space-y-6 relative z-10">
                        {c.h2_salaoEventos.itens.map((item, i) => (
                    ...
                    <p className="mt-10 font-bold text-white text-sm bg-red-600/20 p-4 rounded-xl border border-red-600/30 italic" dangerouslySetInnerHTML={{ __html: c.h2_salaoEventos.closing }} />
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            A segurança dos seus fiéis não pode esperar.
          </p>
          <p className="text-xl text-slate-300 font-medium mb-10 italic">
            Fale com um engenheiro e receba seu diagnóstico gratuito hoje para sua Igreja.
          </p>
          <CtaWhatsApp
      ...
      <OccupationAuthorityBlock
        occupation="Igreja"
        currentSlug="/renovacao-avcb-igreja-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="Renovação de AVCB para Igrejas"
      />

      <ServiceClusterLinks currentSlug="/renovacao-avcb-igreja-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-igreja-sao-paulo" />

      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-avcb-igreja-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Especialista em Renovação de AVCB para Igrejas e Templos em SP
          </p>
        </div>
      </section>
