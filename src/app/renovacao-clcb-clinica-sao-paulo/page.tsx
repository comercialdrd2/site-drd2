...
import {
  ...
  ShieldX, Heart, Stethoscope, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbClinicaContent as c } from "@/data/pages/renovacao-clcb-clinica-sao-paulo";
...
export default function RenovacaoCLCBClinicaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-clinica-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Clínica Médica em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Clínica Médica", item: "/renovacao-clcb-clinica-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Clínica Médica em São Paulo — DRD2 Engenharia"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — CLÍNICA MÉDICA
              </span>
              <span className="text-2xl md:text-3xl lg:text-4xl italic text-red-500 mt-1 block leading-none">
                CLCB VENCIDO? PACIENTES EM RISCO E PLANO PODE SUSPENDER CREDENCIAMENTO
              </span>
            </h1>
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  Clínicas com oxigênio medicinal têm risco de incêndio elevado — o oxigênio é comburente e acelera qualquer combustão. CLCB vencido em estabelecimento de saúde representa risco direto para pacientes e responsabilidade grave da direção em caso de sinistro.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            CLCB da sua clínica vencido? Fale agora e receba diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="clínica médica em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 para a sua clínica?
              </h2>
              <div className="space-y-4">
                {[
                  "Especialistas em CLCB para clínicas médicas",
                  "Avaliação de extintores adequados por tipo de sala",
                  "Sinalização de área com gases medicinais incluída",
                  "Diagnóstico técnico gratuito sem surpresas",
                  "Documentação completa para ANS e seguradoras",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Heart, l: "Clínicas Médicas Gerais" },
                { Icon: Stethoscope, l: "Clínicas de Especialidades" },
                { Icon: Heart, l: "Centros de Diagnóstico" },
                { Icon: Stethoscope, l: "Laboratórios de Análises" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Clínica Médica</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-clinica-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-clinica-sao-paulo" />
      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-clcb-clinica-sao-paulo" />

      <OccupationAuthorityBlock occupation="Clínica Médica" currentSlug="/renovacao-clcb-clinica-sao-paulo" />
      <OccupationDepthBlock occupation="Clínica Médica" currentSlug="/renovacao-clcb-clinica-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-clinica-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Clínica Médica em São Paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight italic">
            CLCB da sua clínica vencido ou próximo do vencimento?
          </h2>
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 renova sem afetar o atendimento — com documentação completa para ANS, seguradoras e órgãos sanitários.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
