...
{/* Documentacao Necessaria */}
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-red-600">AVCB em Escritorio</span></h2>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/avcb-para-escritorio-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/avcb-para-escritorio-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-para-escritorio-sao-paulo" />
