...
const faqs = [
  ...
  { q: "Posso ser multado se o AVCB do meu prédio em Saúde estiver vencido?", a: "Sim. O Decreto Estadual 69.118/2024 permite que o CBPMESP aplique multas pesadas. Além disso, a ausência de AVCB válido anula a cobertura do seguro predial e transfere a responsabilidade civil e criminal diretamente para o síndico em caso de sinistro." },
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div>
              ...
              <div className="space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
                ...
                <p>
                  A responsabilidade pela manutenção do AVCB recai integralmente sobre o síndico. Em condomínios de Saúde, a ausência de um AVCB válido ou a negligência na renovação resulta em três consequências severas: a <strong>nulidade imediata da apólice de seguro predial</strong> em caso de sinistro, a aplicação de <strong>multas estaduais (Decreto 69.118/2024)</strong> e a responsabilização civil e criminal direta do gestor caso ocorram danos físicos aos moradores.
                </p>
