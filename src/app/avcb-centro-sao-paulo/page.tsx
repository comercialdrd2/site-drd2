...
const _pageTitle = "AVCB em Centro SP SP | Especialistas na Região da Paulista | DRD2";
const _pageDesc = "Regularização de AVCB e CLCB no Centro de São Paulo. Engenheiros credenciados no CREA para condomínios antigos (década de 50/70), bancos e comércio popular e estabelecimentos com emissão ágil.";

export const metadata = {
  title: "AVCB em Centro SP SP | Especialistas na Região da Paulista | DRD2",
  description: "Regularização de AVCB e CLCB no Centro de São Paulo. Engenheiros credenciados no CREA para condomínios antigos (década de 50/70), bancos e comércio popular e estabelecimentos com emissão ágil.",
  alternates: {
    canonical: "/avcb-centro-sao-paulo",
  },
};

export default function CentrodeSoPauloLandingPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Meu edifício no centrão pode isentar da Sprinkler?",
      answer: "Existem preceitos de compensação perante os anos de construção para garantir aprovações flexibilizadas na Engenharia (Lei de Retrospectivas)."
    },
    {
      question: "Qual o prazo para obter o AVCB em Centro São Paulo?",
    ...
    {
      question: "Meu imóvel em Centro São Paulo precisa de AVCB completo ou CLCB simplificado?",
    ...
    {
      question: "O AVCB vencido impede a renovacao do alvará de funcionamento em Centro São Paulo?",
    ...
    {
      question: "Qual a documentação para iniciar o AVCB em Centro São Paulo?",
  ...
  const services = [
    { 
      name: "Regularização Predial Retrofit", 
      desc: "Implementação especializada sem deturpar arquiteturas tombadas e antigas.",
      icon: Building2,
      slug: "service"
    }
  ];
  ...
  return (
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8 text-left">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-3/5">
              <span className="inline-block bg-primary text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 border border-white/10 leading-none shadow-xl tracking-tighter shadow-primary/20">O Eixo da Inovação e Gastronomia: Centro de São Paulo Premium</span>
              <h1 className="text-3xl md:text-[5.5rem] font-black mb-4 leading-[0.8] tracking-tighter uppercase italic text-white flex flex-col">
                <span className="text-white">AVCB NO(A) <br/> <span className="text-primary not-italic tracking-tighter uppercase font-black">CENTRO DE SÃO PAULO</span></span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-5 mb-12">
                ...
                >
                  <Phone className="w-8 h-8" /> Falar com engenheiro especialista em Centro SP
                </a>
              </div>
            </div>
            ...
            <div className="lg:w-2/5">
                <div className="bg-white p-8 rounded-[4rem] shadow-4xl relative overflow-hidden text-slate-900 border-t-8 border-primary italic">
                  ...
                  <h3 className="text-2xl font-black text-secondary mb-4 flex items-center gap-3 italic uppercase text-center justify-center underline decoration-primary/10">
                    Diagnóstico <span className="text-primary not-italic uppercase tracking-tighter font-black">Centro SP</span>
                  </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <div className="inline-flex items-center gap-2 text-primary font-black text-xs uppercase tracking-widest leading-none">
                <BadgeInfo className="w-4 h-4" /> Prédios Históricos e Administração Urbana
              </div>
              <h2 className="text-4xl md:text-[5.5rem] font-black text-secondary leading-[0.85] tracking-tighter uppercase italic underline decoration-primary/20 decoration-8 underline-offset-16 text-left font-black">
                AUTORIDADE <br /> TÉCNICA EM <br /> <span className="text-primary not-italic tracking-tighter uppercase font-black tracking-tighter">CENTRO SP</span>
              </h2>
              <p className="text-xl text-gray-500 font-bold leading-relaxed uppercase tracking-tight text-balance border-l-8 border-primary/20 pl-8 text-left font-black">
                A região da Centro de São Paulo exige engenharia de precisão com foco em condomínios antigos (década de 50/70), bancos e comércio popular. A regularização do AVCB no CBPMESP precisa seguir rigorosamente as normas 2025 do Decreto Estadual, cobrindo com assertividade tudo o que prefeituras e órgãos exigem dos empreendimentos no eixo da  Avenida Paulista.
              </p>
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Precisa de AVCB em Centro São Paulo? Fale agora com um engenheiro especialista.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="imóvel em Centro São Paulo"
            variant="primary"
            centered
          />
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="text-4xl md:text-[6rem] font-black uppercase italic tracking-tighter mb-10 leading-[0.8] underline decoration-primary decoration-8 underline-offset-16 font-black font-black">
                  PRESENÇA <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black">CENTRO SP SP</span>
                </h2>
      ...
      <SocialProof
        testimonial={{
          text: "A DRD2 regularizou nosso estabelecimento em Centro São Paulo com agilidade e sem burocracia. AVCB aprovado sem nenhuma pendência. Recomendo a todos os empresários da região.",
          author: "Cliente DRD2 Engenharia",
          role: "Empresário — Centro São Paulo, São Paulo",
        }}
      />
      ...
      <section className="py-24 bg-white border-t border-slate-100 italic">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="text-center mb-16 underline decoration-primary decoration-4 underline-offset-16">
             <h2 className="text-4xl font-black text-secondary uppercase italic tracking-tighter text-center font-black tracking-tighter">Dúvidas <span className="text-primary not-italic text-sm font-bold tracking-tighter text-center font-black">CENTRO SP</span></h2>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-slate-300 text-xl font-black uppercase italic tracking-tight mb-2">
            Não arrisque seu CNPJ em Centro São Paulo.
          </p>
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-200 text-center relative overflow-hidden italic shadow-inner">
        <div className="container mx-auto px-4 max-w-6xl text-center">
            <h2 className="text-4xl md:text-[8rem] font-black text-secondary leading-[0.75] uppercase tracking-tighter mb-12 italic underline decoration-primary decoration-8 underline-offset-[2rem] text-center font-black font-black">
              Centro SP Seguro <br /><span className="text-primary not-italic tracking-[0.1em] font-black tracking-tighter font-black font-black">EFICIÊNCIA MASTER</span>
            </h2>
      ...
      <section className="py-24 bg-white border-t border-slate-100 text-slate-700 italic border-b-4 border-primary font-bold">
        <div className="container mx-auto px-4 max-w-4xl prose prose-slate font-black uppercase text-[11px] tracking-tight leading-relaxed text-left">
          <h2 className="text-3xl font-black text-secondary uppercase tracking-tighter italic mb-10 border-l-12 border-primary pl-10 leading-none underline decoration-primary/5 text-left font-black tracking-tighter font-black">Aprovação de AVCB Master na região de Centro de São Paulo</h2>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-primary">AVCB em Centro São Paulo</span></h2>
          <p className="text-slate-600 font-medium mb-8 text-center">
            Para protocolar o pedido de AVCB junto ao Corpo de Bombeiros, seu imóvel em Centro São Paulo precisa dos seguintes documentos:
          </p>
          ...
          <div className="bg-red-50 border-l-8 border-primary p-6 rounded-r-2xl text-red-900 font-bold text-sm">
            A DRD2 faz auditoria documental gratuita antes de qualquer protocolo em Centro São Paulo. Evite exigencias, rejeicoes e atrasos identificando documentos pendentes antes de submeter ao CBPMESP.
          </div>
        </div>
      </section>
      ...
      <NeighborhoodAuthorityBlock
        ...
        zone="Centro"
        currentSlug="/avcb-centro-sao-paulo"
      />



      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <ServiceClusterLinks currentSlug="/avcb-centro-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-centro-sao-paulo" />


      <OccupationDepthBlock
        occupation="/Avcb Centro"
        currentSlug="/avcb-centro-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="bairro"
        maxLinks={6}
        titulo="Serviços de AVCB em Centro"
      />
</>
  );
}
