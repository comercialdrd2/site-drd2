...
const _slug = "/renovacao-clcb-lapa-sao-paulo";
const _pageTitle = "Renovação de CLCB na Lapa SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB na Lapa com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Rua Guaicurus, Av. Antártica, Vila Leopoldina, Pompeia e todo o bairro. DRD2 Engenharia.";
...
export default function RenovacaoClcbLapaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido na Lapa?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Na Lapa, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB na Lapa exige obras?",
    ...
    {
      question: "Tenho uma loja ou escritório na Rua Guaicurus com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. A Lapa concentra um mix de comércio tradicional, escritórios e novos negócios convertidos de antigas instalações industriais — todos sujeitos à fiscalização. Regularize sem esperar notificação.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel na Lapa precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — comércio, escritórios, clínicas, salões de beleza, pequenos restaurantes. Galpões e imóveis industriais convertidos podem exigir AVCB dependendo do uso e da área. A DRD2 define qual certificado se aplica no diagnóstico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB na Lapa?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente na Lapa, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Vila Leopoldina, Pompeia, Água Branca e Barra Funda.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB na Lapa" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido na Lapa — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB na Lapa:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido na Lapa é risco real de interdição e bloqueio do alvará. Do comércio tradicional da Rua Guaicurus aos escritórios e estúdios instalados em antigos galpões, qualquer estabelecimento pode ser autuado pelo CBPMESP sem aviso prévio.
            </p>
            ...
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico na Lapa",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Quem Precisa de Renovação de CLCB na Lapa?
              </h2>
              <p className="text-slate-600 font-medium mb-6 leading-relaxed">A Lapa combina comércio tradicional, novos negócios e conversões de uso — com grande concentração de estabelecimentos ao longo da Rua Guaicurus, Av. Antártica e entorno da estação CPTM. A maioria opera em espaços menores que 750 m² — perfil exato do CLCB.</p>
              <ul className="space-y-4">
                {[
                  "Lojas e serviços na Rua Guaicurus e Av. Nossa Senhora da Lapa",
                  "Escritórios e coworkings em galpões convertidos na região",
                  "Clínicas médicas e odontológicas no miolo residencial do bairro",
                  "Restaurantes e bares próximos à estação CPTM Lapa",
                  "Salões de beleza e academias espalhados pelo bairro",
                ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido na Lapa?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP pode interditar o estabelecimento em qualquer fiscalização. Na Lapa, imóveis convertidos de uso industrial para comercial/serviços são foco frequente de vistorias." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado na Lapa?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Conversão de Uso ou Reforma</h3>
              <p className="text-slate-600 font-medium">Na Lapa, a conversão de galpões e sobrados industriais em escritórios, coworkings e estúdios é frequente. Cada mudança de uso exige um novo CLCB antes de iniciar as atividades no espaço adaptado.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Contratos de Locação e Due Diligence</h3>
              <p className="text-slate-600 font-medium">Locadores de espaços comerciais e industriais convertidos na Lapa exigem CLCB válido como condição contratual. Empresas em processo de due diligence ou captação de investimento também precisam do certificado em dia.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="mt-16 bg-red-600 text-white rounded-[2rem] p-10 max-w-3xl mx-auto shadow-2xl font-black uppercase flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h4 className="text-2xl mb-4">Prazos de Renovação na Lapa</h4>
              <ul className="text-sm font-medium space-y-2 opacity-90 normal-case mb-4">
                <li>• Lojas e escritórios com sistemas OK: 15 a 30 dias</li>
                <li>• Restaurantes e galpões convertidos: 20 a 45 dias</li>
      ...
      <SocialProof
        testimonial={{
          text: "Convertemos um galpão na Lapa em coworking e precisávamos do CLCB para abrir as portas. A DRD2 orientou todo o processo desde o diagnóstico, adequou os sistemas e entregou o certificado dentro do prazo de inauguração.",
          author: "Cliente DRD2 Engenharia",
          role: "Gestor de Coworking — Lapa, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Lapa</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Toda a Lapa e a Zona Oeste</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB na Rua Guaicurus, Av. Antártica, Av. Nossa Senhora da Lapa, Rua Catão e em todo o bairro — além dos bairros vizinhos: Vila Leopoldina, Pompeia, Água Branca, Barra Funda e Perdizes.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB na Lapa Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-white text-sm font-bold mb-8">Cada dia sem renovação é um dia a mais de exposição para você e seu negócio na Lapa.</p>
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Lapa" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB na Lapa e Zona Oeste" />
      <LeadForm />
