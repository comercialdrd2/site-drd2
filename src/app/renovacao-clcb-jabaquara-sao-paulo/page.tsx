...
const _slug = "/renovacao-clcb-jabaquara-sao-paulo";
const _pageTitle = "Renovação de CLCB no Jabaquara SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB no Jabaquara com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Av. Jabaquara, Terminal Jabaquara, Saúde, Sacomã e toda a região. DRD2 Engenharia.";
...
export default function RenovacaoClcbJabaquaraPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido no Jabaquara?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. No Jabaquara, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB no Jabaquara exige obras?",
    ...
    {
      question: "Tenho uma farmácia ou clínica no Jabaquara com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. O Jabaquara tem alta concentração de farmácias e clínicas populares no entorno do Terminal e metrô — que são alvo frequente da Vigilância Sanitária e do CBPMESP. Farmácias perdem a autorização de funcionamento e clínicas perdem credenciamento em planos de saúde com CLCB vencido.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel no Jabaquara precisa?",
      answer: "CLCB é para edificações até 750 m² com atividades de baixo risco — farmácias, clínicas, comércio, restaurantes, salões, academias. AVCB é exigido para imóveis maiores ou de risco elevado. A DRD2 define qual certificado se aplica no diagnóstico gratuito.",
    },
    {
      question: "A DRD2 atende renovações urgentes de CLCB no Jabaquara?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente no Jabaquara, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Saúde, Sacomã, Cursino, Ipiranga e Vila Mariana.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB no Jabaquara" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido no Jabaquara — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB no Jabaquara:<br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-3xl leading-relaxed">
              O Jabaquara concentra comércio popular e serviços de saúde no entorno do Terminal e
              metrô, com alta fiscalização da Vigilância Sanitária e CBPMESP. Farmácias e clínicas
              com CLCB vencido perdem autorização de funcionamento e credenciamentos.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
                ...
                <RefreshCw className="w-5 h-5" /> Renovar CLCB no Jabaquara
              </a>
              <a href="#diagnostico"
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-2"><Map className="w-4 h-4 text-blue-400" /> Jabaquara · Saúde · Sacomã</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4">
            Quem Precisa de Renovação de CLCB no Jabaquara?
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            O Jabaquara é um polo de comércio popular e serviços de saúde no extremo sul do município,
            com grande fluxo de passageiros pelo Terminal Jabaquara e metrô. Av. Jabaquara,
            Rua Antônio Gomes, Av. Eng. Armando de Arruda Pereira e o entorno do terminal
            concentram os estabelecimentos com maior demanda por CLCB em dia.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Estabelecimentos que mais renovam no Jabaquara</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Farmácias e drogarias no entorno do Terminal e metrô Jabaquara</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Clínicas populares de saúde, odontologia e exames na Av. Jabaquara</li>
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Academias e studios de bairro</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Salões de beleza e barbearias</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Lojas de calçados, vestuário e eletrônicos no comércio de bairro</li>
              </ul>
            </div>
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Por que o Jabaquara tem fiscalização intensa?</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Terminal Jabaquara gera alto fluxo de passageiros — CBPMESP e Prefeitura fiscalizam o entorno com frequência</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Vigilância Sanitária realiza blitzes periódicas em farmácias e clínicas populares da região</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Planos de saúde populares (Amil Saúde, SulAmérica) realizam auditorias frequentes de credenciamento</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Proximidade com Santo André e São Bernardo aumenta o raio de fiscalização na região</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">
            O Que Acontece com CLCB Vencido no Jabaquara?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              { icon: Clock, title: "Autorização Sanitária Suspensa", desc: "A Vigilância Sanitária suspende a autorização de funcionamento de farmácias e clínicas sem CLCB." },
              { icon: FileCheck, title: "Credenciamento Cancelado", desc: "Planos de saúde cancelam o credenciamento de clínicas populares sem CLCB válido." },
            ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Map, title: "Abertura de novo ponto", desc: "Farmácia, clínica ou comércio no Jabaquara precisa de CLCB antes de iniciar atividades." },
              ...
              { icon: CheckCircle2, title: "Auditoria de plano de saúde", desc: "Amil, SulAmérica e outros realizam vistorias periódicas e pedem o CLCB atualizado." },
            ].map((item) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8">
                Como Funciona a Renovação de CLCB no Jabaquara
              </h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8">
              <h3 className="font-black text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Clock className="w-6 h-6 text-amber-500" /> Prazo de Renovação no Jabaquara
              </h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-black mb-4">Diagnóstico Gratuito para Renovação de CLCB no Jabaquara</h2>
              ...
              <ul className="space-y-3 text-slate-300">
                {["Diagnóstico técnico gratuito", "Sem obras desnecessárias", "Engenheiro responsável pelo processo", "Cobertura: Jabaquara e toda Zona Sul"].map((item) => (
      ...
      <SocialProof
        testimonial={{
          text: "Tenho uma clínica popular de exames na Av. Jabaquara e recebi notificação do plano de saúde pedindo o CLCB atualizado. Estava vencido há 14 meses. A DRD2 fez o diagnóstico em dois dias, sem obras, e em 40 dias o CLCB estava renovado. Não perdi nenhum convênio.",
          author: "Sônia Carvalho",
          role: "Proprietária de clínica de exames, Jabaquara",
        }}
      />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-10 text-center">Perguntas Frequentes — CLCB Jabaquara</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">Cobertura: Jabaquara e Região</h2>
          <p className="text-center text-slate-500 mb-8 max-w-2xl mx-auto">
            Além do Jabaquara, a DRD2 atende renovações de CLCB nos bairros vizinhos da Zona Sul.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {["Saúde", "Sacomã", "Cursino", "Ipiranga", "Vila Mariana", "Mirandópolis", "Vila Prudente", "Santo André"].map((bairro) => (
      ...
      <CtaWhatsApp label="CLCB Vencido no Jabaquara? Fale com um Engenheiro Agora" />
      ...
      <nav aria-label="Breadcrumb" className="py-4 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <li className="text-slate-300">/</li>
            <li className="text-slate-800 font-medium">Jabaquara</li>
          </ol>
        </div>
      </nav>
    </>
