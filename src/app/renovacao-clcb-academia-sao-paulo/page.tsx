...
import {
  ...
  ShieldX, Dumbbell, Activity, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbAcademiaContent as c } from "@/data/pages/renovacao-clcb-academia-sao-paulo";
...
export default function RenovacaoCLCBAcademiaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-academia-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Academia em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Academia e Estúdio Fitness", item: "/renovacao-clcb-academia-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Academia em São Paulo — DRD2 Engenharia"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — ACADEMIA E ESTÚDIO FITNESS
              </span>
              <span className="text-2xl md:text-3xl lg:text-4xl italic text-red-500 mt-1 block leading-none">
                CLCB VENCIDO? EVITE INTERDIÇÃO E CANCELAMENTO DAS AULAS
              </span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Academia e Estúdio Fitness" },
        ]}
        dark
      />
      <TrustBar dark />
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  Academia interditada por CLCB vencido precisa cancelar todas as aulas e mensalidades até a regularização completa. O impacto financeiro pode ser imediato e severo — não espere o vencimento.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            CLCB da sua academia vencido? Fale agora e receba diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico técnico gratuito pelo WhatsApp"
            occupationType="academia em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 para a sua academia?
              </h2>
              <div className="space-y-4">
                {[
                  "Especialistas em CLCB para academias e estúdios fitness",
                  "Avaliação de enquadramento CLCB ou AVCB sem erro",
                  "Diagnóstico técnico gratuito sem surpresas",
                  "Adequações sem cancelamento de aulas",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Dumbbell, l: "Academias de Musculação" },
                { Icon: Activity, l: "Estúdios de Pilates" },
                { Icon: Dumbbell, l: "CrossFit e Funcional" },
                { Icon: Activity, l: "Yoga e Dança" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Academia</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-academia-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-academia-sao-paulo" />
      <div className="container mx-auto px-4 max-w-4xl text-center py-4 opacity-50"><p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conteúdo Técnico Atualizado em: Maio de 2026</p></div>
      <NeighborhoodSilo currentSlug="/renovacao-clcb-academia-sao-paulo" />

      <OccupationAuthorityBlock occupation="Academia" currentSlug="/renovacao-clcb-academia-sao-paulo" />
      <OccupationDepthBlock occupation="Academia" currentSlug="/renovacao-clcb-academia-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-academia-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Academia em São Paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight italic">
            CLCB da sua academia vencido ou próximo do vencimento?
          </h2>
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 renova sem cancelar suas aulas — do diagnóstico à entrega do certificado.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
