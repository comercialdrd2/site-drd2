...
import { alvaraBombeiroContent as c } from "@/data/pages/alvara-bombeiro-escola-faculdade-sao-paulo";
...
export default function AlvaraBombeiroEscolaFaculdadePage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Alvará do Corpo de Bombeiros para Escolas e Faculdades em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Alvará Bombeiro Escolas e Faculdades SP", item: c.meta.canonical },
        ],
      });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[40px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Alvará do Bombeiro para Escola e Faculdade"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Escolas e Faculdades em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Escolas e Faculdades" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto">
              Itens verificados pelo Corpo de Bombeiros na vistoria de escolas e faculdades.
            </p>
          </div>
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Escola ou faculdade sem alvará do bombeiro? Regularize com segurança.
          </p>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Escolas e Faculdades</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-500 opacity-60">
            DRD2 Engenharia — Alvará do Bombeiro para Escolas e Faculdades em São Paulo
          </p>
        </div>
      </section>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/alvara-bombeiro-escola-faculdade-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/alvara-bombeiro-escola-faculdade-sao-paulo" />
      <ServiceBlogLinks currentSlug="/alvara-bombeiro-escola-faculdade-sao-paulo" />
