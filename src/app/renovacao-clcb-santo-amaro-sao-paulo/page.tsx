...
const _slug = "/renovacao-clcb-santo-amaro-sao-paulo";
const _pageTitle = "Renovação de CLCB em Santo Amaro SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB em Santo Amaro com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Largo Treze, Av. Santo Amaro, Campo Belo, Brooklin e todo o bairro. DRD2 Engenharia.";
...
export default function RenovacaoClcbSantoAmaroPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido em Santo Amaro?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Em Santo Amaro, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB em Santo Amaro exige obras?",
    ...
    {
      question: "Tenho uma loja no Largo Treze ou clínica na Av. Santo Amaro com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. O Largo Treze de Maio é um dos corredores comerciais mais movimentados da cidade, com fiscalização frequente. Lojas em galerias e clínicas próximas ao metrô Santo Amaro são alvos frequentes de inspeção.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel em Santo Amaro precisa?",
    ...
    {
      question: "A DRD2 atende renovações urgentes de CLCB em Santo Amaro?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente em Santo Amaro, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Campo Belo, Brooklin, Chácara Santo Antônio e Cidade Monções.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB em Santo Amaro" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido em Santo Amaro — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB em Santo Amaro:<br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              CLCB vencido em Santo Amaro é risco real de interdição e bloqueio do alvará. Do Largo Treze à Av. Santo Amaro, um dos corredores comerciais mais movimentados da Zona Sul, qualquer estabelecimento pode ser autuado pelo CBPMESP sem aviso prévio.
            </p>
            <div className="flex flex-col sm:flex-row gap-5">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl bg-[#25D366] px-10 py-6 text-xl font-black shadow-[0_0_40px_rgba(220,38,38,0.5)] hover:bg-[#1EBE5A] hover:-translate-y-1 transition-all text-white border border-red-500 uppercase tracking-tighter">
                Renovar CLCB em Santo Amaro Agora
              </a>
            </div>
            <ul className="mt-10 space-y-4">
              {[
                ...
                "Protocolo de urgência para CLCB com prazo crítico em Santo Amaro",
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                Quem Precisa de Renovação de CLCB em Santo Amaro?
              </h2>
              <p className="text-slate-600 font-medium mb-6 leading-relaxed">Santo Amaro é o maior polo comercial da Zona Sul, com enorme concentração de lojas, clínicas e serviços ao longo do Largo Treze de Maio, Av. Santo Amaro e entorno do metrô. A maioria dos estabelecimentos opera em espaços menores que 750 m² — perfil exato do CLCB.</p>
              <ul className="space-y-4">
                {[
                  "Lojas e galerias comerciais no Largo Treze de Maio",
                  "Clínicas médicas e odontológicas próximas ao metrô Santo Amaro",
                  "Restaurantes e lanchonetes ao longo da Av. Santo Amaro",
                  "Salões de beleza e clínicas estéticas no comércio do bairro",
                  "Escritórios e consultórios no miolo residencial e comercial",
                ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">
            O que Acontece com<br /><span className="text-red-500">CLCB Vencido em Santo Amaro?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              { icon: AlertTriangle, title: "Interdição Imediata", text: "O CBPMESP pode interditar o estabelecimento em qualquer fiscalização. O Largo Treze de Maio é um dos pontos de maior fiscalização da Zona Sul pela alta densidade de lojas e galerias." },
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Quando o CLCB Precisa ser Renovado em Santo Amaro?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-white p-10 rounded-[2.5rem] border border-red-600 shadow-xl relative overflow-hidden">
              ...
              <p className="text-slate-600 font-medium">CLCB expirado exige renovação imediata. Não espere notificação — o CBPMESP fiscaliza a qualquer momento. Em Santo Amaro, o risco é maior pela alta densidade comercial e pelos eventos frequentes no Largo Treze.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              ...
              <p className="text-slate-600 font-medium">Qualquer reforma ou mudança no uso do espaço exige atualização do CLCB. Em Santo Amaro, adequações em lojas do Largo Treze e reformas em clínicas são causas frequentes de renovação antecipada.</p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl">
              <h3 className="text-2xl font-black text-red-900 mb-4 border-b-2 border-red-600/20 pb-4">Contratos de Galeria e Redes</h3>
              <p className="text-slate-600 font-medium">Lojistas em galerias do Largo Treze e franqueados em Santo Amaro precisam de CLCB válido para renovar contratos de locação em shopping e galerias, que exigem regularidade documental como condição contratual.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="mt-16 bg-red-600 text-white rounded-[2rem] p-10 max-w-3xl mx-auto shadow-2xl font-black uppercase flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h4 className="text-2xl mb-4">Prazos de Renovação em Santo Amaro</h4>
      ...
      <SocialProof
        testimonial={{
          text: "Minha loja no Largo Treze estava com CLCB vencido e o administrador da galeria exigiu regularização para renovar o contrato. A DRD2 resolveu tudo em menos de um mês sem que eu precisasse fechar a loja.",
          author: "Cliente DRD2 Engenharia",
          role: "Lojista — Largo Treze de Maio, Santo Amaro, SP",
        }}
      />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center text-slate-900 mb-16 uppercase tracking-tighter">
            Perguntas Frequentes: <span className="text-red-600">Renovação CLCB Santo Amaro</span>
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <h3 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">Atendemos Todo Santo Amaro e a Zona Sul</h3>
          <p className="text-slate-600 font-medium max-w-2xl mx-auto">Renovamos CLCB no Largo Treze de Maio, Av. Santo Amaro, Rua Amador Bueno, Av. Giovanni Gronchi e em todo o bairro — além dos bairros vizinhos: Campo Belo, Brooklin, Chácara Santo Antônio, Cidade Monções e Vila Andrade.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-slate-900 border-b-8 border-red-600 rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl text-white">
            <div className="text-center md:text-left">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase italic tracking-tighter">Renove o CLCB em Santo Amaro Hoje</h3>
      ...
      <div className="py-14 bg-slate-950">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-white text-sm font-bold mb-8">Cada dia sem renovação é um dia a mais de exposição para você e seu negócio em Santo Amaro.</p>
          <CtaWhatsApp label="Falar com engenheiro e renovar agora" occupationType="renovacao CLCB Santo Amaro" variant="primary" size="lg" centered />
        </div>
      </div>

      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={6} titulo="Renovação de CLCB em Santo Amaro e Zona Sul" />
      <LeadForm />
