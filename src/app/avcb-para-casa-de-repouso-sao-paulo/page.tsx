...
import { avcbCasaRepousoContent as c } from "@/data/pages/avcb-casa-repouso-sao-paulo";
...
const sistemaIcons: Record<string, React.ReactNode> = {
  ...
  "Saídas de emergência e rotas de fuga": <ArrowRight className="w-7 h-7" />,
  ...
  "Áreas de refúgio": <ShieldCheck className="w-7 h-7" />,
};

export default function AVCBCasaRepousoPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "AVCB para Casa de Repouso em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "AVCB para Casa de Repouso em São Paulo", item: "/avcb-para-casa-de-repouso-sao-paulo" },
        ],
      });
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[20px] flex items-center bg-slate-950 border-b-8 border-red-600  ">
        <Image src="/images/hero-casa-repouso.webp" alt="Instalações de casa de repouso com acessibilidade e segurança" fill className="object-cover object-center opacity-30 grayscale-[30%]" priority sizes="100vw" quality={65} />
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "AVCB para Casa de Repouso em São Paulo" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-none uppercase tracking-tighter mb-8 italic">
            Casa de Repouso e ILPI Precisam de{" "}
      ...
      {/* ── H2 #2: EXIGÊNCIAS TÉCNICAS MAIS RÍGIDAS ── */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
              Por que o AVCB de Casa de Repouso tem{" "}
              <span className="text-red-600 not-italic">Exigências Técnicas Mais Rígidas?</span>
            </h2>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic">Corpo de Bombeiros em Casas de Repouso</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Sua casa de repouso tem todos esses sistemas aprovados pelo CBPMESP?
          </p>
          <CtaWhatsApp
      ...
      {/* ── H2 #4: EDIFICAÇÃO RESIDENCIAL ADAPTADA ── */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic">
                Casa de Repouso em{" "}
                <span className="text-red-600 not-italic">Edificação Residencial Adaptada</span>
              </h2>
              <div className="space-y-5 text-lg text-slate-700 leading-relaxed font-medium">
                {c.h2_adaptada.body.map((p, i) => (
                  <p key={i}>{p}</p>
                ))}
              </div>
              <div className="space-y-6 mt-8">
                {c.h2_adaptada.itens.map((item, i) => (
              ...
              <div className="bg-slate-950 p-8 rounded-[2rem] text-white mt-8 border-l-8 border-red-600">
                <p className="text-slate-200 font-bold leading-relaxed italic" dangerouslySetInnerHTML={{ __html: c.h2_adaptada.closing }} />
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-[3rem] border border-slate-200 p-10">
              ...
              {[
                "Licença sanitária CVS exige AVCB vigente",
                "Vigilância Sanitária pode interditar sem aviso",
                "AVCB vencido = AVCB inexistente na fiscalização",
                "Convênios e planos de saúde exigem regularidade",
                "Responsabilidade civil e criminal do diretor",
                "Seguro do imóvel inválido sem certificado",
              ].map((item, i) => (
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-20">
            <span className="text-red-500 font-black uppercase tracking-widest text-xs">Grupo I — Processo Especializado</span>
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter leading-none uppercase italic mt-4">
              ...
              <span className="text-red-600 not-italic">AVCB para Casa de Repouso em SP</span>
            </h2>
          </div>
      ...
      <div className="py-16 border-y bg-[#7F1D1D] border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            Pronto para regularizar sua instituição?
          </p>
          <CtaWhatsApp
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic">
                Atendemos Casas de Repouso e ILPIs em{" "}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tighter uppercase italic">
              ...
              <span className="text-red-600 not-italic font-black italic uppercase">AVCB para Casa de Repouso SP</span>
            </h2>
          </div>
...
{/* Documentacao Necessaria */}
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tighter text-center">Documentação Necessaria para <span className="text-red-600">AVCB em Casa de Repouso</span></h2>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/avcb-para-casa-de-repouso-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="AVCB para Casas de Repouso em SP"
      />

      <ServiceClusterLinks currentSlug="/avcb-para-casa-de-repouso-sao-paulo" />
      <ServiceBlogLinks currentSlug="/avcb-para-casa-de-repouso-sao-paulo" />

      <NeighborhoodSilo currentSlug="/avcb-para-casa-de-repouso-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — AVCB para Casas de Repouso em São Paulo — Decreto 69.118/2024
          </p>
        </div>
      </section>
