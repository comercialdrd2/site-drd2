...
import {
  ...
  ShieldX, AlertTriangle, MapPin, GraduationCap, Activity, Zap,
  Users, BookOpen, ClipboardList, Hammer, School
} from "lucide-react";
...
import { renovacaoAvcbEscolaContent as c } from "@/data/pages/renovacao-avcb-escola-sao-paulo";
...
export default function RenovacaoAVCBEscolaPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const _schema = generateMasterSchema({
        slug: "/renovacao-avcb-escola-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de AVCB para Escola em São Paulo",
        faqs: c.h2_faq.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação de AVCB para Escola", item: "/renovacao-avcb-escola-sao-paulo" },
        ],
      });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de AVCB para Escola em São Paulo"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            <span className="inline-block bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-3 shadow-lg shadow-red-900/20">
              Setor Educacional — Renovação 2026
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-4xl font-black mb-2 leading-[0.9] tracking-tighter uppercase italic text-white flex flex-col">
              ...
              <span className="text-red-600 not-italic text-2xl md:text-3xl lg:text-4xl mt-2 block drop-shadow-2xl text-wrap">
                PARA ESCOLA EM SP — A SEGURANÇA DOS SEUS ALUNOS
              </span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Renovação de AVCB para Escola em SP" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-6xl text-lg text-slate-700 leading-relaxed font-medium">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-none uppercase tracking-tighter mb-8 italic" dangerouslySetInnerHTML={{ __html: c.h2_porqueVence.heading }} />
              <div className="space-y-5 text-lg text-slate-700 leading-relaxed font-medium">
                ...
                <p dangerouslySetInnerHTML={{ __html: c.h2_porqueVence.body }} />
              </div>
              <p className="mt-6 font-bold text-slate-900 uppercase italic tracking-tight">Situações que complicam a renovação de escolas:</p>
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter uppercase italic" dangerouslySetInnerHTML={{ __html: c.h2_riscos.heading }} />
          </div>
      ...
      <div className="py-16 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">
            AVCB da escola vencido? Fale agora com um engenheiro pelo WhatsApp e receba o diagnóstico gratuito.
          </p>
          <CtaWhatsApp
            label="Solicitar diagnóstico para Escola"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic text-balance" dangerouslySetInnerHTML={{ __html: c.h2_verificado.heading }} />
      ...
      {/* ── H2 #4: ESCOLA PÚBLICA VS PARTICULAR ── */}
      <section className="py-24 bg-slate-950 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                    <h2 className="text-3xl md:text-4xl font-black mb-8 tracking-tighter uppercase italic leading-none" dangerouslySetInnerHTML={{ __html: c.h2_diferenca.heading }} />
                    <div className="space-y-6">
                        {c.h2_diferenca.itens.map((item, i) => (
                            <div key={i} className="flex items-start gap-5 bg-white/5 rounded-2xl p-6 border border-white/10">
                                <div className="w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="bg-white rounded-[3rem] p-10 text-slate-900 relative overflow-hidden h-full">
                    ...
                    <h2 className="font-black text-2xl uppercase italic mb-6 relative z-10 text-red-600 leading-tight" dangerouslySetInnerHTML={{ __html: c.h2_impacto.heading }} />
                    <p className="text-slate-600 mb-8 relative z-10 leading-relaxed italic font-medium" dangerouslySetInnerHTML={{ __html: c.h2_impacto.intro }} />
                    <div className="space-y-6 relative z-10">
                        {c.h2_impacto.itens.map((item, i) => (
                            <div key={i} className="flex items-start gap-4">
                                <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2.5 flex-shrink-0" />
                                <div>
                                    <p className="text-slate-900 font-black text-sm uppercase italic tracking-tight mb-1">{item.titulo}</p>
                                    <p className="text-slate-600 text-sm font-medium leading-relaxed italic">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic" dangerouslySetInnerHTML={{ __html: c.h2_processo.heading }} />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {c.h2_processo.etapas.map((e, i) => (
              <div key={i} className="group p-10 bg-slate-50 rounded-[3rem] border border-slate-200 hover:bg-slate-950 hover:text-white transition-all relative overflow-hidden">
                ...
                <p className="relative z-10 text-slate-500 group-hover:text-slate-400 leading-relaxed font-medium text-sm">{e.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase italic" dangerouslySetInnerHTML={{ __html: c.h2_cobertura.heading }} />
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            {c.h2_faq.faqs.map((faq, i) => (
              <details
                key={i}
                className="group bg-slate-50 rounded-2xl shadow-sm border border-slate-200 overflow-hidden cursor-pointer open:ring-4 open:ring-red-600/10 transition-all hover:bg-white"
              >
      ...
      <section className="py-24 bg-slate-900 text-center border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-white">
          <p className="text-2xl md:text-4xl font-black uppercase italic tracking-tight mb-6">
            A segurança dos seus alunos não pode esperar.
          </p>
          <p className="text-xl text-slate-300 font-medium mb-10 italic">
            Fale com um engenheiro e receba seu diagnóstico gratuito hoje para sua escola.
          </p>
          <CtaWhatsApp
      ...
      <OccupationAuthorityBlock
        occupation="Escola"
        currentSlug="/renovacao-avcb-escola-sao-paulo"
      />
      ...
      <ServiceClusterLinks currentSlug="/renovacao-avcb-escola-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-avcb-escola-sao-paulo" />

      <NeighborhoodSilo currentSlug="/renovacao-avcb-escola-sao-paulo" />
      ...
      <section className="py-24 bg-red-900 text-center relative overflow-hidden text-white border-t-8 border-slate-900">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-100 opacity-50">
            DRD2 Engenharia — Especialista em Renovação de AVCB para Escolas em SP
          </p>
        </div>
      </section>
