...
import { alvaraBombeiroContent as c } from "@/data/pages/alvara-bombeiro-casa-de-repouso-sao-paulo";
...
export default function AlvaraBombeiroCasaRepousoPage() {
  ...
  const _schema = generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Alvará do Corpo de Bombeiros para Casas de Repouso em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Alvará Bombeiro Casas de Repouso SP", item: c.meta.canonical },
        ],
      });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Casas de Repouso em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Casas de Repouso" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto">
              Itens verificados pelo Corpo de Bombeiros na vistoria de casas de repouso.
            </p>
          </div>
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Casa de repouso sem alvará? Idosos dependem da sua regularização.
          </p>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Casas de Repouso</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-500 opacity-60">
            DRD2 Engenharia — Alvará do Bombeiro para Casas de Repouso em São Paulo
          </p>
        </div>
      </section>
      ...
      <OccupationAuthorityBlock
        ...
        currentSlug="/alvara-bombeiro-casa-de-repouso-sao-paulo"
      />
      ...
      <InternalLinksBlock
        ...
        mode="ocupação"
        maxLinks={8}
        titulo="Alvará Bombeiro para Casas de Repouso em SP"
      />

      <ServiceClusterLinks currentSlug="/alvara-bombeiro-casa-de-repouso-sao-paulo" />
      <ServiceBlogLinks currentSlug="/alvara-bombeiro-casa-de-repouso-sao-paulo" />
