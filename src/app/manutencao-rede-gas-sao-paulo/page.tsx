...
import { manutencaoGasContent as c } from "@/data/pages/manutencao-rede-gas-sao-paulo";
...
export default function ManutencaoRedeGasPage() {
  ...
  const schema = generateMasterSchema({
    ...
    title: c.meta.title,
    description: c.meta.description,
    serviceName: "Manutenção de Rede de Gás em São Paulo",
    faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Serviços", item: "/servicos" },
      { name: "Manutenção de Rede de Gás SP", item: c.meta.canonical },
    ],
  });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              Manutenção de Rede de Gás<br />
              <span className="text-orange-400 not-italic">em São Paulo — GLP e GN</span>
            </h1>
            ...
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
              ...
              <span className="font-black uppercase tracking-tight">Orçamento sem compromisso Agora</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Manutenção de Rede de Gás SP" },
        ]}
        dark
      />
      <TrustBar dark />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5">
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-xl sticky top-32">
                <h3 className="text-xl font-black text-slate-900 mb-2 italic uppercase">Orçamento gratuito — Resposta em 2h</h3>
                <p className="text-slate-500 text-sm mb-3 font-medium">Engenheiro especialista em gás responde em até 2h.</p>
                <div className="flex flex-wrap gap-2 mb-5">
                  <span className="text-xs font-black text-green-700 bg-green-50 border border-green-200 px-2 py-1 rounded-full">✓ Laudo com ART incluído</span>
                  <span className="text-xs font-black text-slate-600 bg-slate-100 border border-slate-200 px-2 py-1 rounded-full">✓ GLP e Gás Natural</span>
                </div>
      ...
      <div className="py-14 bg-orange-900 border-y border-orange-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Laudo de gás vencido? Regularize antes da vistoria do bombeiro.
          </p>
          <p className="text-orange-200 text-sm font-bold mb-6">
            A DRD2 emite o laudo técnico com ART em até 3 dias úteis.
          </p>
          <CtaWhatsApp label="Solicitar orçamento de manutenção de gás" occupationType="condominio" variant="primary" centered />
        </div>
      </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-orange-600">Manutenção de Rede de Gás</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-orange-500">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-4xl md:text-6xl font-black mb-6 uppercase tracking-tighter italic leading-none">
            Manutenção de Gás<br />
            <span className="text-orange-400 not-italic">com Laudo e ART</span>
          </h2>
          <p className="text-slate-300 text-xl font-medium mb-10 leading-relaxed">
            Laudo técnico pronto para o AVCB. Atendimento em SP e Grande SP. Orçamento sem compromisso.
          </p>
          <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
      ...
      <InternalLinksBlock currentSlug={c.meta.canonical} mode="servico" maxLinks={8} titulo="Serviços de Gás e Regularização em SP" />
