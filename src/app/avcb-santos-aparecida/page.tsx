...
const _slug = "/avcb-santos-aparecida";
const _pageTitle = "AVCB e CLCB em Aparecida, Santos SP | DRD2 Engenharia";
const _pageDesc = "Regularização de AVCB e CLCB em Aparecida, Santos SP. Foco em segurança contra incêndio, aprovação técnica e renovação no Corpo de Bombeiros com projeto especializado.";
...
export default function ExpansionLandingPage() {
  ...
  const faqItems = [
    { question: "Shopping precisa de AVCB ou CLCB?", answer: "Sempre AVCB completo, devido à complexidade e alta lotação de público." },
    { question: "Como saber se a porta corta-fogo do prédio está boa?", answer: "Ela deve fechar sozinha (mola ok), não ter frestas e possuir o selo da ABNT/IPT." },
    { question: "O Bombeiro vistoria dentro das lojas do shopping?", answer: "Sim, eles verificam extintores, sprinklers e se as saídas de estoque estão livres." },
    { question: "Onde fica o registro de gás do prédio na Aparecida?", answer: "Deve estar em local ventilado e sinalizado, com a válvula de corte rápido acessível." },
    { question: "Qual o prazo para obter o AVCB em Aparecida?", answer: "Em média de 30 a 90 dias, dependendo da complexidade técnica. A DRD2 acelera o processo com protocolos prioritários." }
  ];
  ...
  const _schema = generateMasterSchema({
    ...
    serviceName: "AVCB e Regularização em Aparecida",
    faqs: faqItems,
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Expansão", item: "#" },
      { name: "Aparecida", item: _slug }
    ]
  });
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-gray-900 border-b-4 border-red-600">
        <Image
          ...
          alt="Regularização de AVCB em Aparecida"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg backdrop-blur-sm">
              <ShieldAlert className="w-4 h-4" /> Segurança para Grandes Comércios e Prédios
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight drop-shadow-2xl text-white">
              AVCB em Aparecida: <br className="hidden md:block" />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 leading-relaxed font-medium">
              Sem AVCB válido em Aparecida, sua empresa pode ser <strong className="text-white bg-red-600/30 px-2">interditada</strong> e seu <strong className="text-white bg-red-600/30 px-2">responsável pode ser autuado</strong>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              >
                Falar com engenheiro especialista em Aparecida
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="prose prose-lg text-slate-700">
               <h2 className="text-4xl font-black text-slate-900 leading-tight mb-8">
                ...
                <span className="text-red-600">Aparecida</span>
              </h2>
              <p>
                Regularizar uma edificação em <strong>Aparecida</strong> exige conhecimento das normas técnicas locais e estaduais. A região de Litoral é estratégica e possui rigorosa fiscalização.
              </p>
              <p>
                A Aparecida combina grandes condomínios residenciais e o maior complexo de compras de Santos. O desafio do AVCB aqui é a gestão de grandes massas. O shopping exige sistemas de sprinklers (chuveiros automáticos) monitorados 24h por central de incêndio.
              </p>
              <p>
      ...
      <section className="py-24 bg-slate-950 text-white">
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="bg-red-900/20 border-l-8 border-red-600 p-10 rounded-r-[3rem] relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black mb-6 uppercase italic tracking-tight">Cenário Local: Aparecida</h3>
              <p className="text-slate-300 text-lg leading-relaxed font-medium mb-6">
                Em prédios residenciais da Aparecida, a substituição de portas corta-fogo por modelos 'comuns' em reformas de moradores é um problema crônico que trava a renovação do AVCB de todo o condomínio.
              </p>
              <p className="text-red-400 font-bold uppercase italic tracking-tighter">
                ⚠️ Atendimento prioritário para a região: Av. Epitácio Pessoa, Av. Bartolomeu de Gusmão
              </p>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase tracking-tighter">Riscos Identificados em Aparecida</h2>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { t: "Sprinklers obstruídos em lojas", d: "Lojistas que colocam gesso ou decoração sobre os bicos de água, inutilizando o sistema." },
                { t: "Central de incêndio em 'bypass'", d: "Condomínios que desligam o alarme devido a alarmes falsos, o que é crime de perigo comum." },
                { t: "Bombas de incêndio com vazamento", d: "Equipamentos que perdem a pressão e não funcionariam em caso de incêndio real." },
              ].map((prob, i) => (
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800 text-center">
         <p className="text-white text-lg font-black uppercase italic tracking-tight mb-6">Precisa de AVCB em Aparecida? Fale agora conosco.</p>
         <CtaWhatsApp label="Agendar Vistoria Técnica" occupationType="imóvel em Aparecida" variant="primary" centered />
      </div>
      ...
      <LeadForm />
      <InternalLinksBlock currentSlug={_slug} mode="bairro" maxLinks={8} titulo="Serviços em Aparecida" />

      <ServiceClusterLinks currentSlug="/avcb-santos-aparecida" />
      <ServiceBlogLinks currentSlug="/avcb-santos-aparecida" />
      ...
      <section className="py-24 bg-red-900 text-white text-center relative overflow-hidden">
         <div className="container mx-auto px-4 max-w-4xl relative z-10">
            <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter uppercase italic">Regularize seu condomínio ou comércio na Aparecida</h2>
            <p className="text-xl text-red-100 mb-12 font-medium italic">Investimento em manutenção de sistemas automáticos de combate a incêndio.</p>
            <a href={whatsappLink} target="_blank" className="bg-white text-red-900 font-black px-10 py-5 rounded-2xl shadow-2xl hover:bg-slate-900 hover:text-white transition-all uppercase tracking-widest">
               Falar com Especialista em Aparecida
            </a>
         </div>
      </section>
    </>
