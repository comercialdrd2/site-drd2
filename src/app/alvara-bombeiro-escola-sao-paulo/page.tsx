...
import { alvaraBombeiroContent as c } from "@/data/pages/alvara-bombeiro-escola-sao-paulo";
...
export default function AlvaraBombeiroEscolaPage() {
  ...
  const schema = generateMasterSchema({
    ...
    title: c.meta.title,
    description: c.meta.description,
    serviceName: "Alvará do Corpo de Bombeiros para Escolas em São Paulo",
    faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
    breadcrumbs: [
      { name: "Home", item: "/" },
      { name: "Serviços", item: "/servicos" },
      { name: "Alvará Bombeiro Escola SP", item: c.meta.canonical },
    ],
  });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Escola em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Escola" },
        ]}
        dark
      />
      <TrustBar dark />
            ...
            {c.sections[1].content.map((item, i) => (
              <div key={i} className="bg-white/5 p-8 rounded-3xl border border-white/10 hover:bg-white/10 hover:border-red-500/40 transition-all group">
                <div className="flex items-start gap-5">
                  <div className="w-11 h-11 bg-red-600 rounded-2xl flex items-center justify-center flex-shrink-0">
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Escola com AVCB irregular? Regularize sem travar as aulas.
          </p>
          <p className="text-red-200 text-sm font-bold mb-6">
            A DRD2 Engenharia regulariza com 98% de aprovação na 1ª análise.
          </p>
          <CtaWhatsApp label="Solicitar vistoria diagnóstica gratuita" occupationType="escola" variant="primary" centered />
        </div>
      </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Escola</span>
          </h2>
      ...
      {/* CTA FINAL */}
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-slate-300 text-xl font-medium mb-10 leading-relaxed">
            Diagnóstico técnico gratuito. Resposta a Comunique-se sem custo adicional. 98% de aprovação na 1ª análise.
          </p>
          <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
      ...
      <OccupationAuthorityBlock occupation="Escola" currentSlug={c.meta.canonical} />
      <OccupationDepthBlock occupation="Escola" currentSlug={c.meta.canonical} />
      <InternalLinksBlock currentSlug={c.meta.canonical} mode="ocupação" maxLinks={8} titulo="Alvará Bombeiro para Escola em SP" />
