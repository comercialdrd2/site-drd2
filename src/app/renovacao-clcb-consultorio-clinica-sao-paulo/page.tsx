...
import {
  ...
  ShieldX, HeartPulse, Stethoscope, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbConsultorioContent as c } from "@/data/pages/renovacao-clcb-consultorio-clinica-sao-paulo";
...
export default function RenovacaoCLCBConsultorioPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-consultorio-clinica-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Consultório e Clínica em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Consultório e Clínica", item: "/renovacao-clcb-consultorio-clinica-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Consultório e Clínica em São Paulo — DRD2 Engenharia"
          fill
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  CLCB vencido = risco de suspensão da licença sanitária. A Vigilância Sanitária pode autuar e suspender a licença de funcionamento do seu estabelecimento de saúde durante vistoria de rotina.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <CtaWhatsApp
            ...
            occupationType="consultório em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase italic tracking-tight">
                Por que escolher a DRD2 para seu consultório?
              </h2>
              <div className="space-y-4">
                {[
                  "Especialistas em processo simplificado CLCB para saúde",
                  "Conhecimento técnico sobre gases medicinais e riscos elétricos",
                  "Diagnóstico técnico gratuito sem enquadramentos errados",
                  "Adequações executadas sem interromper atendimentos",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: HeartPulse, l: "Clínicas Médicas" },
                { Icon: Stethoscope, l: "Consultórios Odontológicos" },
                { Icon: HeartPulse, l: "Clínicas de Fisioterapia" },
                { Icon: Stethoscope, l: "Clínicas de Estética" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Consultório</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" />
      <NeighborhoodSilo currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" />

      <OccupationAuthorityBlock occupation="Consultório e Clínica" currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" />
      <OccupationDepthBlock occupation="Consultório e Clínica" currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-consultorio-clinica-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Consultório e Clínica em São Paulo" />
      ...
      <section className="py-24 bg-primary text-white overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          ...
          <p className="text-xl mb-10 font-bold opacity-95 max-w-3xl mx-auto italic leading-relaxed border-b border-white/20 pb-10">
            A DRD2 renova sem interromper seus atendimentos — do diagnóstico à entrega do certificado.
          </p>
          <a
            href={whatsappLink}
            target="_blank"
