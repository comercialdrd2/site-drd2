...
export default function AlvaraBombeiroRestaurantePage() {
  ...
  const schema = generateMasterSchema({
    ...
    breadcrumbs: [
      ...
      { name: "Alvará Bombeiro Restaurante SP", item: c.meta.canonical },
    ],
  });
    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para Restaurante em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para Restaurante" },
        ]}
        dark
      />
      <TrustBar dark />
      ...
      <div className="py-14 bg-red-900 border-y border-red-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <p className="text-white text-xl font-black uppercase italic tracking-tight mb-2">
            Restaurante com AVCB irregular? Regularize agora.
          </p>
          <p className="text-red-200 text-sm font-bold mb-6">
            A DRD2 Engenharia regulariza com 98% de aprovação na 1ª análise.
          </p>
          <CtaWhatsApp label="Solicitar vistoria diagnóstica gratuita" occupationType="restaurante" variant="primary" centered />
        </div>
      </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para Restaurante</span>
          </h2>
      ...
      <OccupationAuthorityBlock occupation="Restaurante" currentSlug={c.meta.canonical} />
      <OccupationDepthBlock occupation="Restaurante" currentSlug={c.meta.canonical} />
      <InternalLinksBlock currentSlug={c.meta.canonical} mode="ocupação" maxLinks={8} titulo="Alvará Bombeiro para Restaurante em SP" />
