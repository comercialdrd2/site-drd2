...
const _slug = "/renovacao-clcb-freguesia-do-o-sao-paulo";
const _pageTitle = "Renovação de CLCB na Freguesia do Ó SP | Engenheiro Especializado — DRD2";
const _pageDesc = "Renovação de CLCB na Freguesia do Ó com engenheiro especializado. CLCB vencido? Regularize antes de interdição ou bloqueio do alvará. Cobertura Av. Deputado Emílio Carlos, Rua Voluntários da Pátria, Limão e toda a região. DRD2 Engenharia.";
...
export default function RenovacaoClcbFreguesiaDOPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  const faqItems = [
    {
      question: "Qual o prazo para renovar o CLCB vencido na Freguesia do Ó?",
      answer: "Assim que o CLCB vence, o imóvel já está irregular perante o CBPMESP. Na Freguesia do Ó, a renovação para ocupações de baixo risco até 750 m² leva de 15 a 45 dias. A DRD2 inicia o processo em até 48h após o diagnóstico técnico gratuito.",
    },
    {
      question: "A renovação de CLCB na Freguesia do Ó exige obras?",
    ...
    {
      question: "Tenho um comércio ou clínica na Freguesia do Ó com CLCB vencido — quais os riscos?",
      answer: "Interdição imediata pelo CBPMESP, multa e bloqueio do alvará pela Prefeitura de São Paulo. A Freguesia do Ó tem um comércio de bairro consolidado na Av. Deputado Emílio Carlos — e a subprefeitura Casa Verde realiza fiscalizações periódicas com o CBPMESP. Clínicas perdem credenciamentos em planos de saúde populares.",
    },
    {
      question: "CLCB ou AVCB: qual meu imóvel na Freguesia do Ó precisa?",
    ...
    {
      question: "A DRD2 atende renovações urgentes de CLCB na Freguesia do Ó?",
      answer: "Sim. Para CLCB vencido com risco de interdição iminente na Freguesia do Ó, a DRD2 aciona protocolo de urgência — diagnóstico prioritário e início do processo em até 48h. Atendemos todo o bairro e a região de Limão, Casa Verde, Brasilândia, Pirituba e Lapa.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[100px] pb-[40px] lg:pt-[120px] lg:flex items-center bg-slate-950 border-b-4 border-red-600">
        <Image src="/images/page-clcb.webp" alt="Renovação de CLCB na Freguesia do Ó" fill className="object-cover object-center opacity-20 grayscale-[50%]" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-red-600/20 text-red-400 font-bold px-5 py-2 rounded-full uppercase tracking-widest mb-6 border border-red-500/30 text-xs shadow-lg">
              <AlertTriangle className="w-4 h-4" /> CLCB Vencido na Freguesia do Ó — Ação Imediata
            </span>
            <h1 className="text-3xl md:text-3xl lg:text-5xl font-black mb-6 leading-tight text-white">
              Renovação de CLCB na Freguesia do Ó:<br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-3xl leading-relaxed">
              A Freguesia do Ó tem comércio de bairro consolidado na Zona Norte, com clínicas
              populares, farmácias e restaurantes que atendem toda a região do Limão e Casa Verde.
              CLCB vencido expõe o negócio à interdição e suspende credenciamentos.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
                ...
                <RefreshCw className="w-5 h-5" /> Renovar CLCB na Freguesia do Ó
              </a>
              <a href="#diagnostico"
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <span className="flex items-center gap-2"><Map className="w-4 h-4 text-blue-400" /> Freguesia do Ó · Limão · Casa Verde</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4">
            Quem Precisa de Renovação de CLCB na Freguesia do Ó?
          </h2>
          <p className="text-slate-600 mb-8 max-w-3xl">
            A Freguesia do Ó é um bairro residencial tradicional da Zona Norte com forte
            comércio de bairro ao longo da Av. Deputado Emílio Carlos, Rua João Pessoa
            e Rua Voluntários da Pátria. Clínicas populares, farmácias, academias e restaurantes
            que atendem moradores do Limão, Casa Verde e Brasilândia precisam do CLCB válido.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Estabelecimentos que mais renovam na Freguesia do Ó</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Clínicas populares de saúde e odontologia na Av. Deputado Emílio Carlos</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Farmácias e drogarias no corredor comercial do bairro</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Restaurantes e padarias tradicionais de bairro</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Academias e studios de ginástica e pilates</li>
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />Lojas de comércio local e serviços de bairro</li>
              </ul>
            </div>
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-slate-800 mb-3 text-lg">Por que a Freguesia do Ó exige atenção com o CLCB?</h3>
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Subprefeitura Casa Verde realiza fiscalizações conjuntas com CBPMESP no corredor comercial</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Planos de saúde populares auditam clínicas da região e suspendem credenciamentos sem CLCB</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Imóveis comerciais antigos no bairro têm instalações que o CBPMESP acompanha com mais rigor</li>
                <li className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-red-500 mt-1 flex-shrink-0" />Renovações de contrato no comércio estabelecido exigem documentação atualizada</li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">
            O Que Acontece com CLCB Vencido na Freguesia do Ó?
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Map, title: "Abertura de novo ponto", desc: "Clínica, farmácia ou comércio na Freguesia precisa de CLCB antes de iniciar atividades." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-black text-slate-900 mb-8">
                Como Funciona a Renovação de CLCB na Freguesia do Ó
              </h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8">
              <h3 className="font-black text-slate-900 text-xl mb-4 flex items-center gap-2">
                <Clock className="w-6 h-6 text-amber-500" /> Prazo de Renovação na Freguesia do Ó
              </h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-black mb-4">Diagnóstico Gratuito para Renovação de CLCB na Freguesia do Ó</h2>
              ...
              <ul className="space-y-3 text-slate-300">
                {["Diagnóstico técnico gratuito", "Sem obras desnecessárias", "Engenheiro responsável pelo processo", "Cobertura: Freguesia do Ó e toda Zona Norte"].map((item) => (
      ...
      <SocialProof
        testimonial={{
          text: "Tenho uma farmácia na Rua João Pessoa na Freguesia do Ó. A Vigilância Sanitária veio para uma vistoria e pediu o CLCB junto. Estava vencido há 16 meses. A DRD2 resolveu em 38 dias, sem obras, e a renovação da autorização sanitária saiu sem problema.",
          author: "Cláudia Mendonça",
          role: "Proprietária de farmácia, Freguesia do Ó",
        }}
      />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-10 text-center">Perguntas Frequentes — CLCB Freguesia do Ó</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-black text-slate-900 mb-4 text-center">Cobertura: Freguesia do Ó e Região</h2>
          <p className="text-center text-slate-500 mb-8 max-w-2xl mx-auto">
            Além da Freguesia do Ó, a DRD2 atende renovações de CLCB nos bairros vizinhos da Zona Norte.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {["Limão", "Casa Verde", "Brasilândia", "Pirituba", "Lapa", "Santana", "Cachoeirinha", "Mandaqui"].map((bairro) => (
      ...
      <CtaWhatsApp label="CLCB Vencido na Freguesia do Ó? Fale com um Engenheiro Agora" />
      ...
      <nav aria-label="Breadcrumb" className="py-4 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <li className="text-slate-300">/</li>
            <li><a href="/renovacao-clcb-zona-norte-sao-paulo" className="hover:text-red-600 transition-colors">Zona Norte</a></li>
            <li className="text-slate-300">/</li>
            <li className="text-slate-800 font-medium">Freguesia do Ó</li>
          </ol>
        </div>
      </nav>
    </>
