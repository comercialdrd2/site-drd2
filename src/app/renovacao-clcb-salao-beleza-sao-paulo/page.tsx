...
import {
  ...
  ShieldX, Scissors, Sparkles, AlertTriangle,
} from "lucide-react";
...
import { renovacaoClcbSalaoContent as c } from "@/data/pages/renovacao-clcb-salao-beleza-sao-paulo";
...
export default function RenovacaoCLCBSalaoPage() {
  const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}`;

  return (
    <>
      <JsonLD schema={generateMasterSchema({
        slug: "/renovacao-clcb-salao-beleza-sao-paulo",
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Renovação de CLCB para Salão de Beleza em São Paulo",
        faqs: c.faqs.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Renovação CLCB", item: "/renovacao-clcb-sao-paulo" },
          { name: "Salão de Beleza", item: "/renovacao-clcb-salao-beleza-sao-paulo" },
        ],
      })} />
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] lg:pb-[30px] flex items-center bg-slate-950 border-b-8 border-red-600">
        <Image
          ...
          alt="Renovação de CLCB para Salão de Beleza em São Paulo — DRD2 Engenharia"
          fill
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="font-extrabold mb-4 leading-tight tracking-tight uppercase text-white flex flex-col">
              <span className="text-base md:text-lg font-bold tracking-[0.18em] opacity-60 not-italic">
                RENOVAÇÃO DE CLCB — SALÃO DE BELEZA E ESTÉTICA
              </span>
            ...
            <div className="lg:col-span-7 space-y-6 text-lg text-slate-700 leading-relaxed font-medium">
              ...
              <div className="flex items-start gap-4 bg-amber-50 p-6 rounded-2xl border border-amber-200">
                ...
                <p className="text-amber-900 font-bold text-base leading-relaxed">
                  Salões de beleza usam produtos químicos inflamáveis no dia a dia — tintas, oxidantes, acetona e aerossóis. O CLCB vencido em um ambiente com esses produtos representa risco real e responsabilidade civil do proprietário em caso de sinistro.
                </p>
              </div>
            </div>
      ...
      <div className="py-14 bg-[#7F1D1D] border-y border-red-900">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <CtaWhatsApp
            ...
            occupationType="salão de beleza em São Paulo"
            variant="primary"
            centered
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  "Especialistas em CLCB para beleza e estética",
                  "Conhecimento técnico sobre produtos químicos inflamáveis",
                  "Diagnóstico técnico gratuito sem enquadramentos errados",
                  "Adequações executadas sem fechar o salão",
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { Icon: Scissors, l: "Salões de Cabeleireiro" },
                { Icon: Sparkles, l: "Clínicas de Estética" },
                { Icon: Scissors, l: "Barbearias" },
                { Icon: Sparkles, l: "Espaços de Sobrancelha" },
              ].map(({ Icon, l }, i) => (
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">CLCB para Salão de Beleza</span>
          </h2>
          <div className="space-y-4">
            {c.faqs.map((faq, i) => (
      ...
      <ServiceClusterLinks currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" />
      <ServiceBlogLinks currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" />
      <NeighborhoodSilo currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" />

      <OccupationAuthorityBlock occupation="Salão de Beleza" currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" />
      <OccupationDepthBlock occupation="Salão de Beleza" currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" />
      <InternalLinksBlock currentSlug="/renovacao-clcb-salao-beleza-sao-paulo" mode="ocupação" maxLinks={8} titulo="Renovação de CLCB para Salão de Beleza em São Paulo" />
