        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-300 leading-relaxed font-medium mb-6">
                Atendemos edifícios em São Paulo e Grande SP, com foco em regiões de alta verticalização e fiscalização recorrente: Itaim Bibi, <a href="/renovacao-avcb-condominio-moema" className="text-red-500 font-bold hover:underline">Moema</a>, <a href="/renovacao-avcb-condominio-vila-olimpia" className="text-red-500 font-bold hover:underline">Vila Olímpia</a>, <a href="/renovacao-avcb-condominio-pinheiros" className="text-red-500 font-bold hover:underline">Pinheiros</a>, <a href="/renovacao-avcb-condominio-brooklin" className="text-red-500 font-bold hover:underline">Brooklin</a>, Campo Belo, <a href="/renovacao-avcb-condominio-tatuape" className="text-red-500 font-bold hover:underline">Tatuapé</a>, <a href="/renovacao-avcb-condominio-santana" className="text-red-500 font-bold hover:underline">Santana</a>, <a href="/renovacao-avcb-condominio-perdizes" className="text-red-500 font-bold hover:underline">Perdizes</a>, Higienópolis, Morumbi, <a href="/renovacao-avcb-condominio-lapa" className="text-red-500 font-bold hover:underline">Lapa</a>, Santo Amaro e região central.
              </p>
