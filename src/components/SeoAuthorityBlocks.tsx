...
const occupationProfiles: Record<string, {
  ...
  condomínio: {
    ...
    systems: ["IT-08: saidas de emergência", "IT-22: hidrantes e mangotinhos", "IT-18: iluminação de emergência", "IT-20: sinalização", "IT-41: inspeccao elétrica"],
  ...
  galpao: {
    ...
    systems: ["IT-14: carga de incêndio", "IT-22: hidrantes", "IT-17: alarme e detecção", "IT-23: chuveiros automáticos", "IT-25: liquidos combustiveis quando aplicavel"],
  ...
  restaurante: {
    ...
    systems: ["IT-10: controle de materiais", "IT-08: saidas de emergência", "IT-16: extintores classe K", "IT-20: sinalização", "IT-28: GLP"],
  ...
  clcbDefault: {
    ...
    systems: ["IT-01: procedimentos para CLCB", "IT-02: classificação da ocupação", "IT-08: saídas de emergência", "IT-16: extintores", "IT-18: iluminação de emergência", "IT-20: sinalização"],
  ...
  clcbAlimentacao: {
    ...
    systems: ["IT-08: saídas e lotação", "IT-16: extintor classe K para cozinha", "IT-20: sinalização", "IT-28: GLP com ART", "IT-21: combustíveis líquidos quando houver"],
  ...
  clcbSaude: {
    ...
    systems: ["IT-08: rotas com largura para macas/cadeira de rodas", "IT-16: extintor CO₂ para sala de raio-X/equipamentos", "IT-20: sinalização visível", "IT-18: iluminação de emergência em áreas críticas"],
  ...
  hotel: {
    ...
    systems: ["IT-08: saidas e escadas dimensionadas para evacuação noturna", "IT-22: hidrantes em todos os andares", "IT-17: alarme com central + detectores em apartamentos", "IT-23: sprinkler acima de determinada altura", "IT-13: brigada 24h"],
  ...
  hospital: {
    ...
    systems: ["IT-08: rotas com largura compatível com macas", "IT-22: hidrantes em todos os andares", "IT-17: alarme com detecção precoce em quartos", "IT-23: sprinkler obrigatório", "IT-13: brigada 24h treinada", "IT-29: gases medicinais com ART"],
  ...
  escola: {
    ...
    systems: ["IT-08: saidas dimensionadas para evacuação rápida", "IT-22: hidrantes em escolas acima de determinada area", "IT-17: alarme com sirene em todos os ambientes", "IT-20: sinalização visivel para crianças", "IT-13: brigada com treinamento de evacuação"],
  ...
  posto: {
    ...
    systems: ["IT-25: armazenagem de combustivel", "IT-19: SPDA reforçado", "IT-22: hidrantes com vazão majorada", "IT-16: extintores em todas as bombas + conveniência", "IT-13: brigada treinada para combustivel"],
  ...
  supermercado: {
    ...
    systems: ["IT-08: saidas com largura para evacuação rápida", "IT-22: hidrantes na area de vendas e estoque", "IT-17: alarme com cobertura total", "IT-23: sprinkler em estoques verticais", "IT-16: extintores classe K na padaria/açougue"],
  ...
  escritorio: {
    ...
    systems: ["IT-08: saidas dimensionadas para lotação", "IT-22: hidrantes em prédios acima de determinada altura", "IT-17: alarme com cobertura por andar", "IT-16: extintores distribuidos por sala", "IT-18: iluminação de emergência em corredores"],
  ...
  default: {
    ...
    systems: ["IT-01: procedimentos administrativos", "IT-02: classificacao da ocupação", "IT-08: saidas de emergência", "IT-16: extintores", "IT-20: sinalização"],
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 grid grid-cols-1 gap-4">
            {[
              ...
              { icon: ShieldCheck, label: "Análise técnica", value: "IT-02, IT-08, IT-16, IT-17, IT-20 e IT-41" },
