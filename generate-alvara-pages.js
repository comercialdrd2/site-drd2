...
const ocupacoes = [
  { slug: "alvara-bombeiro-restaurante-sao-paulo", fn: "AlvaraBombeiroRestaurante", label: "Restaurantes", cta: "restaurante", ctaTxt: "Restaurante sem alvará do bombeiro? Não arrisque a interdição." },
  { slug: "alvara-bombeiro-bar-restaurante-sao-paulo", fn: "AlvaraBombeiroBarRestaurante", label: "Bares e Restaurantes", cta: "bares-restaurantes", ctaTxt: "Bar ou restaurante com AVCB irregular? Regularize agora." },
  { slug: "alvara-bombeiro-supermercado-sao-paulo", fn: "AlvaraBombeiroSupermercado", label: "Supermercados", cta: "supermercado", ctaTxt: "Supermercado sem alvará do bombeiro? Risco de embargo é real." },
  { slug: "alvara-bombeiro-hospital-clinica-sao-paulo", fn: "AlvaraBombeiroHospitalClinica", label: "Hospitais e Clínicas", cta: "hospital-clinica", ctaTxt: "Clínica ou hospital sem alvará? Risco de interdição imediata." },
  { slug: "alvara-bombeiro-escola-faculdade-sao-paulo", fn: "AlvaraBombeiroEscolaFaculdade", label: "Escolas e Faculdades", cta: "escola", ctaTxt: "Escola ou faculdade sem alvará do bombeiro? Regularize com segurança." },
  { slug: "alvara-bombeiro-condominio-sao-paulo", fn: "AlvaraBombeiroCondominio", label: "Condomínios", cta: "condominio", ctaTxt: "Condomínio sem AVCB válido? Síndico, você responde por isso." },
  { slug: "alvara-bombeiro-academia-sao-paulo", fn: "AlvaraBombeiroAcademia", label: "Academias", cta: "academia", ctaTxt: "Academia com AVCB vencido? Não arrisque a interdição no horário de pico." },
  { slug: "alvara-bombeiro-hotel-pousada-sao-paulo", fn: "AlvaraBombeiroHotelPousada", label: "Hotéis e Pousadas", cta: "hotel", ctaTxt: "Hotel ou pousada sem alvará do bombeiro? Hóspedes correm risco." },
  { slug: "alvara-bombeiro-hostel-sao-paulo", fn: "AlvaraBombeiroHostel", label: "Hostels", cta: "hostel", ctaTxt: "Hostel sem AVCB válido? Cada hóspede aumenta sua responsabilidade." },
  { slug: "alvara-bombeiro-motel-sao-paulo", fn: "AlvaraBombeiroMotel", label: "Motéis", cta: "motel", ctaTxt: "Motel com alvará do bombeiro irregular? Regularize com discrição." },
  { slug: "alvara-bombeiro-pousada-sao-paulo", fn: "AlvaraBombeiroPousada", label: "Pousadas", cta: "pousada", ctaTxt: "Pousada sem AVCB? Turistas dormem em seu estabelecimento — regularize." },
  { slug: "alvara-bombeiro-shopping-sao-paulo", fn: "AlvaraBombeiroShopping", label: "Shoppings e Galerias", cta: "shopping", ctaTxt: "Shopping ou galeria sem alvará válido? Grande risco de notificação." },
  { slug: "alvara-bombeiro-igreja-sao-paulo", fn: "AlvaraBombeiroIgreja", label: "Igrejas e Templos", cta: "igreja", ctaTxt: "Igreja sem alvará do bombeiro? Reunião de público exige regularização." },
  { slug: "alvara-bombeiro-creche-sao-paulo", fn: "AlvaraBombeiroCreche", label: "Creches", cta: "creche", ctaTxt: "Creche sem AVCB? Crianças em risco — regularize agora." },
  { slug: "alvara-bombeiro-casa-de-repouso-sao-paulo", fn: "AlvaraBombeiroCasaRepouso", label: "Casas de Repouso", cta: "casa-de-repouso", ctaTxt: "Casa de repouso sem alvará? Idosos dependem da sua regularização." },
  { slug: "alvara-bombeiro-farmacia-drogaria-sao-paulo", fn: "AlvaraBombeiroFarmaciaDrogaria", label: "Farmácias e Drogarias", cta: "farmacia", ctaTxt: "Farmácia com AVCB vencido? Produtos inflamáveis elevam o risco." },
  { slug: "alvara-bombeiro-padaria-sao-paulo", fn: "AlvaraBombeiroPadaria", label: "Padarias", cta: "padaria", ctaTxt: "Padaria sem alvará do bombeiro? Forno e GLP exigem regularização." },
  { slug: "alvara-bombeiro-escritorio-sao-paulo", fn: "AlvaraBombeiroEscritorio", label: "Escritórios", cta: "escritorio", ctaTxt: "Escritório sem AVCB? Regularize antes da próxima fiscalização." },
  { slug: "alvara-bombeiro-galpao-industrial-sao-paulo", fn: "AlvaraBombeiroGalpaoIndustrial", label: "Galpões Industriais", cta: "galpao-industrial", ctaTxt: "Galpão sem alvará do bombeiro? Carga de incêndio elevada exige ação." },
  { slug: "alvara-bombeiro-posto-combustivel-sao-paulo", fn: "AlvaraBombeiroPosto", label: "Postos de Combustível", cta: "posto-combustivel", ctaTxt: "Posto sem AVCB? Combustível e regulação exigem máxima atenção." },
  { slug: "alvara-bombeiro-salao-de-festas-sao-paulo", fn: "AlvaraBombeiroSalaoFestas", label: "Salões de Festas", cta: "salao-de-festas", ctaTxt: "Salão de festas sem alvará do bombeiro? Eventos concentram público." },
  { slug: "alvara-bombeiro-casa-noturna-boate-sao-paulo", fn: "AlvaraBombeiroCasaNoturna", label: "Casas Noturnas e Boates", cta: "casa-noturna", ctaTxt: "Casa noturna sem AVCB? Risco de interdição e tragédia é real." },
  { slug: "alvara-bombeiro-consultorio-medico-sao-paulo", fn: "AlvaraBombeiroConsultorioMedico", label: "Consultórios Médicos", cta: "consultorio-medico", ctaTxt: "Consultório sem alvará do bombeiro? CFM e ANVISA também fiscalizam." },
  { slug: "alvara-bombeiro-escola-sao-paulo", fn: "AlvaraBombeiroEscola", label: "Escolas", cta: "escola", ctaTxt: "Escola sem AVCB válido? Alunos menores exigem máxima responsabilidade." },
];

function createPageContent(o) {
  return `import {
...
import { alvaraBombeiroContent as c } from "@/data/pages/${o.slug}";
...
export default function ${o.fn}Page() {
  ...
  return (
    <>
      <JsonLD schema={generateMasterSchema({
        ...
        title: c.meta.title,
        description: c.meta.description,
        serviceName: "Alvará do Corpo de Bombeiros para ${o.label} em São Paulo",
        faqs: c.faq.map((f) => ({ question: f.question, answer: f.answer })),
        breadcrumbs: [
          { name: "Home", item: "/" },
          { name: "Serviços", item: "/servicos" },
          { name: "Alvará Bombeiro ${o.label} SP", item: c.meta.canonical },
        ],
      })} />
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl w-full">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-[1.0] tracking-tighter uppercase italic text-white">
              ...
              <span className="text-red-500 not-italic">para ${o.label} em SP</span>
            </h1>
      ...
      <BreadcrumbNav
        items={[
          ...
          { label: "Alvará do Bombeiro para ${o.label}" },
        ]}
        dark
      />
      <TrustBar dark />
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto">
              Itens verificados pelo Corpo de Bombeiros na vistoria de ${o.label.toLowerCase()}.
            </p>
          </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-12 text-center uppercase tracking-tighter italic">
            Perguntas Frequentes — <span className="text-red-600">Alvará do Bombeiro para ${o.label}</span>
          </h2>
      ...
      <section className="py-24 bg-slate-950 text-center text-white border-t-8 border-red-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-3xl relative z-10">
          ...
          <p className="mt-8 text-xs font-black uppercase tracking-[0.3em] text-red-500 opacity-60">
            DRD2 Engenharia — Alvará do Bombeiro para ${o.label} em São Paulo
          </p>
        </div>
      </section>
...
// Gerar todos os 24 page.tsx
for (const o of ocupacoes) {
  const dir = path.join(__dirname, "src", "app", o.slug);
  fs.mkdirSync(dir, { recursive: true });
  fs.writeFileSync(path.join(dir, "page.tsx"), createPageContent(o), "utf8");
  console.log(`✅ Criado: ${o.slug}/page.tsx`);
}

console.log(`\n🎉 ${ocupacoes.length} páginas geradas com sucesso!`);
console.log("\nPróximo passo: criar os 24 arquivos de dados em src/data/pages/");
