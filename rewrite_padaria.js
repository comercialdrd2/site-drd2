    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[auto] pt-[85px] pb-[20px] lg:pt-[95px] flex items-center bg-slate-950 border-b-8 border-red-600">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-6xl py-8">
          <div className="lg:w-3/5">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6 leading-[0.9] tracking-tighter uppercase italic text-white flex flex-col drop-shadow-2xl">
              AVCB para Padaria em São Paulo
            </h1>
            <p className="text-base md:text-lg text-gray-200 mb-3 leading-relaxed font-medium max-w-2xl">
              Padaria com área de consumo, forno a lenha ou a gás, coifa com acúmulo de gordura e central de GLP é enquadrada como Grupo F-3 — Local de Reunião de Público pelo CBPMESP — uma classificação mais exigente que o comércio comum, com regras específicas de saídas de emergência, brigada e supressão. Coifa sem sistema de supressão certificado, GLP irregular ou rota de fuga fora da norma são os motivos mais frequentes de embargo, interdição e lacre em padarias em São Paulo.
            </p>
      ...
      <div className="py-12 bg-slate-950 border-y border-slate-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <CtaWhatsApp
            label="Falar com Engenheiro Agora"
...
fs.writeFileSync(path.join(__dirname, 'src/app/avcb-para-padaria-sao-paulo/page.tsx'), pageContent, 'utf8');
console.log('Done rewriting Padaria');
